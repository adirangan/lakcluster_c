...
# Compiler
CC=gcc
CCFLAGS_dev_prince= -w -O2 -lpthread -fopenmp -I/home/avr209 -L/home/avr209 -Wl,-rpath=/home/avr209 -lm -lgslcblas -I./dir_h -I./dir_c 
CCFLAGS_dev= -w -O2 -lpthread -fopenmp -lm -lgslcblas -I./dir_h -I./dir_c 
CCFLAGS=$(CCFLAGS_dev_prince) -D_MONOLITH
...
$(project_dev): $(objects_dev) $(header_dev)
	rm -f $(project_dev)
	$(CLINK) $(objects_dev) $(CCFLAGS_dev_prince)

$(project): $(objects_dev) $(header_dev)
	rm -f $(project)
	gcc -w -O2 -lpthread -fopenmp -I/home/avr209 -L/home/avr209 -Wl,-rpath=/home/avr209 ./dir_c/lakcluster_ver18.c -o $(project) -L./dir_h -L./dir_c -I./dir_h -I./dir_c -D_MONOLITH -lgslcblas -lm

./dir_o/%.o : %.c ./dir_h/lakcluster_header.h
	@echo $< 
	@$(CC) $(CCFLAGS_dev_prince) -c $< -o $@

.c.o: ./dir_h/lakcluster_header.h
	$(CC) -c $(CCFLAGS_dev_prince) $<
