function dexcluster_uADZSZDA_hmap_0(dir_code,dir_trunk,prefix,M_n_,rev_flag,A_n_rind_,A_n_cind,Z_n_rind_,T_n_,T_n_cind,gamma,B_MLT,Ireq,shuffle_num,verbose_flag);
% plots heatmap ;

nbins=length(M_n_);
[A_n_cols,Y_n_cols,T_n_cols,~,~] = lakcluster_uADZSZDA_check_0(shuffle_num,M_n_,A_n_rind_,A_n_cind,Z_n_rind_,T_n_,T_n_cind);

tmp_string = sprintf('%s_%s',prefix,dexcluster_uADZSZDA_xfix_gen_ver0(rev_flag,gamma,B_MLT,Ireq,0));
