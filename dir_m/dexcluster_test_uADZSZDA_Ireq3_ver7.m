function dexcluster_test_uADZSZDA_Ireq3_ver7(dir_trunk,N,X_factor,X_esm,gamma,B_MLT,rng_num,pt_num)
...
% try: ;
%{
  !scp -p rangan@access1.cims.nyu.edu:/data/rangan/dir_bcc/dir_code_022316/dexcluster_test_uADZSZDA_Ireq3_ver7.m ./ ;
  N=1024*1;X_factor=0.65;X_esm=0.0;gamma=0.25;B_MLT= 32;rng_num=1;dexcluster_test_uADZSZDA_Ireq3_ver7(pwd,N,X_factor,X_esm,gamma,B_MLT,rng_num);
  N=16;X_factor=0.65;X_esm=0.0;gamma=0.25;B_MLT= 32;rng_num=1;dexcluster_test_uADZSZDA_Ireq3_ver7(pwd,N,X_factor,X_esm,gamma,B_MLT,rng_num);
  %}
...
test_string = 'dexcluster_test_uADZSZDA_Ireq3';
...
fprintf(fp,'END= 0;\n');
fprintf(fp,'%% generated by dexcluster_test_uADZSZDA_Ireq3_ver7.m on %s;\n',date);
fclose(fp);
