function dexcluster_test_uADZSZDA_ver0b(dir_trunk,N,X_factor,X_esm,gamma,B_MLT,rng_num,pt_num)
...
% try: ;
%{
  !scp -p rangan@access1.cims.nyu.edu:/data/rangan/dir_bcc/dir_code_022316/dexcluster_test_uADZSZDA_ver0b.m ./ ;
  N=1024*1;X_factor=0.65;X_esm=0.0;gamma=0.25;B_MLT= 0;rng_num=1;dexcluster_test_uADZSZDA_ver0b(pwd,N,X_factor,X_esm,gamma,B_MLT,rng_num);
  N=16;X_factor=0.65;X_esm=0.0;gamma=0.25;B_MLT= 0;rng_num=1;dexcluster_test_uADZSZDA_ver0b(pwd,N,X_factor,X_esm,gamma,B_MLT,rng_num);
  %}
...
test_string = 'dexcluster_test_uADZSZDA';
...
X0 = 2*(rand(nrows_X,ncols_X)<X_p2)-1; X0(:,floor(end/2):end) = 1-X0(:,floor(end/2):end);
...
X4 = 2*(rand(3*nrows_XX,ncols_XX)<X_p2)-1; X4(:,floor(end/2):end) = 1-X4(:,floor(end/2):end);
for nb1=0:nbins-1; 
...
X1 = 2*(rand(nrows_XX,ncols_XX)<X_p2)-1; X1(:,floor(end/2):end) = 1-X1(:,floor(end/2):end);
...
X2 = 2*(rand(nrows_XX,ncols_XX)<X_p2)-1; X2(:,floor(end/2):end) = 1-X2(:,floor(end/2):end);
...
X3 = 2*(rand(nrows_XX,ncols_XX)<X_p2)-1; X3(:,floor(end/2):end) = 1-X3(:,floor(end/2):end);
...
X5(:,floor(end/2):end) = 1-X5(:,floor(end/2):end);
...
X6(:,floor(end/2):end) = 1-X6(:,floor(end/2):end);
...
fprintf(fp,'GLOBAL_thread_count= 4;\n');
fprintf(fp,'GLOBAL_omp_type= 0;\n');
fprintf(fp,'GLOBAL_NTEST= 9;\n');
fprintf(fp,'GLOBAL_account_for_sparsity= 1;\n');
fprintf(fp,'GLOBAL_VERSUS= 0;\n');
fprintf(fp,'GLOBAL_nb_srt= %d;\n',nb_srt);
fprintf(fp,'GLOBAL_gamma= %0.4f;\n',gamma);
fprintf(fp,'GLOBAL_NBINS= %d;\n',nbins);
fprintf(fp,'GLOBAL_DIR_XPRE= %s;\n',dir__in);
fprintf(fp,'A_n_name_= '); for nb1=0:nbins-1; fprintf(fp,'A_%.2d_n.b16',nb1); if nb1<nbins-1; fprintf(fp,','); else fprintf(fp,';'); end; end; fprintf(fp,'\n');
fprintf(fp,'A_t_name_= '); for nb1=0:nbins-1; fprintf(fp,'A_%.2d_t.b16',nb1); if nb1<nbins-1; fprintf(fp,','); else fprintf(fp,';'); end; end; fprintf(fp,'\n');
fprintf(fp,'A_n_rows_= '); for nb1=0:nbins-1; fprintf(fp,'%d',nrows_A_(1+nb1)); if nb1<nbins-1; fprintf(fp,','); else fprintf(fp,';'); end; end; fprintf(fp,'\n');
fprintf(fp,'A_n_cols= %d;\n',ncols_A);
fprintf(fp,'A_n_rind_= '); for nb1=0:nbins-1; fprintf(fp,'mr_A_%.2d.b16',nb1); if nb1<nbins-1; fprintf(fp,','); else fprintf(fp,';'); end; end; fprintf(fp,'\n');
fprintf(fp,'A_n_cind= mc_A.b16;\n');
fprintf(fp,'Z_n_name_= '); for nb1=0:nbins-1; fprintf(fp,'Z_%.2d_n.b16',nb1); if nb1<nbins-1; fprintf(fp,','); else fprintf(fp,';'); end; end; fprintf(fp,'\n');
fprintf(fp,'Z_t_name_= '); for nb1=0:nbins-1; fprintf(fp,'Z_%.2d_t.b16',nb1); if nb1<nbins-1; fprintf(fp,','); else fprintf(fp,';'); end; end; fprintf(fp,'\n');
fprintf(fp,'Z_n_rows_= '); for nb1=0:nbins-1; fprintf(fp,'%d',nrows_Z_(1+nb1)); if nb1<nbins-1; fprintf(fp,','); else fprintf(fp,';'); end; end; fprintf(fp,'\n');
fprintf(fp,'Z_n_rind_= '); for nb1=0:nbins-1; fprintf(fp,'mr_Z_%.2d.b16',nb1); if nb1<nbins-1; fprintf(fp,','); else fprintf(fp,';'); end; end; fprintf(fp,'\n');
fprintf(fp,'T_n_name_= '); for nb1=0:nbins-1; fprintf(fp,'T_%.2d_n.b16',nb1); if nb1<nbins-1; fprintf(fp,','); else fprintf(fp,';'); end; end; fprintf(fp,'\n');
fprintf(fp,'T_t_name_= '); for nb1=0:nbins-1; fprintf(fp,'T_%.2d_t.b16',nb1); if nb1<nbins-1; fprintf(fp,','); else fprintf(fp,';'); end; end; fprintf(fp,'\n');
fprintf(fp,'T_n_cols= %d;\n',ncols_T);
fprintf(fp,'T_n_cind= mc_T.b16;\n');
fprintf(fp,'S_n_name_= '); for nb1=0:nbins-1; fprintf(fp,'S_%.2d_n.b16',nb1); if nb1<nbins-1; fprintf(fp,','); else fprintf(fp,';'); end; end; fprintf(fp,'\n');
fprintf(fp,'S_t_name_= '); for nb1=0:nbins-1; fprintf(fp,'S_%.2d_t.b16',nb1); if nb1<nbins-1; fprintf(fp,','); else fprintf(fp,';'); end; end; fprintf(fp,'\n');
fprintf(fp,'GLOBAL_DIR_NAME= %s;\n',dir_out);
fprintf(fp,'END= 0;\n');
fprintf(fp,'%% generated by dexcluster_test_uADZSZDA_ver0b.m on %s;\n',date);
fclose(fp);

call_flag=1;%call_flag = input(' call? 1=yes (default), 0=no:'); if isempty(call_flag); call_flag=1; end;
if call_flag;
disp(sprintf('%s/../lakcluster_ver17 < %s',dir_trunk,fname__in));
system(sprintf('%s/../lakcluster_ver17 < %s',dir_trunk,fname__in));
end;%if call_flag;
