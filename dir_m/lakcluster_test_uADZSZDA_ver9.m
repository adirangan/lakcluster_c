function lakcluster_test_uADZSZDA_ver9(dir_trunk,N,X_factor,X_esm,gamma,B_MLT,rng_num,pt_num,verbose_flag)
...
%{
  ...
  N=1024*2;X_factor=0.55;X_esm=0.01;gamma=0.05;B_MLT=32;rng_num=1;pt_num=-1;verbose_flag=0;lakcluster_test_uADZSZDA_ver9(pwd,N,X_factor,X_esm,gamma,B_MLT,rng_num);
...
fprintf(fp,'END= 0;\n');
fprintf(fp,'%% generated by lakcluster_test_uADZSZDA_ver9.m on %s;\n',date);
fclose(fp);

%call_flag=~exist(sprintf('%s/out_xdrop_a.txt',dir_out),'file');
call_flag = input(' call? 1=yes (default), 0=no:'); if isempty(call_flag); call_flag=1; end;
if call_flag;
