function dexcluster_test_AAAA_ver5(dir_trunk,N,X_factor,X_esm,gamma,B_MLT,rng_num,pt_num)
% trying to test dexcluster with single bins and mrnd=0 ; 
% this time we embed only a single balanced cluster. no controls! ;
% try: ;
%{
  
  N=1024*1;X_factor=0.575;X_esm=0.0;gamma=0.25;B_MLT= 32;rng_num=1;dexcluster_test_AAAA_ver5(pwd,N,X_factor,X_esm,gamma,B_MLT,rng_num);
...
fprintf(fp,'END= 0;\n');
fprintf(fp,'%% generated by dexcluster_test_AAAA_ver5.m on %s;\n',date);
fclose(fp);
