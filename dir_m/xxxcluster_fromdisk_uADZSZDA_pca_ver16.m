...
if ~isfield(parameter_pca,'dir_out_jpg'); parameter_pca.dir_out = {}; end;
if ~isfield(parameter_pca,'dir_out_b16'); parameter_pca.dir_out = {}; end;
if ~isfield(parameter_pca,'dir_out_inp'); parameter_pca.dir_out = {}; end;
if ~isfield(parameter_pca,'dir_out_mda'); parameter_pca.dir_out = {}; end;
if ~isfield(parameter_pca,'dir_out_mat'); parameter_pca.dir_out = {}; end;
...
pca_pca_mr_A_ = parameter_pca.pca_mr_A_;
pca_pca_mr_Z_ = parameter_pca.pca_mr_Z_;
pca_pca_mc_A = parameter_pca.pca_mc_A;
pca_pca_mc_T = parameter_pca.pca_mc_T;
...
%%%%%%%%;
flag_found_all = 0;
if ( strcmp(str_driver,'pca_driver') );
flag_found_all = exist(pca_str_V,'file');
end;%if ( strcmp(str_driver,'pca_driver') );
if ( strcmp(str_driver,'pca_proj_driver') );
flag_found_all = exist(pca_str_AnV,'file') & exist(pca_str_ZnV,'file');
end;%if ( strcmp(str_driver,'pca_proj_driver') );
...
%%%%%%%%;
if ~isempty(pca_mc_A);
str_tmp = sprintf('%s/%s_mc_A.b16',pca_dir_out_b16,pca_str_infix); end;
if (flag_force_create | ~exist(str_tmp,'file'));
if (flag_verbose>0); disp(sprintf(' %% %s not found, creating',str_tmp)); end;
...
%%%%%%%%;
if ~isempty(pca_mc_T);
str_tmp = sprintf('%s/%s_mc_T.b16',pca_dir_out_b16,pca_str_infix); end;
if (flag_force_create | ~exist(str_tmp,'file'));
if (flag_verbose>0); disp(sprintf(' %% %s not found, creating',str_tmp)); end;
