...
if (nargin<1+na); parameter_pca=[]; end; na=na+1;
...
%%%%%%%%;
if isempty(parameter_pca); parameter_pca = struct('type','parameter_pca'); end;
if ~isfield(parameter_pca,'str_driver'); parameter_pca.str_driver = 'pca_driver'; end;
if ~isfield(parameter_pca,'b_mlt'); parameter_pca.b_mlt = 44; end;
if ~isfield(parameter_pca,'tolerance'); parameter_pca.tolerance = 1e-6; end;
if ~isfield(parameter_pca,'TEST_niter'); parameter_pca.TEST_niter = 1024; end;
if ~isfield(parameter_pca,'rank'); parameter_pca.rank = 2; end;
if ~isfield(parameter_pca,'flag_reverse'); parameter_pca.flag_reverse = parameter.flag_reverse; end;
if ~isfield(parameter_pca,'pca_mr_A_'); parameter_pca.pca_mr_A_ = []; end;
if ~isfield(parameter_pca,'pca_mr_Z_'); parameter_pca.pca_mr_Z_ = []; end;
if ~isfield(parameter_pca,'pca_mc_A'); parameter_pca.pca_mc_A = []; end;
if ~isfield(parameter_pca,'pca_mc_T'); parameter_pca.pca_mc_T = []; end;
if ~isfield(parameter_pca,'str_infix'); parameter_pca.str_infix = {}; end;
if ~isfield(parameter_pca,'dir_out'); parameter_pca.dir_out = {}; end;
if ~isfield(parameter_pca,'dir_out_jpg'); parameter_pca.dir_out_jpg = {}; end;
if ~isfield(parameter_pca,'dir_out_b16'); parameter_pca.dir_out_b16 = {}; end;
if ~isfield(parameter_pca,'dir_out_inp'); parameter_pca.dir_out_inp = {}; end;
if ~isfield(parameter_pca,'dir_out_mda'); parameter_pca.dir_out_mda = {}; end;
if ~isfield(parameter_pca,'dir_out_mat'); parameter_pca.dir_out_mat = {}; end;
if ~isfield(parameter_pca,'str_V'); parameter_pca.str_V = {}; end;
if ~isfield(parameter_pca,'str_AnV'); parameter_pca.str_AnV = {}; end;
if ~isfield(parameter_pca,'str_ZnV'); parameter_pca.str_ZnV = {}; end;
if ~isfield(parameter_pca,'flag_force_create'); parameter_pca.flag_force_create = parameter.flag_force_create; end;
pca_str_driver = parameter_pca.str_driver;
pca_b_mlt = parameter_pca.b_mlt;
pca_tolerance = parameter_pca.tolerance;
pca_TEST_niter = parameter_pca.TEST_niter;
pca_rank = parameter_pca.rank;
pca_flag_reverse = parameter_pca.flag_reverse;
pca_mr_A_ = parameter_pca.pca_mr_A_;
pca_mr_Z_ = parameter_pca.pca_mr_Z_;
pca_mc_A = parameter_pca.pca_mc_A;
pca_mc_T = parameter_pca.pca_mc_T;
pca_str_infix = parameter_pca.str_infix;
pca_dir_out = parameter_pca.dir_out;
pca_dir_out_jpg = parameter_pca.dir_out_jpg;
pca_dir_out_b16 = parameter_pca.dir_out_b16;
pca_dir_out_inp = parameter_pca.dir_out_inp;
pca_dir_out_mda = parameter_pca.dir_out_mda;
pca_dir_out_mat = parameter_pca.dir_out_mat;
pca_str_V = parameter_pca.str_V;
pca_str_AnV = parameter_pca.str_AnV;
pca_str_ZnV = parameter_pca.str_ZnV;
pca_flag_force_create = parameter_pca.flag_force_create;
%%%%%%%%;
...
parameter_pca.dir_out = pca_dir_out;
...
parameter_pca.dir_out_jpg = pca_dir_out_jpg;
...
parameter_pca.dir_out_b16 = pca_dir_out_b16;
...
parameter_pca.dir_out_inp = pca_dir_out_inp;
...
parameter_pca.dir_out_mda = pca_dir_out_mda;
...
parameter_pca.dir_out_mat = pca_dir_out_mat;
...
parameter_pca.str_infix = pca_str_infix;
...
parameter_pca.str_AnV = pca_str_AnV;
...
parameter_pca.str_ZnV = pca_str_ZnV;
...
if ~isempty(pca_mc_T);
if (flag_T==0);
str_out_ = xxxcluster_fromdisk_uADZSZDA_excerpt_0(-1,'GLOBAL_T_n_name_= ',n_bin,dir_out_plus_prefix,'_T_crop_','_n.b16');
...
if (pca_flag_force_create | ~exist(str_tmp,'file'));
if (flag_verbose>0); disp(sprintf(' %% %s not found, creating',str_tmp)); end;
binary_compress(bitj,pca_mc_T>0,str_tmp);
end;%if (pca_flag_force_create | ~exist(str_tmp,'file'));
...
parameter_pca.str_0in = fname_0in;
...
if  exist(sprintf('%s/A_p.mda',dir_out_s0000),'file');
fprintf(fp,'GLOBAL_A_p_name= %s/A_p.mda;\n',dir_out_s0000);
end;%if  exist(sprintf('%s/A_p.mda',dir_out_s0000),'file');
if X_bother;
