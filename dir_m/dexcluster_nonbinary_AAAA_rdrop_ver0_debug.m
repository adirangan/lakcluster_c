function [out_xdrop_,trace_] = dexcluster_nonbinary_AAAA_rdrop_ver0_debug(A_n_,gamma);
...
tmp_t = tic();
%profile on;
[out_xdrop_,trace_] = dexcluster_nonbinary_AAAA_rdrop_ver0_debug(A1_rc__,gamma);
