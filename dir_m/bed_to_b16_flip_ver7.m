...
tmpchar = sprintf('%s/%smc_T.b16',dir_out,str_output_prefix_local); tutorial_binary_compress(bitj,mc_T(:)>0,tmpchar); 
tmpchar = sprintf('%s/%sT_full_n.b16',dir_out,str_output_prefix_local);tutorial_binary_compress(bitj,[ones(nrows_T_sum,1) , (T_full_>0)],tmpchar);
tmpchar = sprintf('%s/%sT_full_t.b16',dir_out,str_output_prefix_local);tutorial_binary_compress(bitj,transpose([ones(nrows_T_sum,1) , (T_full_>0)]),tmpchar);
for ns=0:n_study-1;
tmpchar = sprintf('%s/%sT_%.2d_n.b16',dir_out,str_output_prefix_local,1+ns);tutorial_binary_compress(bitj,[ones(n_rij_cap_s_(1+ns),1) , (T_{1+ns}>0)],tmpchar);
tmpchar = sprintf('%s/%sT_%.2d_t.b16',dir_out,str_output_prefix_local,1+ns);tutorial_binary_compress(bitj,transpose([ones(n_rij_cap_s_(1+ns),1) , (T_{1+ns}>0)]),tmpchar);
end;%for ns=0:n_study-1;
...
tmpchar = sprintf('%s/%smc_T_m2r%d.b16',dir_out,str_output_prefix_local,nz); if (verbose>0); disp(sprintf(' %% Writing %s of size %d sum %d',tmpchar,numel(mc_T_m2rx),sum(mc_T_m2rx>0))); end; tutorial_binary_compress(bitj,mc_T_m2rx(:)>0,tmpchar);
tmpchar = sprintf('%s/%sT_m2r%d_full_n.b16',dir_out,str_output_prefix_local,nz); if (verbose>0); disp(sprintf(' %% Writing %s of size %d-x%d',tmpchar,size(T_m2rx_full_,1),1+size(T_m2rx_full_,2))); end; tutorial_binary_compress(bitj,[ones(nrows_T_sum,1) , (T_m2rx_full_>0)],tmpchar);
tmpchar = sprintf('%s/%sT_m2r%d_full_t.b16',dir_out,str_output_prefix_local,nz); if (verbose>0); disp(sprintf(' %% Writing %s of size %d-x%d',tmpchar,1+size(T_m2rx_full_,2),size(T_m2rx_full_,1))); end; tutorial_binary_compress(bitj,transpose([ones(nrows_T_sum,1) , (T_m2rx_full_>0)]),tmpchar);
save(sprintf('%s/%sT_m2r%d_full_n.mat',dir_out,str_output_prefix_local,nz),'T_m2rz_med_','T_m2rz_full_','T_m2rx_full_','w_tmp','R_tmp');
for ns=0:n_study-1;
tmpchar = sprintf('%s/%sT_m2r%d_%.2d_n.b16',dir_out,str_output_prefix_local,nz,1+ns); if (verbose>0); disp(sprintf(' %% Writing %s of size %d-x%d',tmpchar,size(T_m2rx_{1+ns},1),1+size(T_m2rx_{1+ns},2))); end; tutorial_binary_compress(bitj,[ones(n_rij_cap_s_(1+ns),1) , (T_m2rx_{1+ns}>0)],tmpchar);
tmpchar = sprintf('%s/%sT_m2r%d_%.2d_t.b16',dir_out,str_output_prefix_local,nz,1+ns); if (verbose>0); disp(sprintf(' %% Writing %s of size %d-x%d',tmpchar,1+size(T_m2rx_{1+ns},2),size(T_m2rx_{1+ns},1))); end; tutorial_binary_compress(bitj,transpose([ones(n_rij_cap_s_(1+ns),1) , (T_m2rx_{1+ns}>0)]),tmpchar);
end;%for ns=0:n_study-1;
...
tmpchar = sprintf('%s/%smr_A_full.b16',dir_out,str_output_prefix_local);if (verbose>0); disp(sprintf(' %% Writing %s of size %d sum %d',tmpchar,numel(mr_A_full),sum(mr_A_full>0))); end; tutorial_binary_compress(bitj,mr_A_full(:)>0,tmpchar); pause(1);
tmpchar = sprintf('%s/%smr_Z_full.b16',dir_out,str_output_prefix_local);if (verbose>0); disp(sprintf(' %% Writing %s of size %d sum %d',tmpchar,numel(mr_Z_full),sum(mr_Z_full>0))); end; tutorial_binary_compress(bitj,mr_Z_full(:)>0,tmpchar); pause(1);
for ns=0:n_study-1;
tmpchar = sprintf('%s/%smr_A_%.2d.b16',dir_out,str_output_prefix_local,1+ns);if (verbose>0); disp(sprintf(' %% Writing %s of size %d sum %d',tmpchar,numel(mr_A_{1+ns}),sum(mr_A_{1+ns}>0))); end; tutorial_binary_compress(bitj,mr_A_{1+ns}(:)>0,tmpchar); pause(1);
tmpchar = sprintf('%s/%smr_Z_%.2d.b16',dir_out,str_output_prefix_local,1+ns);if (verbose>0); disp(sprintf(' %% Writing %s of size %d sum %d',tmpchar,numel(mr_Z_{1+ns}),sum(mr_Z_{1+ns}>0))); end; tutorial_binary_compress(bitj,mr_Z_{1+ns}(:)>0,tmpchar); pause(1);
end;%for ns=0:n_study-1;
...
for ns=0:n_study-1;
tmpAnchar = sprintf('%s/%sA_%.2d_n.b16',dir_out,str_output_prefix_local,1+ns);
Bn_{1+ns} = tutorial_binary_uncompress(tmpAnchar,1:nrows_An_s_(1+ns),1:ncols_An);
tmpAtchar = sprintf('%s/%sA_%.2d_t.b16',dir_out,str_output_prefix_local,1+ns);
Bt_{1+ns} = tutorial_binary_uncompress(tmpAtchar,1:ncols_An,1:nrows_An_s_(1+ns));
