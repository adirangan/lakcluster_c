function lakcluster_test_uADZSZDA_ver6(dir_trunk,N,X_factor,X_esm,gamma,B_MLT,rng_num,pt_num,verbose_flag)
...
%{
  ...
  N=1024;X_factor=0.55;X_esm=0.1;gamma=0.05;B_MLT=32;rng_num=1;lakcluster_test_uADZSZDA_ver6(pwd,N,X_factor,X_esm,gamma,B_MLT,rng_num);
...
fprintf(fp,'END= 0;\n');
fprintf(fp,'%% generated by lakcluster_test_uADZSZDA_ver6.m on %s;\n',date);
fclose(fp);
