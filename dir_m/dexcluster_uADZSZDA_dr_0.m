function dexcluster_uADZSZDA_dr_0(dir_code,dir_trunk,prefix,M_n_,rev_flag,A_n_rind_,A_n_cind,Z_n_rind_,T_n_,T_n_cind,gamma,B_MLT,Ireq,shuffle_num,walltime,verbose_flag,force_create_flag)
% using lakcluster_ver18 ; 
% test with: ;
%{
  dexcluster_uADZSZDA_dr_0();
  %}
...
verbose_flag = 0;
force_create_flag = 1;
dexcluster_uADZSZDA_dr_0(dir_code,dir_trunk,prefix,M_n_,rev_flag,A_n_rind_,A_n_cind,Z_n_rind_,T_n_,T_n_cind,gamma,B_MLT,Ireq,shuffle_num,walltime,verbose_flag,force_create_flag);
n_shuffles = 8;
...
disp_flag=1;
if disp_flag;
test_string = sprintf('%s_%s',prefix,dexcluster_uADZSZDA_xfix_gen_ver0(rev_flag,gamma,B_MLT,Ireq,0));
...
subplot(1,3,2); imagesc(M_n_{1}(1+rij,1+cij),[-1,1]); title('dex');
...
fprintf(fp,'END= 0;\n');
fprintf(fp,'%% generated by dexcluster_uADZSZDA_dr_0.m on %s;\n',date);
fclose(fp);
