function lakcluster_test_uADZSZDA_ver7b(dir_trunk,N,X_factor,X_esm,gamma,B_MLT,rng_num,pt_num,verbose_flag)
...
% compares output with that of lakcluster_uADZSZDA_dr_1 ;
% uses lakcluster_ver18 ;
% try: ;
%{
  
  N=1024;X_factor=0.65;X_esm=0.01;gamma=0.50;B_MLT=32;rng_num=1;lakcluster_test_uADZSZDA_ver7b(pwd,N,X_factor,X_esm,gamma,B_MLT,rng_num);
...
fprintf(fp,'END= 0;\n');
fprintf(fp,'%% generated by lakcluster_test_uADZSZDA_ver7b.m on %s;\n',date);
fclose(fp);
