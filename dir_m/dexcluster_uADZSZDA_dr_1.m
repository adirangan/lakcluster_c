function dexcluster_uADZSZDA_dr_1(dir_code,dir_trunk,prefix,M_n_,rev_flag,A_n_rind_,A_n_cind,Z_n_rind_,T_n_,T_n_cind,GLOBAL_TEST_sparse,gamma,B_MLT,Ireq,shuffle_num,verbose_flag,force_create_flag,slurm_walltime,slurm_nnodes,slurm_tpn,slurm_memdecl)
% using lakcluster_ver18 and slurm; 
% test with: ;
%{
  dexcluster_uADZSZDA_dr_1();
  %}
...
fprintf(fp,'END= 0;\n');
fprintf(fp,'%% generated by dexcluster_uADZSZDA_dr_1.m on %s;\n',date);
fclose(fp);
