function lakcluster_test_uADZSZDA_Ireq3_ver7(dir_trunk,N,X_factor,X_esm,gamma,B_MLT,rng_num,pt_num,verbose_flag)
...
%{
  ...
  N=1024;X_factor=0.55;X_esm=0.1;gamma=0.01;B_MLT=32;rng_num=1;lakcluster_test_uADZSZDA_Ireq3_ver7(pwd,N,X_factor,X_esm,gamma,B_MLT,rng_num);
...
test_string = 'lakcluster_test_uADZSZDA_Ireq3';
...
fprintf(fp,'END= 0;\n');
fprintf(fp,'%% generated by lakcluster_test_uADZSZDA_Ireq3_ver7.m on %s;\n',date);
fclose(fp);
