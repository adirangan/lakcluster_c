function lakcluster_uADZSZDA_scorebox_0(dir_code,dir_trunk,prefix,M_n_,rev_flag,A_n_rind_,A_n_cind,Z_n_rind_,T_n_,T_n_cind,gamma,B_MLT,Ireq,shuffle_num,walltime,verbose_flag,force_create_flag,scorebox_out_xdrop,scorebox_row_max,scorebox_row_num,scorebox_col_max,scorebox_col_num)
% using lakcluster_ver18 ; 
% test with: ;
%{
  lakcluster_uADZSZDA_scorebox_0();
  %}
...
fprintf(fp,'END= 0;\n');
fprintf(fp,'%% generated by lakcluster_uADZSZDA_scorebox_0.m on %s;\n',date);
fclose(fp);
