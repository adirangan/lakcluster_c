...
if (flag_reverse==0); parameter_pca.pca_mr_A_{1+nstudy}(xdrop_.ij_rkeep_(1:n_r_tmp))=1; end;
parameter_pca.pca_mr_Z_{1+nstudy} = zeros(size(mx__.mr_Z__{1+nstudy}));
if (flag_reverse==1); parameter_pca.pca_mr_Z_{1+nstudy}(xdrop_.ij_rkeep_(1:n_r_tmp))=1; end;
end;%for nstudy=0:n_study-1;
parameter_pca.str_infix = sprintf('pca_D_ni%d',ni);
[ ...
 parameter ...
 parameter_pca ...
] = ...
...
parameter_pca_proj.str_infix = sprintf('pca_proj_D_ni%d',ni);
[ ...
 parameter ...
 parameter_pca_proj ...
] = ...
