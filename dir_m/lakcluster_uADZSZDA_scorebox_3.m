...
if (nargin<na); scorebox_out_xdrop = 'test'; end; na=na+1;
if (nargin<na); scorebox_row_max = length(A_n_rind_{1}); end; na=na+1;
if (nargin<na); scorebox_row_num = 32; end; na=na+1;
if (nargin<na); scorebox_col_max = length(A_n_cind); end; na=na+1;
if (nargin<na); scorebox_col_num = 64; end; na=na+1;
...
fprintf(fp,'END= 0;\n');
fprintf(fp,'%% generated by lakcluster_uADZSZDA_scorebox_3.m on %s;\n',date);
fclose(fp);
