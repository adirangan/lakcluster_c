...
global_nlpnex_threshold_ = 3:0.5:27; global_n_nlpnex_threshold = numel(global_nlpnex_threshold_);
%%%%%%%%;
...
%%%%%%%%;
% loading local hnbrtZRgumb results. ;
%%%%%%%%;
local_US_B_logn_sg__ = [];
%%%%%%%%;
tmp_infix_hnbrtZRgumb_0 = sprintf('hnbrtZRgumb_r%d_r1',local_rank_estimate_B_logn_sg); 
tmp_infix_hnbrtZRgumb_1 = sprintf('%s',tmp_infix_hnbrtZRgumb_0);
dir_local_mat_hnbrtZRgumb = sprintf('%s/dir_tmp_%s/dir_tmp_%s',dir_local_mat,tmp_infix_hnbrtZRgumb_0,tmp_infix_hnbrtZRgumb_1);
tmp_local_fname_output_label = sprintf('%s/output_label__.txt',dir_local_mat_hnbrtZRgumb);
tmp_local_fname_nlpbra_label = sprintf('%s/nlpbra_label__.txt',dir_local_mat_hnbrtZRgumb);
tmp_local_fname_nlpnex_label = sprintf('%s/nlpnex_label__.txt',dir_local_mat_hnbrtZRgumb);
flag_hnbrtZRgumb = exist(tmp_local_fname_output_label,'file') & exist(tmp_local_fname_nlpbra_label,'file') & exist(tmp_local_fname_nlpnex_label,'file');
if (flag_hnbrtZRgumb);
local_fname_hnbrtZRgumb_pre = sprintf('%s/%s_postprocess',dir_local_mat,tmp_infix_hnbrtZRgumb_1);
[local_flag_hnbrtZRgumb_skip,local_fname_hnbrtZRgumb_mat] = open_fname_tmp(local_fname_hnbrtZRgumb_pre,date_diff_threshold,flag_force_create_mat,flag_force_create_tmp);
if ~local_flag_hnbrtZRgumb_skip;
fp = fopen(tmp_local_fname_output_label); local_output_label__ = textscan(fp,'%s','Delimiter','\n'); local_output_label__ = local_output_label__{1}; fclose(fp);
fp = fopen(tmp_local_fname_nlpbra_label); local_nlpbra_label__ = textscan(fp,'%s','Delimiter','\n'); local_nlpbra_label__ = local_nlpbra_label__{1}; fclose(fp);
fp = fopen(tmp_local_fname_nlpnex_label); local_nlpnex_label__ = textscan(fp,'%s','Delimiter','\n'); local_nlpnex_label__ = local_nlpnex_label__{1}; fclose(fp);
[tmp_lpv_hnbrtZRgumb] = label_to_label_enrichment_quad_4(label_xxxx_enum_,label_str_to_enum_0(local_output_label__));
%%%%%%%%;
tmp_label_tree_hnbrtZRgumb ...
= ...
label_to_tree_1( ...
 0 ...
,[] ...
...
%%%%%%%%%%%%%%%%;
if isempty(local_US_B_logn_sg__);
[tmp_U_,tmp_S_,tmp_V_] = svds(local_B_logn_sg__,local_rank_estimate_B_logn_sg);
local_US_B_logn_sg__ = tmp_U_*tmp_S_; clear tmp_U_ tmp_S_ tmp_V_;
end;%if isempty(local_US_B_logn_sg__);
[ ...
 ~ ...
,tmp_lpv_hnbrtZRgumb__ ...
,tmp_n_cluster_hnbrtZRgumb_ ...
,tmp_lpv_hnbrtZRgumb_rearrange_0__ ...
,tmp_n_cluster_hnbrtZRgumb_rearrange_0_ ...
,tmp_lpv_hnbrtZRgumb_rearrange_1__ ...
,tmp_n_cluster_hnbrtZRgumb_rearrange_1_ ...
] = ...
label_to_tree_enrichment_0( ...
 tmp_label_tree_hnbrtZRgumb ...
 ,{label_xxxx_enum_,label_xxxx_pasca_enum_,label_xxxx_isoge_enum_,label_xxxx_stage_enum_} ...
 ,global_nlpnex_threshold_ ...
 ,local_US_B_logn_sg__ ...
);
%%%%%%%%;
save(local_fname_hnbrtZRgumb_mat ...
     ,'tmp_lpv_hnbrtZRgumb__' ...
     ,'tmp_n_cluster_hnbrtZRgumb_' ...
     ,'tmp_lpv_hnbrtZRgumb_rearrange_0__' ...
     ,'tmp_n_cluster_hnbrtZRgumb_rearrange_0_' ...
...
close_fname_tmp(local_fname_hnbrtZRgumb_pre);
end;%if ~local_flag_hnbrtZRgumb_skip;
%%%%%%%%;
if exist(local_fname_hnbrtZRgumb_mat,'file');
load(local_fname_hnbrtZRgumb_mat);
fname_fig = sprintf('%s/local_lpv_nlpnex_threshold_%s_FIGA',dir_local_jpg,tmp_infix_hnbrtZRgumb_1);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1);clf;figbig;
index_louvain00pr = efind(strcmp(global_prefix_method_,'louvain00pr_default'));
index_umap00pr = efind(strcmp(global_prefix_method_,'umap00pr_default'));
index_hnbrtZRgumb = efind(strcmp(global_prefix_method_,'hnbrtZRgumb'));
%%%%%%%%;
subplot(2,2,1); hold on;
plot(global_nlpnex_threshold_,-tmp_lpv_hnbrtZRgumb__(:,1+0),'m.-');
plot(global_nlpnex_threshold_,-tmp_lpv_hnbrtZRgumb_rearrange_0__(:,1+0),'mo-');
plot(global_nlpnex_threshold_,-tmp_lpv_hnbrtZRgumb_rearrange_1__(:,1+0),'ms-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_(1+index_louvain00pr)*ones(global_n_nlpnex_threshold,1),'rx-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_(1+index_umap00pr)*ones(global_n_nlpnex_threshold,1),'k^-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_(1+index_hnbrtZRgumb)*ones(global_n_nlpnex_threshold,1),'m-');
xlabel('nlp'); ylabel('entropy');
title('all','Interpreter','none');
%%%%%%%%;
subplot(2,2,2); hold on;
plot(global_nlpnex_threshold_,-tmp_lpv_hnbrtZRgumb__(:,1+1),'m.-');
plot(global_nlpnex_threshold_,-tmp_lpv_hnbrtZRgumb_rearrange_0__(:,1+1),'mo-');
plot(global_nlpnex_threshold_,-tmp_lpv_hnbrtZRgumb_rearrange_1__(:,1+1),'ms-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_pasca_(1+index_louvain00pr)*ones(global_n_nlpnex_threshold,1),'rx-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_pasca_(1+index_umap00pr)*ones(global_n_nlpnex_threshold,1),'k^-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_pasca_(1+index_hnbrtZRgumb)*ones(global_n_nlpnex_threshold,1),'m-');
xlabel('nlp'); ylabel('entropy');
title('pasca','Interpreter','none');
%%%%%%%%;
subplot(2,2,3); hold on;
plot(global_nlpnex_threshold_,-tmp_lpv_hnbrtZRgumb__(:,1+2),'m.-');
plot(global_nlpnex_threshold_,-tmp_lpv_hnbrtZRgumb_rearrange_0__(:,1+2),'mo-');
plot(global_nlpnex_threshold_,-tmp_lpv_hnbrtZRgumb_rearrange_1__(:,1+2),'ms-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_isoge_(1+index_louvain00pr)*ones(global_n_nlpnex_threshold,1),'rx-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_isoge_(1+index_umap00pr)*ones(global_n_nlpnex_threshold,1),'k^-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_isoge_(1+index_hnbrtZRgumb)*ones(global_n_nlpnex_threshold,1),'m-');
xlabel('nlp'); ylabel('entropy');
title('isoge','Interpreter','none');
%%%%%%%%;
subplot(2,2,4); hold on;
plot(global_nlpnex_threshold_,-tmp_lpv_hnbrtZRgumb__(:,1+3),'m.-');
plot(global_nlpnex_threshold_,-tmp_lpv_hnbrtZRgumb_rearrange_0__(:,1+3),'mo-');
plot(global_nlpnex_threshold_,-tmp_lpv_hnbrtZRgumb_rearrange_1__(:,1+3),'ms-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_stage_(1+index_louvain00pr)*ones(global_n_nlpnex_threshold,1),'rx-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_stage_(1+index_umap00pr)*ones(global_n_nlpnex_threshold,1),'k^-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_stage_(1+index_hnbrtZRgumb)*ones(global_n_nlpnex_threshold,1),'m-');
xlabel('nlp'); ylabel('entropy');
title('stage','Interpreter','none');
%%%%%%%%;
sgtitle(sprintf('%s',dir_local_mat_hnbrtZRgumb),'Interpreter','none');
disp(sprintf(' %% writing %s',fname_fig));
print('-djpeg',sprintf('%s.jpg',fname_fig));
print('-depsc',sprintf('%s.eps',fname_fig));
close(gcf);
...
%%%%%%%%;
end;%if exist(local_fname_hnbrtZRgumb_mat,'file');
%%%%%%%%;
end;%if (flag_hnbrtZRgumb);
%%%%%%%%;
% loading local hnbtZRgumb results. ;
%%%%%%%%;
tmp_infix_hnbtZRgumb_0 = sprintf('hnbtZRgumb_r1'); 
tmp_infix_hnbtZRgumb_1 = sprintf('%s_g010',tmp_infix_hnbtZRgumb_0);
dir_local_mat_hnbtZRgumb = sprintf('%s/dir_tmp_%s/dir_tmp_%s',dir_local_mat,tmp_infix_hnbtZRgumb_0,tmp_infix_hnbtZRgumb_1);
tmp_local_fname_output_label = sprintf('%s/output_label__.txt',dir_local_mat_hnbtZRgumb);
tmp_local_fname_nlpbra_label = sprintf('%s/nlpbra_label__.txt',dir_local_mat_hnbtZRgumb);
tmp_local_fname_nlpnex_label = sprintf('%s/nlpnex_label__.txt',dir_local_mat_hnbtZRgumb);
flag_hnbtZRgumb = exist(tmp_local_fname_output_label,'file') & exist(tmp_local_fname_nlpbra_label,'file') & exist(tmp_local_fname_nlpnex_label,'file');
if (flag_hnbtZRgumb);
local_fname_hnbtZRgumb_pre = sprintf('%s/%s_postprocess',dir_local_mat,tmp_infix_hnbtZRgumb_1);
[local_flag_hnbtZRgumb_skip,local_fname_hnbtZRgumb_mat] = open_fname_tmp(local_fname_hnbtZRgumb_pre,date_diff_threshold,flag_force_create_mat,flag_force_create_tmp);
if ~local_flag_hnbtZRgumb_skip;
fp = fopen(tmp_local_fname_output_label); local_output_label__ = textscan(fp,'%s','Delimiter','\n'); local_output_label__ = local_output_label__{1}; fclose(fp);
fp = fopen(tmp_local_fname_nlpbra_label); local_nlpbra_label__ = textscan(fp,'%s','Delimiter','\n'); local_nlpbra_label__ = local_nlpbra_label__{1}; fclose(fp);
fp = fopen(tmp_local_fname_nlpnex_label); local_nlpnex_label__ = textscan(fp,'%s','Delimiter','\n'); local_nlpnex_label__ = local_nlpnex_label__{1}; fclose(fp);
[tmp_lpv_hnbtZRgumb] = label_to_label_enrichment_quad_4(label_xxxx_enum_,label_str_to_enum_0(local_output_label__));
%%%%%%%%;
tmp_label_tree_hnbtZRgumb ...
= ...
label_to_tree_1( ...
 0 ...
,[] ...
...
%%%%%%%%%%%%%%%%;
% Note here we use local_US_B_logn_sg__ instead of local_B_logn_sg__, ;
...
[ ...
 ~ ...
,tmp_lpv_hnbtZRgumb__ ...
,tmp_n_cluster_hnbtZRgumb_ ...
,tmp_lpv_hnbtZRgumb_rearrange_0__ ...
,tmp_n_cluster_hnbtZRgumb_rearrange_0_ ...
,tmp_lpv_hnbtZRgumb_rearrange_1__ ...
,tmp_n_cluster_hnbtZRgumb_rearrange_1_ ...
] = ...
label_to_tree_enrichment_0( ...
 tmp_label_tree_hnbtZRgumb ...
 ,{label_xxxx_enum_,label_xxxx_pasca_enum_,label_xxxx_isoge_enum_,label_xxxx_stage_enum_} ...
...
%%%%%%%%;
save(local_fname_hnbtZRgumb_mat ...
     ,'tmp_lpv_hnbtZRgumb__' ...
     ,'tmp_n_cluster_hnbtZRgumb_' ...
     ,'tmp_lpv_hnbtZRgumb_rearrange_0__' ...
     ,'tmp_n_cluster_hnbtZRgumb_rearrange_0_' ...
...
close_fname_tmp(local_fname_hnbtZRgumb_pre);
end;%if ~local_flag_hnbtZRgumb_skip;
%%%%%%%%;
if exist(local_fname_hnbtZRgumb_mat,'file');
load(local_fname_hnbtZRgumb_mat);
%%%%%%%%;
fname_fig = sprintf('%s/local_lpv_nlpnex_threshold_%s_FIGA',dir_local_jpg,tmp_infix_hnbtZRgumb_1);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1);clf;figbig;
index_louvain00 = efind(strcmp(global_prefix_method_,'louvain00_default'));
index_umap00 = efind(strcmp(global_prefix_method_,'umap00_default'));
index_hnbtZRgumb = efind(strcmp(global_prefix_method_,'hnbtZRgumb'));
%%%%%%%%;
subplot(2,2,1); hold on;
plot(global_nlpnex_threshold_,-tmp_lpv_hnbtZRgumb__(:,1+0),'m.-');
plot(global_nlpnex_threshold_,-tmp_lpv_hnbtZRgumb_rearrange_0__(:,1+0),'mo-');
plot(global_nlpnex_threshold_,-tmp_lpv_hnbtZRgumb_rearrange_1__(:,1+0),'ms-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_(1+index_louvain00)*ones(global_n_nlpnex_threshold,1),'rx-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_(1+index_umap00)*ones(global_n_nlpnex_threshold,1),'k^-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_(1+index_hnbtZRgumb)*ones(global_n_nlpnex_threshold,1),'m-');
xlabel('nlp'); ylabel('entropy');
title('all','Interpreter','none');
%%%%%%%%;
subplot(2,2,2); hold on;
plot(global_nlpnex_threshold_,-tmp_lpv_hnbtZRgumb__(:,1+1),'m.-');
plot(global_nlpnex_threshold_,-tmp_lpv_hnbtZRgumb_rearrange_0__(:,1+1),'mo-');
plot(global_nlpnex_threshold_,-tmp_lpv_hnbtZRgumb_rearrange_1__(:,1+1),'ms-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_pasca_(1+index_louvain00)*ones(global_n_nlpnex_threshold,1),'rx-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_pasca_(1+index_umap00)*ones(global_n_nlpnex_threshold,1),'k^-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_pasca_(1+index_hnbtZRgumb)*ones(global_n_nlpnex_threshold,1),'m-');
xlabel('nlp'); ylabel('entropy');
title('pasca','Interpreter','none');
%%%%%%%%;
subplot(2,2,3); hold on;
plot(global_nlpnex_threshold_,-tmp_lpv_hnbtZRgumb__(:,1+2),'m.-');
plot(global_nlpnex_threshold_,-tmp_lpv_hnbtZRgumb_rearrange_0__(:,1+2),'mo-');
plot(global_nlpnex_threshold_,-tmp_lpv_hnbtZRgumb_rearrange_1__(:,1+2),'ms-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_isoge_(1+index_louvain00)*ones(global_n_nlpnex_threshold,1),'rx-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_isoge_(1+index_umap00)*ones(global_n_nlpnex_threshold,1),'k^-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_isoge_(1+index_hnbtZRgumb)*ones(global_n_nlpnex_threshold,1),'m-');
xlabel('nlp'); ylabel('entropy');
title('isoge','Interpreter','none');
%%%%%%%%;
subplot(2,2,4); hold on;
plot(global_nlpnex_threshold_,-tmp_lpv_hnbtZRgumb__(:,1+3),'m.-');
plot(global_nlpnex_threshold_,-tmp_lpv_hnbtZRgumb_rearrange_0__(:,1+3),'mo-');
plot(global_nlpnex_threshold_,-tmp_lpv_hnbtZRgumb_rearrange_1__(:,1+3),'ms-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_stage_(1+index_louvain00)*ones(global_n_nlpnex_threshold,1),'rx-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_stage_(1+index_umap00)*ones(global_n_nlpnex_threshold,1),'k^-');
plot(global_nlpnex_threshold_,-local_lpv_xxxx_stage_(1+index_hnbtZRgumb)*ones(global_n_nlpnex_threshold,1),'m-');
xlabel('nlp'); ylabel('entropy');
title('stage','Interpreter','none');
%%%%%%%%;
sgtitle(sprintf('%s',dir_local_mat_hnbtZRgumb),'Interpreter','none');
disp(sprintf(' %% writing %s',fname_fig));
print('-djpeg',sprintf('%s.jpg',fname_fig));
print('-depsc',sprintf('%s.eps',fname_fig));
close(gcf);
...
%%%%%%%%;
end;%if exist(local_fname_hnbtZRgumb_mat,'file');
%%%%%%%%;
end;%if (flag_hnbtZRgumb);
%%%%%%%%;
%%%%%%%%%%%%%%%%;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
