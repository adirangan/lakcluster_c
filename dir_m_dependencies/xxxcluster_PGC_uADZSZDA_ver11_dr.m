% scp -p rangan@access1.cims.nyu.edu:/data/rangan/dir_bcc/dir_PGC_20180304/dir_m/xxxcluster_PGC_uADZSZDA_ver11_dr.m /scratch/avr209/dir_PGC_20180304/dir_m/ ;
...
%%%%%%%%%%%%%%%%;
  ...
  flag_verbose=0;
  flag_dex_vs_lak = {'lak'}; 
  flag_reverse=0;%flag_reverse=[0,1]; 
  cl_num=2; 
  ...
  nshuffle=0;
  xxxcluster_PGC_uADZSZDA_ver11(dir_code,dir_trunk,string_prefix,maf_lo_threshold,maf_hi_threshold,flag_dex_vs_lak{1},flag_reverse,Icat,n_mds,mds_used_,mds_repl,gamma,B_MLT,Ireq,nshuffle,flag_rerun,pbs_walltime,slurm_walltime,slurm_nnodes,slurm_tpn,slurm_memdecl,row_factor,col_factor,flag_verbose);
  end;%for n_cov=[0,1,2]; 
  end;%for n_maf = [5,4]; 
...
nshuffle=0; xxxcluster_PGC_uADZSZDA_ver11(dir_code,dir_trunk,string_prefix,maf_lo_threshold,maf_hi_threshold,flag_dex_vs_lak{1},flag_reverse,Icat,n_mds,mds_used_,mds_repl,gamma,B_MLT,Ireq,nshuffle,flag_rerun,pbs_walltime,slurm_walltime,slurm_nnodes,slurm_tpn,slurm_memdecl,row_factor,col_factor,flag_verbose);
end;%if (flag_platform==1);
if (flag_platform==3);
for nshuffle=1:64; xxxcluster_PGC_uADZSZDA_ver11(dir_code,dir_trunk,string_prefix,maf_lo_threshold,maf_hi_threshold,flag_dex_vs_lak{1},flag_reverse,Icat,n_mds,mds_used_,mds_repl,gamma,B_MLT,Ireq,nshuffle,flag_rerun,pbs_walltime,slurm_walltime,slurm_nnodes,slurm_tpn,slurm_memdecl,row_factor,col_factor,flag_verbose); end;
