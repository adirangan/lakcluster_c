function dolphin_dXX_8(dXX,n_shuffle,age_percentile_range_,flag_constrain_CC,sex_constrain,flag_drift0);
...
for flag_drift0=1:2;
%%%%;
dXX = 0; n_shuffle = 256; flag_constrain_CC = 1; sex_constrain = 'M';
dolphin_dXX_8(dXX,n_shuffle,[ 0, 21],flag_constrain_CC,sex_constrain,flag_drift0);
dolphin_dXX_8(dXX,n_shuffle,[21, 73],flag_constrain_CC,sex_constrain,flag_drift0);
dolphin_dXX_8(dXX,n_shuffle,[73,100],flag_constrain_CC,sex_constrain,flag_drift0);
dolphin_dXX_8(dXX,n_shuffle,[],flag_constrain_CC,sex_constrain,flag_drift0);
%%%%;
dXX = 0; n_shuffle = 256; flag_constrain_CC = 0; sex_constrain = 'M';
dolphin_dXX_8(dXX,n_shuffle,[ 0, 21],flag_constrain_CC,sex_constrain,flag_drift0);
dolphin_dXX_8(dXX,n_shuffle,[21, 73],flag_constrain_CC,sex_constrain,flag_drift0);
dolphin_dXX_8(dXX,n_shuffle,[73,100],flag_constrain_CC,sex_constrain,flag_drift0);
dolphin_dXX_8(dXX,n_shuffle,[],flag_constrain_CC,sex_constrain,flag_drift0);
%%%%;
dXX = 0; n_shuffle = 256; flag_constrain_CC = 1; sex_constrain = 'F';
dolphin_dXX_8(dXX,n_shuffle,[ 0, 14],flag_constrain_CC,sex_constrain,flag_drift0);
dolphin_dXX_8(dXX,n_shuffle,[14, 68],flag_constrain_CC,sex_constrain,flag_drift0);
dolphin_dXX_8(dXX,n_shuffle,[68,100],flag_constrain_CC,sex_constrain,flag_drift0);
dolphin_dXX_8(dXX,n_shuffle,[],flag_constrain_CC,sex_constrain,flag_drift0);
%%%%;
dXX = 0; n_shuffle = 256; flag_constrain_CC = 0; sex_constrain = 'F';
dolphin_dXX_8(dXX,n_shuffle,[ 0, 14],flag_constrain_CC,sex_constrain,flag_drift0);
dolphin_dXX_8(dXX,n_shuffle,[14, 68],flag_constrain_CC,sex_constrain,flag_drift0);
dolphin_dXX_8(dXX,n_shuffle,[68,100],flag_constrain_CC,sex_constrain,flag_drift0);
dolphin_dXX_8(dXX,n_shuffle,[],flag_constrain_CC,sex_constrain,flag_drift0);
%%%%;
dXX = 0; n_shuffle = 256; flag_constrain_CC = 1; sex_constrain = '';
dolphin_dXX_8(dXX,n_shuffle,[ 0, 20],flag_constrain_CC,sex_constrain,flag_drift0);
dolphin_dXX_8(dXX,n_shuffle,[20, 70],flag_constrain_CC,sex_constrain,flag_drift0);
dolphin_dXX_8(dXX,n_shuffle,[70,100],flag_constrain_CC,sex_constrain,flag_drift0);
dolphin_dXX_8(dXX,n_shuffle,[],flag_constrain_CC,sex_constrain,flag_drift0);
%%%%;
dXX = 0; n_shuffle = 256; flag_constrain_CC = 0; sex_constrain = '';
dolphin_dXX_8(dXX,n_shuffle,[ 0, 20],flag_constrain_CC,sex_constrain,flag_drift0);
dolphin_dXX_8(dXX,n_shuffle,[20, 70],flag_constrain_CC,sex_constrain,flag_drift0);
dolphin_dXX_8(dXX,n_shuffle,[70,100],flag_constrain_CC,sex_constrain,flag_drift0);
dolphin_dXX_8(dXX,n_shuffle,[],flag_constrain_CC,sex_constrain,flag_drift0);
%%%%;
end;%for flag_drift0=1:2;
...
if (nargin<1+na); flag_constrain_CC = []; end; na=na+1;
if (nargin<1+na); sex_constrain = []; end; na=na+1;
if (nargin<1+na); flag_drift0 = []; end; na=na+1;

% test with: ;
% dXX = 0; n_shuffle = 256; age_percentile_range_ = []; flag_constrain_CC = 1; sex_constrain = '';
...
if (isempty(flag_drift0)); flag_drift0 = 1; end;
...
fname_infix = sprintf('aid%.2dd%dc%dC%d%s',dXX,flag_drift0,flag_center,flag_constrain_CC,sex_constrain);
end;%if ( isempty(age_percentile_range_));
if (~isempty(age_percentile_range_));
fname_infix = sprintf('aid%.2d_age%.2d%.2d_d%dc%dC%d%s',dXX,min(age_percentile_range_),min(99,max(age_percentile_range_)),flag_drift0,flag_center,flag_constrain_CC,sex_constrain);
end;%if (~isempty(age_percentile_range_));
