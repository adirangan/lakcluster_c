...
'v1/ms.bip_butr_eur-qc.fam',...
'v1/ms.bip_uktr_eur-qc.fam',...
};
...
print('-depsc','./lisa_mds_extract_2_A.eps');
...
print('-depsc','./lisa_mds_extract_2_study_A_histogram.eps');
...
print('-depsc','./lisa_mds_extract_2_study_A_overlap.eps');
...
set(gca,'XTick',1:n_study,'XTickLabel',fam_label_,'XTickLabelRotation',90);
set(gcf,'Position',1+[1,1,1024,524]);
print('-depsc','./lisa_mds_extract_2_famex_A_overlap.eps');
...
set(gcf,'Position',1+[1,1,1024,512]);
print('-depsc','./lisa_mds_extract_2_study_B_histogram.eps');
...
set(gca,'YTick',1:n_study,'YTickLabel',fam_label_);
set(gcf,'Position',1+[1,1,1024,524]);
print('-depsc','./lisa_mds_extract_2_study_B_overlap.eps');
...
print('-depsc','./lisa_mds_extract_2_mds12.eps');
...
set(gcf,'Position',1+[0,0,512*3,512*2]);
print('-depsc','./lisa_mds_extract_2_mds34.eps');
