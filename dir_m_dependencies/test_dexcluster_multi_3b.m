function test_dexcluster_multi_3b(M,N,snr,n_cluster,gamma,n_rank,n_iteration,n_shuffle,flag_rerun);
% tries to find up to 8 clusters. ;
% single rank. ;
% see test_dexcluster_multi_3b_collect.m ;
%{

  %M = 178; N = 2e3; n_cluster = 1; gamma = 0.0; n_rank = 2; n_iteration = 8; n_shuffle = 256; flag_rerun = 0;
  M = 178; N = 2e3; n_cluster = 3; gamma = 0.0; n_rank = 4; n_iteration = 8; n_shuffle = 256; flag_rerun = 0;	
  ...
  for nstep=1:n_step;
  snr = snr_(nstep);
  test_dexcluster_multi_3b(M,N,snr,n_cluster,gamma,n_rank,n_iteration,n_shuffle,flag_rerun);
...
dir_base = sprintf('%s/dir_dexcluster_multi_3b',dir_trunk);
n_rank_sub = 1;
...
lpv_ = zeros(n_rank_sub,1); lP0_ = zeros(n_rank_sub,1); fla_ = zeros(n_rank_sub,1); label_B__ = cell(n_rank_sub,1);
for nrank_sub=1:n_rank_sub;
A_n_sub_ = fast_tsne_dr_0(U_,struct('rand_seed',1,'no_dims',2,'theta',0));
opts_isosplit5 = struct('K_init',200,'isocut_threshold',1.0);
label_B__{nrank_sub} = transpose(isosplit5(transpose(A_n_sub_),opts_isosplit5));
[lpv_(nrank_sub),lP0_(nrank_sub),fla_(nrank_sub)] = label_to_label_enrichment_3(label_A_,label_B__{nrank_sub});
end;%for nrank_sub=1:n_rank_sub;
...
for nrank_sub=1:n_rank_sub;
A_n_sub_ = fast_tsne_dr_0(U_,struct('rand_seed',1,'no_dims',2,'theta',0.5));
opts_isosplit5 = struct('K_init',200,'isocut_threshold',1.0);
label_B__{nrank_sub} = transpose(isosplit5(transpose(A_n_sub_),opts_isosplit5));
[lpv_(nrank_sub),lP0_(nrank_sub),fla_(nrank_sub)] = label_to_label_enrichment_3(label_A_,label_B__{nrank_sub});
end;%for nrank_sub=1:n_rank_sub;
...
label_B__ = cell(n_rank_sub,1);
for nrank_sub=1:n_rank_sub;
[A_n_sub_, ~, label_B__{nrank_sub}]=run_umap(U_,'verbose','none');
[lpv_(nrank_sub),lP0_(nrank_sub),fla_(nrank_sub)] = label_to_label_enrichment_3(label_A_,label_B__{nrank_sub});
end;%for nrank_sub=1:n_rank_sub;
%%%%%%%%;
...
label_B__ = cell(n_rank_sub,1);
for nrank_sub=1:n_rank_sub;
[A_n_sub_, ~, ~]=run_umap(U_,'verbose','none');
opts_isosplit5 = struct('K_init',200,'isocut_threshold',1.0);
label_B__{nrank_sub} = transpose(isosplit5(transpose(A_n_sub_),opts_isosplit5));
[lpv_(nrank_sub),lP0_(nrank_sub),fla_(nrank_sub)] = label_to_label_enrichment_3(label_A_,label_B__{nrank_sub});
end;%for nrank_sub=1:n_rank_sub;
...
dir_out = []; E_array_base_ = U_; E_array_r_ij_ = []; E_array_c_ij_ = []; p_set = []; n_member_lob = 2;
