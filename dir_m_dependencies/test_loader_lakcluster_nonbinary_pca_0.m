function [tmp_E1_pos_,tmp_E0_pos_] = test_loader_lakcluster_nonbinary_pca_0(E_array_,gamma,niteration,prefix,n_rank);
...
if (~exist(str_trace,'file') |  flag_force_create);
disp(sprintf(' %% %s not found, must creat!',str_trace));
end;%if (~exist(str_trace,'file') |  flag_force_create);
%%%%%%%%;
