function lisa_dosage_pca_ver9(n_scramble_use,flag_stage);
...
%%%%%%%%;
V_rx_trnx_perm_and_ = zeros(length(dud_),2);
V_rx_trnx_perm_xor_ = zeros(length(dud_),2);
V_rx_trnx_perm_nor_ = zeros(length(dud_),2);
V_rx_tstx_perm_and_ = zeros(length(dud_),2);
V_rx_tstx_perm_xor_ = zeros(length(dud_),2);
V_rx_tstx_perm_nor_ = zeros(length(dud_),2);
...
nbu1 = tmp_bu1_(1);
V_rx_trnx_perm_and_(ndud,:) = V_rx_trnx_arm1_and_(nbu1,:);
V_rx_trnx_perm_xor_(ndud,:) = V_rx_trnx_arm1_xor_(nbu1,:);
V_rx_trnx_perm_nor_(ndud,:) = V_rx_trnx_arm1_nor_(nbu1,:);
V_rx_tstx_perm_and_(ndud,:) = V_rx_tstx_arm1_and_(nbu1,:);
V_rx_tstx_perm_xor_(ndud,:) = V_rx_tstx_arm1_xor_(nbu1,:);
V_rx_tstx_perm_nor_(ndud,:) = V_rx_tstx_arm1_nor_(nbu1,:);
