...
test_loader_dexcluster_nonbinary_rdrop_trace_ZRimax_recursive_5( ...
 dir_trunk ...
,dir_out ...
,prefix_base ...
,E_array_base_ ...
...
if (verbose>0); disp(sprintf(' %% [entering test_loader_dexcluster_nonbinary_rdrop_trace_ZRimax_recursive_5]: dir_out %s',dir_out)); end;
...
[~,~,~,tmp_p_opt,tmp_p_emp] = gumbel_fit(max(ZR_E_(:,2:end),[],1),max(ZR_E_(:,1)));
