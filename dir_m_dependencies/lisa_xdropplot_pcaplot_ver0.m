...
%%%%%%%%%%%%%%%% ;
fname_tmp = sprintf('%s/i_trn%d_tst%d.mat',dir_out_s0000_pca_arm1,cl_num_arm1,cl_num_arm2);
if (exist(fname_tmp,'file')); disp(sprintf(' %% loading %s',fname_tmp)); load(fname_tmp); end;
if (~exist(fname_tmp,'file')); disp(sprintf(' %% creating %s',fname_tmp)); 
[~,i_arm1,i_arm2] = intersect(bim_arm1_condensed_,bim_arm2_condensed_,'stable');
save(fname_tmp,'i_arm1','i_arm2');
...
drawnow();
fname_fig = sprintf('%s/%s_pca_proj_ni%d_tst%d.jpg',dir_out_s0000_pca_arm1,string_name_s0000_arm1,niteration,cl_num_arm2); print('-djpeg',fname_fig);
