...
% single rank. ;
% see test_hnbtZRgumb_multi_6_collect.m ;
...
for nl=0:0;
na=0;   
if (nl==na); M =  563; N = 6325; n_cluster = 6; snr = 0.80; n_iteration = 32; n_shuffle =  64; end; na=na+1;
flag_rerun = 0;
n_rank_ = min(min(M,N),(1+n_cluster) + [0,1,2,4,8,16,32,64,128,256,512,1024]);
...
if (verbose); disp(sprintf(' %% [entering test_hnbtZRgumb_multi_6]')); end;
...
if (verbose); disp(sprintf(' %% [finished test_hnbtZRgumb_multi_6]')); end;
