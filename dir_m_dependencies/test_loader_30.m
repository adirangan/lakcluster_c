...
[tmp_U_E_fill__,tmp_S_E_fill__,tmp_V_E_fill__] = svds(E_fill_,rank_estimate);
...
[tmp_U_I_fill__,tmp_S_I_fill__,tmp_V_I_fill__] = svds(I_fill_,rank_estimate);
...
%%%%%%%%;
n_rank_imputation = 16; %<-- same as rank_estimate. ;
...
[~,E_li16f_] = svd_impute_fit_3(log(max(1e-12,E_val_)),E_ij_missing_,n_rank_imputation,E_li16_prefix_,tmp_rseed,tmp_n_iteration,tmp_tolerance);
%save(sprintf('%s/E_li16_.mat',dir_mat),'E_li16_');
save(sprintf('%s/E_li16f_.mat',dir_mat),'E_li16f_');
...
[~,I_li16f_] = svd_impute_fit_3(log(max(1e-12,I_val_)),I_ij_missing_,n_rank_imputation,I_li16_prefix_,tmp_rseed,tmp_n_iteration,tmp_tolerance);
%save(sprintf('%s/I_li16_.mat',dir_mat),'I_li16_');
save(sprintf('%s/I_li16f_.mat',dir_mat),'I_li16f_');
...
if flag_load==1;
%load(sprintf('%s/E_li16_.mat',dir_mat),'E_li16_');
%load(sprintf('%s/I_li16_.mat',dir_mat),'I_li16_');
load(sprintf('%s/E_li16f_.mat',dir_mat),'E_li16f_');
load(sprintf('%s/I_li16f_.mat',dir_mat),'I_li16f_');
end;%if flag_load==1;
...
test_loader_dexcluster_nonbinary_trace_ZRimax_recursive_2(dir_cluster,dir_out,prefix_base,E_array_base_,E_array_r_ij_,E_array_c_ij_,gamma,n_shuffle,p_set,n_member_lob);
%ZRimax_label_ = test_loader_dexcluster_nonbinary_trace_ZRimax_recursive_2(dir_cluster,dir_out,prefix_base,E_array_base_,E_array_r_ij_,E_array_c_ij_,gamma,n_shuffle,p_set,n_member_lob);
p_set_ = [0.05]*0.5.^[0:3];
for np=1:length(p_set_);
tmp_p_set = p_set_(np);
tmp_ZRimax_label_ = test_loader_dexcluster_nonbinary_trace_ZRimax_recursive_2(dir_cluster,dir_out,prefix_base,E_array_base_,E_array_r_ij_,E_array_c_ij_,gamma,n_shuffle,tmp_p_set,n_member_lob);
subplot(2,2,np);
...
prefix_base = sprintf('Ccavg0_%s',str_xfix); 
dir_out = []; E_array_base_ = transpose(Ccavg0_); E_array_r_ij_ = []; E_array_c_ij_ = [];
test_loader_lakcluster_nonbinary_trace_ZRimax_recursive_2(dir_cluster,dir_out,prefix_base,E_array_base_,E_array_r_ij_,E_array_c_ij_,gamma,n_shuffle,p_set,n_member_lob);
%ZRimax_label_ = test_loader_lakcluster_nonbinary_trace_ZRimax_recursive_2(dir_cluster,dir_out,prefix_base,E_array_base_,E_array_r_ij_,E_array_c_ij_,gamma,n_shuffle,p_set,n_member_lob);
p_set_ = [0.05]*0.5.^[0:3];
for np=1:length(p_set_);
tmp_p_set = p_set_(np);
tmp_ZRimax_label_ = test_loader_lakcluster_nonbinary_trace_ZRimax_recursive_2(dir_cluster,dir_out,prefix_base,E_array_base_,E_array_r_ij_,E_array_c_ij_,gamma,n_shuffle,tmp_p_set,n_member_lob);
subplot(2,2,np);
scatter(tmp_VCcavg0_(:,1),tmp_VCcavg0_(:,2),15,label_str_to_enum_0(tmp_ZRimax_label_));
colormap('lines');
title(sprintf('p %0.6f',tmp_p_set));
...
%UEC_ = inv(tmp_SE_)*transpose(tmp_UE_)*mean_center_0(C_rank_); %<-- explicit mean-centering not required, since this is built-in to dexcluster. ;
...
%%%%%%%%;
p_set = 0.05; 
[ZRimax_output_label_,ZRimax_lpFmax_label_] = test_loader_dexcluster_nonbinary_trace_ZRimax_recursive_2(dir_cluster,dir_out,prefix_base,E_array_base_,E_array_r_ij_,E_array_c_ij_,gamma,n_shuffle,p_set,n_member_lob);
...
test_loader_dexcluster_nonbinary_trace_ZRimax_recursive_2(dir_cluster,dir_out,prefix_base,I_array_base_,I_array_r_ij_,I_array_c_ij_,gamma,n_shuffle,p_set,n_member_lob);
%ZRimax_label_ = test_loader_dexcluster_nonbinary_trace_ZRimax_recursive_2(dir_cluster,dir_out,prefix_base,I_array_base_,I_array_r_ij_,I_array_c_ij_,gamma,n_shuffle,p_set,n_member_lob);
p_set_ = [0.05]*0.5.^[0:3];
for np=1:length(p_set_);
tmp_p_set = p_set_(np);
tmp_ZRimax_label_ = test_loader_dexcluster_nonbinary_trace_ZRimax_recursive_2(dir_cluster,dir_out,prefix_base,I_array_base_,I_array_r_ij_,I_array_c_ij_,gamma,n_shuffle,tmp_p_set,n_member_lob);
subplot(2,2,np);
...
test_loader_dexcluster_nonbinary_trace_ZRimax_recursive_2(dir_cluster,dir_out,prefix_base,EI_array_base_,EI_array_r_ij_,EI_array_c_ij_,gamma,n_shuffle,p_set,n_member_lob);
%ZRimax_label_ = test_loader_dexcluster_nonbinary_trace_ZRimax_recursive_2(dir_cluster,dir_out,prefix_base,EI_array_base_,EI_array_r_ij_,EI_array_c_ij_,gamma,n_shuffle,p_set,n_member_lob);
p_set_ = [0.05]*0.5.^[0:3];
for np=1:length(p_set_);
tmp_p_set = p_set_(np);
tmp_ZRimax_label_ = test_loader_dexcluster_nonbinary_trace_ZRimax_recursive_2(dir_cluster,dir_out,prefix_base,EI_array_base_,EI_array_r_ij_,EI_array_c_ij_,gamma,n_shuffle,tmp_p_set,n_member_lob);
subplot(2,2,np);
scatter(tmp_VX_(:,1),tmp_VX_(:,2),15,label_str_to_enum_0(tmp_ZRimax_label_));
colormap('lines');
title(sprintf('p %0.6f',tmp_p_set));
...
test_loader_helper_wrap_2(dir_trunk,n_iteration_wrap,n_Sample_Label,str_Sample_Label_,C_VariableName_LC_,E_li16f_rankn_,I_li16f_rankn_,xeta_RRR_li16f_rankn_cUE1_,n_rank_wrap);
n_iteration_wrap = 128;n_rank_wrap = 5;
test_loader_helper_wrap_2(dir_trunk,n_iteration_wrap,n_Sample_Label,str_Sample_Label_,C_VariableName_LC_,E_li16f_rankn_,I_li16f_rankn_,xeta_RRR_li16f_rankn_cUE2_,n_rank_wrap);
n_iteration_wrap = 128;n_rank_wrap = 8;
test_loader_helper_wrap_2(dir_trunk,n_iteration_wrap,n_Sample_Label,str_Sample_Label_,C_VariableName_LC_,E_li16f_rankn_,I_li16f_rankn_,xeta_RRR_li16f_rankn_cUE3_,n_rank_wrap);
n_iteration_wrap = 128;n_rank_wrap = 1;
test_loader_helper_wrap_2(dir_trunk,n_iteration_wrap,n_Sample_Label,str_Sample_Label_,C_VariableName_LC_,E_li16f_rankn_,I_li16f_rankn_,xeta_RRR_li16f_rankn_cUE4_,n_rank_wrap);
n_iteration_wrap = 128;n_rank_wrap = 1;
test_loader_helper_wrap_2(dir_trunk,n_iteration_wrap,n_Sample_Label,str_Sample_Label_,C_VariableName_LC_,E_li16f_rankn_,I_li16f_rankn_,xeta_RRR_li16f_rankn_cUE5_,n_rank_wrap);
n_iteration_wrap = 128;n_rank_wrap = 8;
test_loader_helper_wrap_2(dir_trunk,n_iteration_wrap,n_Sample_Label,str_Sample_Label_,C_VariableName_LC_,E_li16f_rankn_,I_li16f_rankn_,xeta_RRR_li16f_rankn_cUE6_,n_rank_wrap);
%%%%%%%%;
n_iteration_wrap = 128;n_rank_wrap = 12;
%%%%%%%%;
test_loader_helper_wrap_2(dir_trunk,n_iteration_wrap,n_Sample_Label,str_Sample_Label_,C_VariableName_LC_,E_li16f_rankn_,I_li16f_rankn_,xeta_RRR_li16f_rankn_cPhr_,n_rank_wrap);
test_loader_helper_wrap_2(dir_trunk,n_iteration_wrap,n_Sample_Label,str_Sample_Label_,C_VariableName_LC_,E_li16f_rankn_,I_li16f_rankn_,xeta_RRR_li16f_rankn_c127_,n_rank_wrap);
test_loader_helper_wrap_2(dir_trunk,n_iteration_wrap,n_Sample_Label,str_Sample_Label_,C_VariableName_LC_,E_li16f_rankn_,I_li16f_rankn_,xeta_RRR_li16f_rankn_c012_,n_rank_wrap);
test_loader_helper_wrap_2(dir_trunk,n_iteration_wrap,n_Sample_Label,str_Sample_Label_,C_VariableName_LC_,E_li16f_rankn_,I_li16f_rankn_,xeta_RRR_li16f_rankn_cRRR_,n_rank_wrap);
...
str_Y_ = {'li16f_rankn'}; n_Y = numel(str_Y_);
