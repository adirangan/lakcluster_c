function [output_label_,lpFmax_label_] = test_loader_dexcluster_nonbinary_trace_ZRimax_recursive_2(dir_trunk,dir_out,prefix_base,E_array_base_,E_array_r_ij_,E_array_c_ij_,gamma,n_shuffle,p_set,n_member_lob);
...
if (verbose>0); disp(sprintf(' %% [entering test_loader_dexcluster_nonbinary_trace_ZRimax_recursive_2]: dir_out %s',dir_out)); end;
...
lpFmax_label_ = cell(n_u,1); for nu=1:n_u; lpFmax_label_{nu} = '0'; end;
...
load(str_branch,'branch_A_r_ij_','branch_B_r_ij_','p_branch','lp_R_F_max');
if (p_branch>p_set);
...
[tmp_output_label_,tmp_lpFmax_label_] = test_loader_dexcluster_nonbinary_trace_ZRimax_recursive_2(dir_trunk,dir_A_out,prefix_base,E_array_base_,E_array_A_r_ij_,E_array_A_c_ij_,gamma,n_shuffle,p_set,n_member_lob);
...
[tmp_output_label_,tmp_lpFmax_label_] = test_loader_dexcluster_nonbinary_trace_ZRimax_recursive_2(dir_trunk,dir_B_out,prefix_base,E_array_base_,E_array_B_r_ij_,E_array_B_c_ij_,gamma,n_shuffle,p_set,n_member_lob);
...
E_array_A_r_ij_ = E_array_r_ij_(branch_A_r_ij_); E_array_A_c_ij_ = E_array_c_ij_;
if (verbose>1); disp(sprintf(' %% %s <-- calling (n_sample = %d)',dir_A_out,length(E_array_A_r_ij_))); end;
test_loader_dexcluster_nonbinary_trace_ZRimax_recursive_2(dir_trunk,dir_A_out,prefix_base,E_array_base_,E_array_A_r_ij_,E_array_A_c_ij_,gamma,n_shuffle,p_set,n_member_lob);
dir_B_out = sprintf('%s/dir_B',dir_out); if (~exist(dir_B_out,'dir')); disp(sprintf(' %% mkdir %s',dir_B_out)); mkdir(dir_B_out); end;
E_array_B_r_ij_ = E_array_r_ij_(branch_B_r_ij_); E_array_B_c_ij_ = E_array_c_ij_;
if (verbose>1); disp(sprintf(' %% %s <-- calling (n_sample = %d)',dir_B_out,length(E_array_B_r_ij_))); end;
test_loader_dexcluster_nonbinary_trace_ZRimax_recursive_2(dir_trunk,dir_B_out,prefix_base,E_array_base_,E_array_B_r_ij_,E_array_B_c_ij_,gamma,n_shuffle,p_set,n_member_lob);
end;%if strcmp(type_code,'split');
