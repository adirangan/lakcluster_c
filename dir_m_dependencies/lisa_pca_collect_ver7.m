function lisa_pca_collect_ver7(cl_num_arm1,cl_num_arm2,flag_reverse_use,flag_rerun);
...
%{
  ...
  lisa_pca_collect_ver7(cl_num_arm1,cl_num_arm2,flag_reverse_use,flag_rerun); 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
pca_fname_mat = sprintf('%s/%s_pca_collect_ver7_trn%d_tst%d.mat',dir_out_s0000_pca_r0_arm1,string_name_r0_arm1,cl_num_arm1,cl_num_arm2); 
