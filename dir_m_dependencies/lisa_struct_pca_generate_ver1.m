function [lisa_arm1,lisa_arm2] = lisa_struct_pca_generate_ver1(specification) ;
%{
  ...
  lisa_struct_pca_generate_ver1(specification) ;
...
fprintf(fp,'END= 0;\n');
fprintf(fp,'%% generated by lisa_struct_pca_generate_ver1 on %s;\n',date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ;
fclose(fp);
type(fname__in);
