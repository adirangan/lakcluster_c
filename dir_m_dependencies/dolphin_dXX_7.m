function dolphin_dXX_7(dXX,n_shuffle,age_percentile_range_,flag_constrain_CC);
%{
...
if (nargin<1);
dXX = 0; n_shuffle = 256; flag_constrain_CC = 1;
dolphin_dXX_7(dXX,n_shuffle,[ 0, 30],flag_constrain_CC);
dolphin_dXX_7(dXX,n_shuffle,[20, 70],flag_constrain_CC);
dolphin_dXX_7(dXX,n_shuffle,[70,100],flag_constrain_CC);
dolphin_dXX_7(dXX,n_shuffle,[],flag_constrain_CC);
dXX = 0; n_shuffle = 256; flag_constrain_CC = 0;
dolphin_dXX_7(dXX,n_shuffle,[ 0, 30],flag_constrain_CC);
dolphin_dXX_7(dXX,n_shuffle,[20, 70],flag_constrain_CC);
dolphin_dXX_7(dXX,n_shuffle,[70,100],flag_constrain_CC);
dolphin_dXX_7(dXX,n_shuffle,[],flag_constrain_CC);
%for dXX=0:145;
%n_shuffle = 64;
%try;dolphin_dXX_7(dXX,n_shuffle);catch;disp(sprintf(' %% error processing dXX %.3d',dXX)); end;%try;
%end;%for dXX=0:145;
...
if (nargin<4); flag_constrain_CC = []; end;
