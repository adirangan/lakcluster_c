function rank_estimate = rank_estimate_0(A__,p_val_0in);
...
rank_estimate = rank_estimate_0(A__);
...
figure(2); clf;
plot(1:n_dim,S_A_,'ko-',1:rank_estimate,S_A_(1:rank_estimate),'rx','MarkerSize',15);
xlim([1,n_dim]); xlabel('rank');ylabel('sigma'); 
title(sprintf('rank %d',rank_estimate));
end;%if (verbose); 
