function [C_,D_,niteration] = svd_impute_fit_2(B_,ij_missed_,n_rank,f_scale_,str_prefix,rseed,n_iteration,tolerance);
...
[C_,D_,niteration] = svd_impute_fit_2(B_,ij_missed_,4);
figure(1);clf;
...
if (verbose_flag); disp(sprintf(' %% [entering svd_impute_fit_2] str_prefix %s',str_prefix)); end;
...
f_scale_opt_ = fminsearch(fh_,[1;1],optimset('TolFun',1e-3,'TolX',1e-3));
...
if (verbose_flag); disp(sprintf(' %% [finished svd_impute_fit_2] str_prefix %s',str_prefix)); end;
