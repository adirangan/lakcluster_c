function lisa_pca_collect_ver5(dir_code,dir_trunk,cl_num,flag_dex_vs_lak,gamma,B_MLT,n_mds,flag_reverse,n_maf,n_cov,n_scramble,n_shuffle) ;
%{
...
flag_dex_vs_lak = 'lak'; 
if (strcmp(flag_dex_vs_lak,'dex')); gamma = 0.004; end; if (strcmp(flag_dex_vs_lak,'lak')); gamma = 0.001; end;
B_MLT=34;n_mds=20;
flag_reverse=1;
n_maf = 4;
n_cov = 2;
n_shuffle = 64; n_scramble = 0;
lisa_pca_collect_ver5(dir_code,dir_trunk,cl_num,flag_dex_vs_lak,gamma,B_MLT,n_mds,flag_reverse,n_maf,n_cov,n_scramble,n_shuffle) ;
...
dir_trunk = sprintf('/data/rangan/dir_bcc/dir_PGC_20180304');
path(path,sprintf('%s/dir_m',dir_code)); 
for cl_num = 3;%for cl_num = 3:4;
[study_trunk_,study_name_,n_study] = lisa_define_study_ver0(cl_num);
Ireq_half = floor(n_study/2); Icat_full = n_study;
string_prefix = sprintf('PGC_cl%d_maf01',cl_num);
flag_dex_vs_lak = {'lak'}; 
if (strcmp(flag_dex_vs_lak{1},'dex')); gamma = 0.004; end; if (strcmp(flag_dex_vs_lak{1},'lak')); gamma = 0.001; end;
B_MLT=34;n_mds=20;
...
n_shuffle = 64; n_scramble=0;
try;
lisa_pca_collect_ver5(dir_code,dir_trunk,cl_num,flag_dex_vs_lak{1},gamma,B_MLT,n_mds,flag_reverse,n_maf,n_cov,n_scramble,n_shuffle) ;
catch; end;%try;
end;%for n_cov = 0:2;
end;%for n_maf = 4:5;
...
fname_mat = sprintf('%s/%s_pca_collect_ver5.mat',dir_out_s0000_pca_arm1,string_name_s0000);
...
set(gcf,'Position',1+[0,0,1024*2,1024]);
fname_pre = sprintf('%s/%s_pca_collect_ver5',dir_out_s0000_pca_arm1,string_name_s0000);
print('-djpeg',sprintf('%s.jpg',fname_pre));
print('-depsc',sprintf('%s.eps',fname_pre));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
