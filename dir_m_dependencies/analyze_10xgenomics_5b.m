function analyze_10xgenomics_5b(dir_data_infix);
%%%%%%%%;
% Testing out new label_rearrange_3.m (which iterates label_rearrange_2.m). ;
% This is implemented in: ;
% label_tree_compilation_plot_1 --> ;
% label_to_tree_node_by_node_enrichment_2 --> ;
% label_rearrange_2.m ;
%%%%%%%%;
% Verdict; does not really help that much, sometimes reduces quality. ;
%%%%%%%%;
