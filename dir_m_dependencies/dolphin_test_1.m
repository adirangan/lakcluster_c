...
[U_tru__,S_tru__] = eig(A_tru__);
S_tru_ = diag(S_tru__); for nvar=0:n_var-1; S_tru_(1+nvar) = min(-0.1,real(S_tru_(1+nvar))) + i*imag(S_tru_(1+nvar)); end; S_tru__ = diag(S_tru_);
A_tru__ = U_tru__*S_tru__*inv(U_tru__);
