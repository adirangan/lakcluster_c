function [AB_] = test_loader_helper_0(n_iteration,n_CLabel,n_CCOV,n_Z_GENE,C_Label_,C_rank_,Z_rank_,zeta_Z_un_,zeta_Z_vn_,n_zeta_Z,beta_Z_un_,beta_Z_vn_,n_beta_Z);
%%%%%%%%;
...
% Use label J_ to refer to E_licr_ * E_licr_beta_un_ ;
% Use label K_ to refer to I_licr_ * I_licr_beta_un_ ;
% Use label F_ to refer to C_rank_ * E_licr_zeta_un_ ;
% Use label H_ to refer to C_rank_ * I_licr_zeta_un_ ;
%%%%%%%%;
n_u = size(C_rank_,1);
