function [r_fr__,r_pv__,r_rtn__,r_mu__,r_sg__,r_sum__,r_cap__] = cumulative_intersect_general(r_remaining_A_,rdrop_A_,r_remaining_B_,rdrop_B_);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
% function cumulative_intersect_general(r_remaining_A_,rdrop_A_,r_remaining_B_,rdrop_B_);
% ;
...
if (nargin<4);
disp(sprintf(' %% testing cumulative_intersect_general'));
for nrng=1:100;
rng(nrng); 
n_A = 18;
...
[r_fr__,r_pv__,r_rtn__,r_mu__,r_sg__,r_sum__,r_cap__] = cumulative_intersect_general(r_remaining_A_,rdrop_A_,r_remaining_B_,rdrop_B_);
...
[r_fr__,r_pv__,r_rtn__,r_mu__,r_sg__,r_sum__,r_cap__] = cumulative_intersect_unique(ra_,ax_,rb_,bx_);
