function [lisa_arm1,lisa_arm2] = lisa_struct_dosage_pca_collect_ver0(specification) ;
%{
 ...
 %try: ;
  ...
  lisa_struct_dosage_pca_collect_ver0(specification) ;
...
lisa_arm1.dir_out_s0_pca_dosage = sprintf('%s/dir_pca_trn%d%s_tst%d%s/dir_dosage',lisa_arm1.dir_out_s0,lisa_arm1.cl_num,cl_num_arm1_string,lisa_arm2.cl_num,cl_num_arm2_string);
if (~exist(lisa_arm1.dir_out_s0_pca_dosage,'dir')); disp(sprintf(' %% mkdir %s',lisa_arm1.dir_out_s0_pca_dosage)); mkdir(lisa_arm1.dir_out_s0_pca_dosage); end;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
%fname_pca_mat = sprintf('%s/%s_pca_collect_ver0_trn%d%s_tst%d%s.mat',lisa_arm1.dir_out_s0_pca,lisa_arm1.string_name_s0,cl_num_arm1,cl_num_arm1_string,cl_num_arm2,cl_num_arm2_string); 
%if ( exist(fname_pca_mat,'file')); disp(sprintf(' %% found %s, loading',fname_pca_mat)); load(fname_pca_mat); end;
%if (~exist(fname_pca_mat,'file')); disp(sprintf(' %% Warning! could not find %s',fname_pca_mat)); end;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
...
if (lisa_arm1.verbose>0); disp(sprintf(' %% niteration %d',niteration)); end;
%%%%%%%%;
...
DnV_arm1_ = mda_read_r8(sprintf('%s/%s_k%d_B%d_AnV_.mda',lisa_arm1.dir_out_s0_pca,pca_proj_infix_arm1,pca_rank,pca_b_mlt)); %<-- Note that we use dir_out_s0_pca from arm one, since this is where the bicluster is. ;
XnV_arm1_ = mda_read_r8(sprintf('%s/%s_k%d_B%d_ZnV_.mda',lisa_arm1.dir_out_s0_pca,pca_proj_infix_arm1,pca_rank,pca_b_mlt)); %<-- Note that we use dir_out_s0_pca from arm one, since this is where the bicluster is. ;
...
%%%%%%%%;
fname_pca_dosage = sprintf('%s/%s_ni%d_dosage_stage_1.mat',lisa_arm1.dir_out_s0_pca_dosage,lisa_arm1.string_name_s0,niteration);
load(fname_pca_dosage,...
     'dosage_genotyp_DnV_arm2_',...
     'dosage_genotyp_XnV_arm2_',...
     'dosage_imputed_DnV_arm2_',...
     'dosage_imputed_XnV_arm2_',...
     'dosage_rounded_DnV_arm2_',...
     'dosage_rounded_XnV_arm2_');
...
DnV_arm2_ = mda_read_r8(sprintf('%s/%s_k%d_B%d_AnV_.mda',lisa_arm1.dir_out_s0_pca,pca_proj_infix_arm2,pca_rank,pca_b_mlt)); %<-- Note that we use dir_out_s0_pca from arm one, since this is where the bicluster is. ;
XnV_arm2_ = mda_read_r8(sprintf('%s/%s_k%d_B%d_ZnV_.mda',lisa_arm1.dir_out_s0_pca,pca_proj_infix_arm2,pca_rank,pca_b_mlt)); %<-- Note that we use dir_out_s0_pca from arm one, since this is where the bicluster is. ;
...
%%%%%%%%;
tmp_auc19_arm1 = cauc_0(XnV_arm1_(find_X_arm1_,1),DnV_arm1_(find_D_arm1_,1),lisa_arm1.mds_sort_(find_X_arm1_,[1:6,19]),lisa_arm1.mds_sort_(find_D_arm1_,[1:6,19])); flag_flip_arm1 = (tmp_auc19_arm1<0.5);
if (lisa_arm1.verbose>0); disp(sprintf(' %% tmp_auc19_arm1 %0.2f flag_flip_arm1 %d',tmp_auc19_arm1,flag_flip_arm1)); end;
tmp_auc19_arm2 = cauc_0(XnV_arm2_(find_X_arm2_,1),DnV_arm2_(find_D_arm2_,1),lisa_arm2.mds_sort_(find_X_arm2_,[1:6,19]),lisa_arm2.mds_sort_(find_D_arm2_,[1:6,19])); flag_flip_arm2 = (tmp_auc19_arm2<0.5);
if (lisa_arm1.verbose>0); disp(sprintf(' %% tmp_auc19_arm2 %0.2f flag_flip_arm2 %d',tmp_auc19_arm2,flag_flip_arm2)); end;
%%%%%%%%;
if ~flag_flip_arm1; 
tmp_DnV_arm1_ = +DnV_arm1_; 
tmp_XnV_arm1_ = +XnV_arm1_; 
tmp_DnV_arm2_ = +DnV_arm2_; 
tmp_XnV_arm2_ = +XnV_arm2_; 
tmp_dosage_genotyp_DnV_arm2_ = +dosage_genotyp_DnV_arm2_;
tmp_dosage_genotyp_XnV_arm2_ = +dosage_genotyp_XnV_arm2_;
tmp_dosage_imputed_DnV_arm2_ = +dosage_imputed_DnV_arm2_;
tmp_dosage_imputed_XnV_arm2_ = +dosage_imputed_XnV_arm2_;
tmp_dosage_rounded_DnV_arm2_ = +dosage_rounded_DnV_arm2_;
tmp_dosage_rounded_XnV_arm2_ = +dosage_rounded_XnV_arm2_;
end;%if ~flag_flip_arm1;
if  flag_flip_arm1; 
tmp_DnV_arm1_ = -DnV_arm1_; 
tmp_XnV_arm1_ = -XnV_arm1_; 
tmp_DnV_arm2_ = -DnV_arm2_; 
...
auc19_arm1 = tmp_auc19_arm1;
logp_auc19_arm1 = tmp_logp_auc19_arm1;
%%%%%%%%;
...
auc19_arm2 = tmp_auc19_arm2;
logp_auc19_arm2 = tmp_logp_auc19_arm2;
%%%%%%%%;
tmp_mds_X_ = lisa_arm2.mds_sort_(find_X_arm2_,[1:6,19]); tmp_mds_D_ = lisa_arm2.mds_sort_(find_D_arm2_,[1:6,19]);
tmp_auc19_arm2 = cauc_0(tmp_dosage_genotyp_XnV_arm2_(find_X_arm2_,1),tmp_dosage_genotyp_DnV_arm2_(find_D_arm2_,1),tmp_mds_X_,tmp_mds_D_);
tmp_logp_auc19_arm2 = log(max(1,length(find(cauc19_arm2_avg_>tmp_auc19_arm2)))/length(cauc19_arm2_avg_));
dosage_genotyp_auc19_arm2 = tmp_auc19_arm2;
dosage_genotyp_logp_auc19_arm2 = tmp_logp_auc19_arm2;
%%%%%%%%;
tmp_mds_X_ = lisa_arm2.mds_sort_(find_X_arm2_,[1:6,19]); tmp_mds_D_ = lisa_arm2.mds_sort_(find_D_arm2_,[1:6,19]);
tmp_auc19_arm2 = cauc_0(tmp_dosage_imputed_XnV_arm2_(find_X_arm2_,1),tmp_dosage_imputed_DnV_arm2_(find_D_arm2_,1),tmp_mds_X_,tmp_mds_D_);
tmp_logp_auc19_arm2 = log(max(1,length(find(cauc19_arm2_avg_>tmp_auc19_arm2)))/length(cauc19_arm2_avg_));
dosage_imputed_auc19_arm2 = tmp_auc19_arm2;
dosage_imputed_logp_auc19_arm2 = tmp_logp_auc19_arm2;
%%%%%%%%;
tmp_mds_X_ = lisa_arm2.mds_sort_(find_X_arm2_,[1:6,19]); tmp_mds_D_ = lisa_arm2.mds_sort_(find_D_arm2_,[1:6,19]);
tmp_auc19_arm2 = cauc_0(tmp_dosage_rounded_XnV_arm2_(find_X_arm2_,1),tmp_dosage_rounded_DnV_arm2_(find_D_arm2_,1),tmp_mds_X_,tmp_mds_D_);
tmp_logp_auc19_arm2 = log(max(1,length(find(cauc19_arm2_avg_>tmp_auc19_arm2)))/length(cauc19_arm2_avg_));
dosage_rounded_auc19_arm2 = tmp_auc19_arm2;
dosage_rounded_logp_auc19_arm2 = tmp_logp_auc19_arm2;
%%%%%%%%;
disp(sprintf(' %% trn%d_tst%d: %s: niteration %d: auc19_arm1 %0.6f logp_auc19_arm1 %0.6f',lisa_arm1.cl_num,lisa_arm2.cl_num,lisa_arm1.string_name_s0,niteration));
disp(sprintf(' %% trn%d_tst%d: %s: niteration %d: auc19_arm1 %0.6f logp_auc19_arm1 %0.6f',lisa_arm1.cl_num,lisa_arm2.cl_num,lisa_arm1.string_name_s0,niteration,auc19_arm1,logp_auc19_arm1));
disp(sprintf(' %% trn%d_tst%d: %s: niteration %d: auc19_arm2 %0.6f logp_auc19_arm1 %0.6f',lisa_arm1.cl_num,lisa_arm2.cl_num,lisa_arm1.string_name_s0,niteration,auc19_arm2,logp_auc19_arm2));
disp(sprintf(' %% trn%d_tst%d: %s: niteration %d: dosage_genotyp_auc19_arm2 %0.6f dosage_genotyp_logp_auc19_arm1 %0.6f',lisa_arm1.cl_num,lisa_arm2.cl_num,lisa_arm1.string_name_s0,niteration,dosage_genotyp_auc19_arm2,dosage_genotyp_logp_auc19_arm2));
disp(sprintf(' %% trn%d_tst%d: %s: niteration %d: dosage_imputed_auc19_arm2 %0.6f dosage_imputed_logp_auc19_arm1 %0.6f',lisa_arm1.cl_num,lisa_arm2.cl_num,lisa_arm1.string_name_s0,niteration,dosage_imputed_auc19_arm2,dosage_imputed_logp_auc19_arm2));
disp(sprintf(' %% trn%d_tst%d: %s: niteration %d: dosage_rounded_auc19_arm2 %0.6f dosage_rounded_logp_auc19_arm1 %0.6f',lisa_arm1.cl_num,lisa_arm2.cl_num,lisa_arm1.string_name_s0,niteration,dosage_rounded_auc19_arm2,dosage_rounded_logp_auc19_arm2));
