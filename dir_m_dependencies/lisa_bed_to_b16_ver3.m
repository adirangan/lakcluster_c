function lisa_bed_to_b16_ver3(cl_num,flag_stop,flag_crop);
...
% scp -p rangan@access1.cims.nyu.edu:/data/rangan/dir_bcc/dir_PGC_20180304/dir_m/lisa_bed_to_b16_ver3.m /home/arangan/dir_PGC_20180304/dir_m/lisa_bed_to_b16_ver3.m ;

if nargin<1; cl_num = input('cluster number? [1,2,3]'); end;
if nargin<2; flag_stop = input(' set flag_stop after bim, fam and masks are created, but before An_ and At_ are binarized? [1=yes, 0=no]'); end;
if nargin<3; flag_crop = input(' set flag_crop so that only a subset of ~1000 snps are considered? [1=yes, 0=no]'); end;
% cl_num = 3; flag_stop = 0; flag_crop = 0;
