function lisa = lisa_struct_prs_scatterplot_ver3(specification);
% try: ;
%{
  ...
  lisa_struct_prs_scatterplot_ver3(specification) ;
...
if (~exist(lisa_arm1_r1.dir_out_s0_pca,'dir')); disp(sprintf(' %% Warning! %s does not exist in lisa_struct_prs_scatterplot_ver3',lisa_arm1_r1.dir_out_s0_pca)); end;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
fname_fig = sprintf('%s/prs_scatterplot_ver3_%s_trn%d%s_tst%d%s_ni%.3d_ni%.3d.jpg',lisa_arm1_r0.dir_out_s0_prs_jpg,prs_prefix,cl_num_arm1,cl_num_arm1_string,cl_num_arm2,cl_num_arm2_string,ni_r0_arm2,ni_r1_arm2);
