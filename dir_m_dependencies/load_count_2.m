...
index_stage_6wk_ = efind(label_stage_enum_==3);
fname_fig = sprintf('%s/pca_6wk_FIGA',dir_jpg);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
[UB__,SB__,VB__] = svds(B_logn_,3); SB_ = diag(SB__);
figure(1+nf);nf=nf+1;figbig;figbeach();
subplot(2,2,1);
imagesc(log(1+hist2d_0(UB__(1+index_stage_6wk_,1),UB__(1+index_stage_6wk_,2),32,32)));
title('pca');
subplot(2,2,2);
scatter3(UB__(1+index_stage_6wk_,1),UB__(1+index_stage_6wk_,2),UB__(1+index_stage_6wk_,3),12,label_pasca_enum_(1+index_stage_6wk_),'filled');fig80s;
title('pasca');
subplot(2,2,3);
scatter3(UB__(1+index_stage_6wk_,1),UB__(1+index_stage_6wk_,2),UB__(1+index_stage_6wk_,3),12,label_Isogenic_type_enum_(1+index_stage_6wk_),'filled');fig80s;
title('Isog');
subplot(2,2,4);
scatter3(UB__(1+index_stage_6wk_,1),UB__(1+index_stage_6wk_,2),UB__(1+index_stage_6wk_,3),12,label_pasca_Isog_stage_enum_(1+index_stage_6wk_),'filled');fig80s;
title('pasca+Isog');
...
n_svd = 36;
n_smp_6wk = numel(index_stage_6wk_);
B_6wk_ = B_(1+index_stage_6wk_,:);
B_6wk_logn_ = B_logn_(1+index_stage_6wk_,:);

fname_mat = sprintf('%s/SB_6wk_logn__.mat',dir_mat);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
[UB_6wk_logn__,SB_6wk_logn__,VB_6wk_logn__] = svds(B_6wk_logn_,n_svd); SB_6wk_logn_ = diag(SB_6wk_logn__);
save(fname_mat ...
     ,'n_svd' ...
     ,'UB_6wk_logn__' ...
     ,'SB_6wk_logn_' ...
...
fname_mat = sprintf('%s/SB_6wk_logn_shuffle__.mat',dir_mat);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
n_shuffle = 32;
SB_6wk_logn_shuffle__ = zeros(n_svd,n_shuffle);
for nshuffle=0:n_shuffle-1;
rng(nshuffle*1024);
tmp_B_6wk_logn_ = B_6wk_logn_;
for numi=0:n_umi-1;
if (mod(numi,1024)==0); disp(sprintf(' %% nshuffle %d/%d, numi %d/%d',nshuffle,n_shuffle,numi,n_umi)); end;
tmp_ij_ = randperm(n_smp_6wk);
tmp_B_6wk_logn_(:,1+numi) = tmp_B_6wk_logn_(tmp_ij_,1+numi);
end;%for numi=0:n_umi-1;
[tmp_UB_6wk_logn__,tmp_SB_6wk_logn__,tmp_VB_6wk_logn__] = svds(tmp_B_6wk_logn_,n_svd); tmp_SB_6wk_logn_ = diag(tmp_SB_6wk_logn__);
SB_6wk_logn_shuffle__(:,1+nshuffle) = tmp_SB_6wk_logn_;
end;%for nshuffle=0:n_shuffle-1;
save(fname_mat ...
     ,'n_svd' ...
     ,'n_shuffle' ...
     ,'SB_6wk_logn_shuffle__' ...
     );
end;%if (~exist(fname_mat,'file'));
load(fname_mat);
...
% Apparent rank is 26. ;
%%%%%%%%;
fname_fig = sprintf('%s/SB_6wk_FIGA',dir_jpg);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1+nf);nf=nf+1;clf;
semilogy(1:n_svd,SB_6wk_logn_,'kx',1:n_svd,SB_6wk_logn_shuffle__,'ro');
title('SB_6wk_logn_','Interpreter','none');
...
rank_estimate_B_6wk_logn = 26;

fname_fig = sprintf('%s/nnz_B_6wk_hist_FIGA',dir_jpg);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1+nf);nf=nf+1;clf;figsml;
n_N = 64; tmp_h_ = hist(B_6wk_(:),[0:n_N]);
...
fname_mat = sprintf('%s/B_6wk_logn_sg__.mat',dir_mat);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
nnz_6wk_gene_ = sum(B_6wk_~=0,1);
index_gene_retain_ = efind(nnz_6wk_gene_>=1); %<-- at least 1 nonzero entries, since 1 does not seem to deviate from algebraic decay. ;
B_6wk_logn_sg__ = B_6wk_logn_(:,1+index_gene_retain_);
[UB_6wk_logn__,SB_6wk_logn__,VB_6wk_logn__] = svds(B_6wk_logn_sg__,2); SB_6wk_logn_ = diag(SB_6wk_logn__);
save(fname_mat ...
     ,'nnz_6wk_gene_' ...
     ,'index_gene_retain_' ...
     ,'B_6wk_logn_sg__' ...
...
label_B_6wk_ = label_pasca_Isog_stage_(1+index_stage_6wk_);
[ ...
 label_B_6wk_enum_ ...
,n_u_label_B_6wk ...
,u_label_B_6wk_ ...
,index_nu_B_6wk_from_nall_ ...
,n_u_label_B_6wk_ ...
,index_nall_from_nu_B_6wk__ ...
] = ...
label_str_to_enum_1( ...
 label_B_6wk_ ...
);
%%%%%%%%;
[~,index_sort_u_label_B_6wk_] = sort(n_u_label_B_6wk_,'descend'); index_sort_u_label_B_6wk_ = index_sort_u_label_B_6wk_ - 1;
index_nu_srt_from_nu_ori_ = index_sort_u_label_B_6wk_;
n_all = sum(n_u_label_B_6wk_);
for nu_label_B_6wk=0:n_u_label_B_6wk-1;
tmp_n_u = n_u_label_B_6wk_(1+index_sort_u_label_B_6wk_(1+nu_label_B_6wk));
u_label_B_6wk = u_label_B_6wk_{1+index_sort_u_label_B_6wk_(1+nu_label_B_6wk)};
disp(sprintf(' %% nu %.2d/%.2d: %.4d/%.4d = %0.2f = %s',nu_label_B_6wk,n_u_label_B_6wk,tmp_n_u,n_all,tmp_n_u/n_all,u_label_B_6wk));
end;%for nu_label_B_6wk=0:n_u_label_B_6wk-1;
%%%%%%%%;
fname_fig = sprintf('%s/B_6wk_logn_sg_pca_FIGA',dir_jpg);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
...
hold on;
for nl=0:numel(index_sort_u_label_B_6wk_)-1;
nc_lines = nl;
str_symbol = str_symbol_{1+mod(nl,5)};
markersize_use = round(markersize_start + (markersize_final-markersize_start)*nl/(numel(index_sort_u_label_B_6wk_)-1));
tmp_nu_label_B_6wk = index_sort_u_label_B_6wk_(1+nl);
tmp_index_ = index_nall_from_nu_B_6wk__{1+tmp_nu_label_B_6wk};
plot(UB_6wk_logn__(1+tmp_index_,1),UB_6wk_logn__(1+tmp_index_,2),str_symbol,'MarkerSize',markersize_use,'MarkerFaceColor',c_lines__(1+nc_lines,:),'MarkerEdgeColor','k');
end;%for nl=0:numel(index_sort_u_label_B_6wk_)-1;
axis equal; axisnotick;
legend(u_label_B_6wk_(1+index_sort_u_label_B_6wk_));
title('pca');
disp(sprintf(' %% writing %s',fname_fig));
print('-djpeg',sprintf('%s.jpg',fname_fig));
print('-depsc',sprintf('%s.eps',fname_fig));
...
%%%%%%%%;
label_B_6wk_pasca_ = label_pasca_(1+index_stage_6wk_);
[ ...
 label_B_6wk_pasca_enum_ ...
,n_u_label_B_6wk_pasca ...
,u_label_B_6wk_pasca_ ...
,index_nu_B_6wk_pasca_from_nall_ ...
,n_u_label_B_6wk_pasca_ ...
,index_nall_from_nu_B_6wk_pasca__ ...
] = ...
label_str_to_enum_1( ...
 label_B_6wk_pasca_ ...
);
%%%%%%%%;
[~,index_sort_u_label_B_6wk_pasca_] = sort(n_u_label_B_6wk_pasca_,'descend'); index_sort_u_label_B_6wk_pasca_ = index_sort_u_label_B_6wk_pasca_ - 1;
index_nu_srt_from_nu_ori_ = index_sort_u_label_B_6wk_pasca_;
n_all = sum(n_u_label_B_6wk_pasca_);
for nu_label_B_6wk_pasca=0:n_u_label_B_6wk_pasca-1;
tmp_n_u = n_u_label_B_6wk_pasca_(1+index_sort_u_label_B_6wk_pasca_(1+nu_label_B_6wk_pasca));
u_label_B_6wk_pasca = u_label_B_6wk_pasca_{1+index_sort_u_label_B_6wk_pasca_(1+nu_label_B_6wk_pasca)};
disp(sprintf(' %% nu %.2d/%.2d: %.4d/%.4d = %0.2f = %s',nu_label_B_6wk_pasca,n_u_label_B_6wk_pasca,tmp_n_u,n_all,tmp_n_u/n_all,u_label_B_6wk_pasca));
end;%for nu_label_B_6wk_pasca=0:n_u_label_B_6wk_pasca-1;
%%%%%%%%;
% create label which only refers to Isogenic_type, ignoring pasca. ;
%%%%%%%%;
label_B_6wk_Isog_ = label_Isogenic_type_(1+index_stage_6wk_);
[ ...
 label_B_6wk_Isog_enum_ ...
,n_u_label_B_6wk_Isog ...
,u_label_B_6wk_Isog_ ...
,index_nu_B_6wk_Isog_from_nall_ ...
,n_u_label_B_6wk_Isog_ ...
,index_nall_from_nu_B_6wk_Isog__ ...
] = ...
label_str_to_enum_1( ...
 label_B_6wk_Isog_ ...
);
%%%%%%%%;
[~,index_sort_u_label_B_6wk_Isog_] = sort(n_u_label_B_6wk_Isog_,'descend'); index_sort_u_label_B_6wk_Isog_ = index_sort_u_label_B_6wk_Isog_ - 1;
index_nu_srt_from_nu_ori_ = index_sort_u_label_B_6wk_Isog_;
n_all = sum(n_u_label_B_6wk_Isog_);
for nu_label_B_6wk_Isog=0:n_u_label_B_6wk_Isog-1;
tmp_n_u = n_u_label_B_6wk_Isog_(1+index_sort_u_label_B_6wk_Isog_(1+nu_label_B_6wk_Isog));
u_label_B_6wk_Isog = u_label_B_6wk_Isog_{1+index_sort_u_label_B_6wk_Isog_(1+nu_label_B_6wk_Isog)};
disp(sprintf(' %% nu %.2d/%.2d: %.4d/%.4d = %0.2f = %s',nu_label_B_6wk_Isog,n_u_label_B_6wk_Isog,tmp_n_u,n_all,tmp_n_u/n_all,u_label_B_6wk_Isog));
end;%for nu_label_B_6wk_Isog=0:n_u_label_B_6wk_Isog-1;
%%%%%%%%;
...
if ~exist('USB_6wk_logn__','var'); [tmp_U_,tmp_S_,tmp_V_] = svds(B_6wk_logn_sg__,rank_estimate_B_6wk_logn); USB_6wk_logn__ = tmp_U_*tmp_S_; clear tmp_U_ tmp_S_ tmp_V_; end;

%%%%%%%%;
% loading hnbr results from full data-set. ;
%%%%%%%%;
infix_method_0 = 'hnbrtZRgumb_r26_r1'; infix_method_1 = sprintf('%s',infix_method_0); E_array_base_ = USB_6wk_logn__;
...
[lpv,lP0,fla,cap_,cup_] = label_to_label_enrichment_quad_4(index_nu_B_6wk_from_nall_,label_str_to_enum_0(output_label__));
%%%%%%%%;
label_tree ...
= ...
label_to_tree_1( ...
...
tmp_lpv = label_to_label_enrichment_quad_4(index_nu_B_6wk_from_nall_,label_B_0_);
tmp_lpv_pasca = label_to_label_enrichment_quad_4(index_nu_B_6wk_pasca_from_nall_,label_B_0_);
tmp_lpv_Isog = label_to_label_enrichment_quad_4(index_nu_B_6wk_Isog_from_nall_,label_B_0_);
...
tmp_lpv = label_to_label_enrichment_quad_4(index_nu_B_6wk_from_nall_,label_B_1_);
tmp_lpv_pasca = label_to_label_enrichment_quad_4(index_nu_B_6wk_pasca_from_nall_,label_B_1_);
tmp_lpv_Isog = label_to_label_enrichment_quad_4(index_nu_B_6wk_Isog_from_nall_,label_B_1_);
...
%%%%%%%%;
fname_fig = sprintf('%s/B_6wk_lpv_nlpnex_threshold_%s_FIGA',dir_jpg,infix_method_1);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1);clf;figmed;
...
%%%%%%%%;
fname_fig = sprintf('%s/B_6wk_label_plot_recursive_nlpscale_%s_FIGA',dir_jpg,infix_method_1);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
%%%%%%%%;
figure(1);figbig;;
...
for nnlpnex_threshold=0:n_nlpnex_threshold-1;
nlpnex_threshold = nlpnex_threshold_(1+nnlpnex_threshold);
nlpv = -lpv_method_0_(1+nnlpnex_threshold);
