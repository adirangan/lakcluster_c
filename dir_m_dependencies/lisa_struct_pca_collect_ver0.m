function [lisa_arm1,lisa_arm2] = lisa_struct_pca_collect_ver0(specification) ;
%{
 ...
 %try: ;
  ...
  lisa_struct_pca_collect_ver0(specification) ;
...
[cauc02_arm1_avg_,cauc02_arm1_min_] = p_cauc_0(lisa_arm1.mds_sort_(find_X_arm1_,1: 2),lisa_arm1.mds_sort_(find_D_arm1_,1: 2),zeros(length(find_X_arm1_),1),zeros(length(find_D_arm1_),1),1024*8);
[cauc06_arm1_avg_,cauc06_arm1_min_] = p_cauc_0(lisa_arm1.mds_sort_(find_X_arm1_,1: 6),lisa_arm1.mds_sort_(find_D_arm1_,1: 6),zeros(length(find_X_arm1_),1),zeros(length(find_D_arm1_),1),1024*8);
...
[cauc20_arm1_avg_,cauc20_arm1_min_] = p_cauc_0(lisa_arm1.mds_sort_(find_X_arm1_,1:20),lisa_arm1.mds_sort_(find_D_arm1_,1:20),zeros(length(find_X_arm1_),1),zeros(length(find_D_arm1_),1),1024*8);
find_X_arm2_ = find(lisa_arm2.mr_X_); find_D_arm2_ = find(lisa_arm2.mr_D_);
[cauc02_arm2_avg_,cauc02_arm2_min_] = p_cauc_0(lisa_arm2.mds_sort_(find_X_arm2_,1: 2),lisa_arm2.mds_sort_(find_D_arm2_,1: 2),zeros(length(find_X_arm2_),1),zeros(length(find_D_arm2_),1),1024*8);
[cauc06_arm2_avg_,cauc06_arm2_min_] = p_cauc_0(lisa_arm2.mds_sort_(find_X_arm2_,1: 6),lisa_arm2.mds_sort_(find_D_arm2_,1: 6),zeros(length(find_X_arm2_),1),zeros(length(find_D_arm2_),1),1024*8);
...
[cauc20_arm2_avg_,cauc20_arm2_min_] = p_cauc_0(lisa_arm2.mds_sort_(find_X_arm2_,1:20),lisa_arm2.mds_sort_(find_D_arm2_,1:20),zeros(length(find_X_arm2_),1),zeros(length(find_D_arm2_),1),1024*8);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
...
%%%%%%%%;
if ~flag_flip_arm1; tmp_DnV_arm1_ = +DnV_arm1_; tmp_XnV_arm1_ = +XnV_arm1_; tmp_DnV_arm2_ = +DnV_arm2_; tmp_XnV_arm2_ = +XnV_arm2_; end;%if ~flag_flip_arm1;
if  flag_flip_arm1; tmp_DnV_arm1_ = -DnV_arm1_; tmp_XnV_arm1_ = -XnV_arm1_; tmp_DnV_arm2_ = -DnV_arm2_; tmp_XnV_arm2_ = -XnV_arm2_; end;%if  flag_flip_arm1;
%%%%%%%%;
...
fname_pca_jpg = sprintf('%s/%s_pca_collect_ver0_trn%d%s_tst%d%s.jpg',lisa_arm1.dir_out_s0_pca_jpg,lisa_arm1.string_name_s0,cl_num_arm1,cl_num_arm1_string,cl_num_arm2,cl_num_arm2_string); 
if (~exist(fname_pca_jpg,'file')); disp(sprintf(' %% creating %s',fname_pca_jpg)); print('-djpeg',fname_pca_jpg); end;%if ~exist;
fname_pca_eps = sprintf('%s/%s_pca_collect_ver0_trn%d%s_tst%d%s.eps',lisa_arm1.dir_out_s0_pca_jpg,lisa_arm1.string_name_s0,cl_num_arm1,cl_num_arm1_string,cl_num_arm2,cl_num_arm2_string); 
