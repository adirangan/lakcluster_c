function lisa_pca_collect_ver4(dir_code,dir_trunk,cl_num,flag_dex_vs_lak,gamma,B_MLT,n_mds,flag_reverse,n_maf,n_cov,n_shuffle) ;
%{
...
n_cov = 2;
n_shuffle = 64;
lisa_pca_collect_ver4(dir_code,dir_trunk,cl_num,flag_dex_vs_lak,gamma,B_MLT,n_mds,flag_reverse,n_maf,n_cov,n_shuffle) ;
...
fname_mat = sprintf('%s/%s_pca_collect_ver4.mat',dir_out_s0000_pca_arm1,string_name_s0000);
...
set(gcf,'Position',1+[0,0,1024*2,1024]);
fname_pre = sprintf('%s/%s_pca_collect_ver4',dir_out_s0000_pca_arm1,string_name_s0000);
print('-djpeg',sprintf('%s.jpg',fname_pre));
print('-depsc',sprintf('%s.eps',fname_pre));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
