function [A__,L] = dolphin_estimate_A_from_BC_0(aid_,age_,dat__,BB__,CC__,dt_lim_,n_step);
% Assuming a_=0, estimates A__, given BB__ and CC__;
...
A__ = reshape(pinv(E_nmnm__,1e-6) * F_nm_,[n_var,n_var]);
...
tmp_L = transpose(dY_ - tmp_dt*(A__*Y_pre_)) * DD__ * (dY_ - tmp_dt*(A__*Y_pre_));
