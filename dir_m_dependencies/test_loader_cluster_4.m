...
%%%%;
if ( isempty(rank_estimate_A)); rank_estimate_A = 18; end;
...
[lpv_(1),lP0_(1),fla_(1)] = label_to_label_enrichment_3(label_A_,label_B__{1});
%%%%%%%%;
save(tmp_fname_mat,'lpv_','lP0_','fla_','label_B__');
clear A_n_sub_ lpv_ lP0_ fla_ label_B__ ;
catch; disp(sprintf(' %% WARNING: error generating %s',tmp_fname_mat)); end;%try;
...
[lpv_(1),lP0_(1),fla_(1)] = label_to_label_enrichment_3(label_A_,label_B__{1});
[lpv_(2),lP0_(2),fla_(2)] = label_to_label_enrichment_3(label_A_,label_B__{2});
%%%%%%%%;
save(tmp_fname_mat,'lpv_','lP0_','fla_','label_B__');
clear A_n_sub_ lpv_ lP0_ fla_ label_B__ ;
catch; disp(sprintf(' %% WARNING: error generating %s',tmp_fname_mat)); end;%try;
