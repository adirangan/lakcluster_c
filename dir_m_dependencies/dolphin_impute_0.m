function dat_out__ = dolphin_impute_0(aid_,age_,dat_0in__,A__,index_mss_);
% impute missing data given A__, B__ and C__. ;
...
flag_continue=0;
if (~isempty(A__)); flag_continue=1; end;
niteration=0;
while(flag_continue);
...
Y_est_ = Y_pre_ + tmp_dt*A__*reshape(Y_pre_,[n_var,1]);
