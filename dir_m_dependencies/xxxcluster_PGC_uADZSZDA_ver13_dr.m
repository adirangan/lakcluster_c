% scp -p rangan@access1.cims.nyu.edu:/data/rangan/dir_bcc/dir_PGC_20180304/dir_m/xxxcluster_PGC_uADZSZDA_ver13_dr.m /scratch/avr209/dir_PGC_20180304/dir_m/ ;
...
%%%%%%%%%%%%%%%%;
  ...
  for flag_reverse=0:1;%for flag_reverse=[0]; 
  for cl_num=1:4;%for cl_num=4; 
  ...
  xxxcluster_PGC_uADZSZDA_ver13(dir_code,dir_trunk,string_prefix,maf_lo_threshold,maf_hi_threshold,mc_string,flag_dex_vs_lak{1},flag_reverse,Icat,n_mds,mds_used_,mds_repl,gamma,B_MLT,Ireq,n_scramble,{},[],nshuffle,flag_rerun,pbs_walltime,slurm_walltime,slurm_nnodes,slurm_tpn,slurm_memdecl,row_factor,col_factor,flag_verbose);
  %%%%%%%%;
  if (cl_num==1); nshuffle=0; n_scramble=1; scramble_rseed_ = [1];
  if (flag_reverse==0); scramble_out_xdrop_ = {'/data/rangan/dir_bcc/dir_PGC_20180304/dir_PGC_cl1_maf01_analyze/dir_PGC_cl1_maf01_dex_p25_D_m2r2_g004/PGC_cl1_maf01_dex_p25_D_m2r2_g004_out_xdrop_ni375.txt'}; end;
  if (flag_reverse==1); scramble_out_xdrop_ = {'/data/rangan/dir_bcc/dir_PGC_20180304/dir_PGC_cl1_maf01_analyze/dir_PGC_cl1_maf01_dex_p25_X_m2r2_g004/PGC_cl1_maf01_dex_p25_X_m2r2_g004_out_xdrop_ni400.txt'}; end;
  ...
  %%%%%%%%;
  if (cl_num==2); nshuffle=0; n_scramble=1; scramble_rseed_ = [1];
  if (flag_reverse==0); scramble_out_xdrop_ = {'/data/rangan/dir_bcc/dir_PGC_20180304/dir_PGC_cl2_maf01_analyze/dir_PGC_cl2_maf01_dex_p25_D_m2r2_g004/PGC_cl2_maf01_dex_p25_D_m2r2_g004_out_xdrop_ni400.txt'}; end;
  if (flag_reverse==1); scramble_out_xdrop_ = {'/data/rangan/dir_bcc/dir_PGC_20180304/dir_PGC_cl2_maf01_analyze/dir_PGC_cl2_maf01_dex_p25_X_m2r2_g004/PGC_cl2_maf01_dex_p25_X_m2r2_g004_out_xdrop_ni450.txt'}; end;
  xxxcluster_PGC_uADZSZDA_ver13(dir_code,dir_trunk,string_prefix,maf_lo_threshold,maf_hi_threshold,mc_string,flag_dex_vs_lak{1},flag_reverse,Icat,n_mds,mds_used_,mds_repl,gamma,B_MLT,Ireq,n_scramble,scramble_out_xdrop_,scramble_rseed_,nshuffle,flag_rerun,pbs_walltime,slurm_walltime,slurm_nnodes,slurm_tpn,slurm_memdecl,row_factor,col_factor,flag_verbose);
  end;%if (cl_num==2);
  %%%%%%%%;
  if (cl_num==3); nshuffle=0; n_scramble=1; scramble_rseed_ = [1];
  if (flag_reverse==0); scramble_out_xdrop_ = {'/data/rangan/dir_bcc/dir_PGC_20180304/dir_PGC_cl3_maf01_analyze/dir_PGC_cl3_maf01_dex_p25_D_m2r2_g004/PGC_cl3_maf01_dex_p25_D_m2r2_g004_out_xdrop_ni400.txt'}; end;
  if (flag_reverse==1); scramble_out_xdrop_ = {'/data/rangan/dir_bcc/dir_PGC_20180304/dir_PGC_cl3_maf01_analyze/dir_PGC_cl3_maf01_dex_p25_X_m2r2_g004/PGC_cl3_maf01_dex_p25_X_m2r2_g004_out_xdrop_ni450.txt'}; end;
  xxxcluster_PGC_uADZSZDA_ver13(dir_code,dir_trunk,string_prefix,maf_lo_threshold,maf_hi_threshold,mc_string,flag_dex_vs_lak{1},flag_reverse,Icat,n_mds,mds_used_,mds_repl,gamma,B_MLT,Ireq,n_scramble,scramble_out_xdrop_,scramble_rseed_,nshuffle,flag_rerun,pbs_walltime,slurm_walltime,slurm_nnodes,slurm_tpn,slurm_memdecl,row_factor,col_factor,flag_verbose);
  end;%if (cl_num==3);
  %%%%%%%%;
  if (cl_num==4); nshuffle=0; n_scramble=1; scramble_rseed_ = [1];
  if (flag_reverse==0); scramble_out_xdrop_ = {'/data/rangan/dir_bcc/dir_PGC_20180304/dir_PGC_cl4_maf01_analyze/dir_PGC_cl4_maf01_dex_p25_D_m2r2_g004/PGC_cl4_maf01_dex_p25_D_m2r2_g004_out_xdrop_ni275.txt'}; end;
  if (flag_reverse==1); scramble_out_xdrop_ = {'/data/rangan/dir_bcc/dir_PGC_20180304/dir_PGC_cl4_maf01_analyze/dir_PGC_cl4_maf01_dex_p25_X_m2r2_g004/PGC_cl4_maf01_dex_p25_X_m2r2_g004_out_xdrop_ni300.txt'}; end;
  xxxcluster_PGC_uADZSZDA_ver13(dir_code,dir_trunk,string_prefix,maf_lo_threshold,maf_hi_threshold,mc_string,flag_dex_vs_lak{1},flag_reverse,Icat,n_mds,mds_used_,mds_repl,gamma,B_MLT,Ireq,n_scramble,scramble_out_xdrop_,scramble_rseed_,nshuffle,flag_rerun,pbs_walltime,slurm_walltime,slurm_nnodes,slurm_tpn,slurm_memdecl,row_factor,col_factor,flag_verbose);
  end;%if (cl_num==4);
  %%%%%%%%;
  end;%for n_cov=[0,1,2]; 
