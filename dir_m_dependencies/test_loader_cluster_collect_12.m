%function test_loader_cluster_collect_12();
% collect results from test_loader_cluster_wrap_2.m ;
...
str_Y_ = {'li16f','li16f_c127_r12','li16f_cRRR_r12','li16f_c012_r12','li16f_cUE1_r1','li16f_cUE2_r5','li16f_cUE3_r8','li16f_cUE4_r1','li16f_cUE5_r1','li16f_cUE6_r8'}; n_Y = numel(str_Y_);
...
ylabel('-log(p-value)');
figbig;
fname = sprintf('/data/rangan/dir_bcc/dir_jamison/dir_jpg/test_loader_cluster_collect_12_%s_PYZ',str_X);
...
ylabel('-log(p-value)');
figbig;
fname = sprintf('/data/rangan/dir_bcc/dir_jamison/dir_jpg/test_loader_cluster_collect_12_%s_PZY',str_X);
disp(sprintf(' %% writing %s',fname));
print('-djpeg',sprintf('%s.jpg',fname));
print('-depsc',sprintf('%s.eps',fname));
end;%for nX=1:n_X;
...
%{
  ...
  str_mat = '/data/rangan/dir_bcc/dir_jamison/dir_loader_cluster/dir_E_li16f_cluster/dexcluster_nonbinary_trace_ZRimax_g010_p050_nml3.mat';
  tmp_mat_ = load(str_mat);
