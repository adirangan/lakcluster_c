function dolphin_dXX_bootstrap_4(dXX,n_shuffle,age_percentile_range_);
%{
note that age-range is 0.64 --> 54.35. ;
try: ;

dXX = 0; n_shuffle = 64;
dolphin_dXX_bootstrap_4(dXX,n_shuffle,[ 0, 50]);
dolphin_dXX_bootstrap_4(dXX,n_shuffle,[25, 75]);
dolphin_dXX_bootstrap_4(dXX,n_shuffle,[50,100]);
dolphin_dXX_bootstrap_4(dXX,n_shuffle);
