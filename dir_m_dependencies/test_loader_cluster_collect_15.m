%function test_loader_cluster_collect_15();
...
fname_fig = sprintf('%s/test_loader_cluster_collect_15_markergene_A__',dir_jpg);
...
fname_fig = sprintf('%s/test_loader_cluster_collect_15_lpv_A_each_vs_B__',dir_jpg);
if (1 | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
%%%%%%%%;
figure(1);clf;
...
fname_fig = sprintf('%s/test_loader_cluster_collect_15_n_cluster__',dir_jpg);
if (1 | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
%%%%%%%%;
figure(1);clf;
...
fname_fig = sprintf('%s/test_loader_cluster_collect_15_markergene_A_vs_c127__',dir_jpg);
if (1 | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
%%%%%%%%;
figure(1);clf;
...
fname_fig = sprintf('%s/test_loader_cluster_collect_15_%s',dir_jpg,str_tmp);
