function [lisa_arm1,lisa_arm2] = lisa_struct_pca_generate_ver2(specification) ;
%{
  ...
  lisa_struct_pca_generate_ver2(specification) ;
...
pca_fname_i = sprintf('%s/i_trn%d_tst%d.mat',lisa_arm1.dir_out_s0_pca_mat,lisa_arm1.cl_num,lisa_arm2.cl_num);
pca_infix = sprintf('pca_ni%d_tst%d',niteration,lisa_arm2.cl_num);
pca_fname_V_arm1_ = sprintf('%s/%s_k%d_B%d_V_.mda',lisa_arm1.dir_out_s0_pca_mda,pca_infix,pca_rank,pca_b_mlt);
pca_fname_V_arm2_ = sprintf('%s/%s_k%d_B%d_V_arm2_.mda',lisa_arm1.dir_out_s0_pca_mda,pca_infix,pca_rank,pca_b_mlt);
pca_proj_arm1_infix = sprintf('pca_proj_arm1_ni%d_tst%d',niteration,lisa_arm2.cl_num);
pca_fname_AnV_arm1_ = sprintf('%s/%s_k%d_B%d_AnV_.mda',lisa_arm1.dir_out_s0_pca_mda,pca_proj_arm1_infix,pca_rank,pca_b_mlt);
pca_fname_ZnV_arm1_ = sprintf('%s/%s_k%d_B%d_ZnV_.mda',lisa_arm1.dir_out_s0_pca_mda,pca_proj_arm1_infix,pca_rank,pca_b_mlt);
pca_proj_arm2_infix = sprintf('pca_proj_arm2_ni%d_tst%d',niteration,lisa_arm2.cl_num);
pca_fname_AnV_arm2_ = sprintf('%s/%s_k%d_B%d_AnV_.mda',lisa_arm1.dir_out_s0_pca_mda,pca_proj_arm2_infix,pca_rank,pca_b_mlt);
pca_fname_ZnV_arm2_ = sprintf('%s/%s_k%d_B%d_ZnV_.mda',lisa_arm1.dir_out_s0_pca_mda,pca_proj_arm2_infix,pca_rank,pca_b_mlt);
...
if (flag_reverse==1); 
tmpchar = sprintf('%s/%s_mr_Z_arm1_full_%s.b16',lisa_arm1.dir_out_s0_pca_b16,lisa_arm1.string_name_s0,pca_infix); %delete(tmpchar);
tutorial_binary_compress(bitj,mr_Z_arm1_tmp(:)>0,tmpchar);
end;%if (flag_reverse==1); 
if (flag_reverse==0); 
tmpchar = sprintf('%s/%s_mr_A_arm1_full_%s.b16',lisa_arm1.dir_out_s0_pca_b16,lisa_arm1.string_name_s0,pca_infix); %delete(tmpchar);
tutorial_binary_compress(bitj,mr_A_arm1_tmp(:)>0,tmpchar);
end;%if (flag_reverse==0); 
tmpchar = sprintf('%s/%s_mc_A_arm1_%s.b16',lisa_arm1.dir_out_s0_pca_b16,lisa_arm1.string_name_s0,pca_infix); %delete(tmpchar);
tutorial_binary_compress(bitj,mc_A_arm1_cap(:)>0,tmpchar);
tmpchar = sprintf('%s/%s_mc_A_arm2_%s.b16',lisa_arm1.dir_out_s0_pca_b16,lisa_arm1.string_name_s0,pca_infix); %delete(tmpchar);
...
d_oupre_pca = sprintf('%s/%s',lisa_arm1.dir_out_s0_pca_b16,lisa_arm1.string_name_s0);
%pca_b_mlt = 44;
%pca_tolerance = 1e-2;
%pca_rank = 2;
flag_T = 0;
...
pca_infix = sprintf('pca_ni%d_tst%d',niteration,lisa_arm2.cl_num);
fname__in = sprintf('%s/%s_%s.in',lisa_arm1.dir_out_s0_pca_inp,lisa_arm1.string_name_s0,pca_infix);
...
fprintf(fp,'GLOBAL_DIR_NAME= %s;\n',lisa_arm1.dir_out_s0_pca_mda);
fprintf(fp,'END= 0;\n');
fprintf(fp,'%% generated by lisa_struct_pca_generate_ver2 on %s;\n',date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ;
fclose(fp);
type(fname__in);
...
for nb=0:lisa_arm1.Icat-1; M_n_rows_(1+nb) = length(lisa_arm1.mr_A__{1+nb});end;%for nb=0:lisa_arm1.Icat-1;
pca_proj_arm1_infix = sprintf('pca_proj_arm1_ni%d_tst%d',niteration,lisa_arm2.cl_num);
fname__in = sprintf('%s/%s_%s.in',lisa_arm1.dir_out_s0_pca_inp,lisa_arm1.string_name_s0,pca_proj_arm1_infix);
fp = fopen(fname__in,'w');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ;
fprintf(fp,'GLOBAL_verbose= %d;\n',flag_verbose);
fprintf(fp,'GLOBAL_thread_count= 15;\n');
...
%%%%%%%%%%%%%%%%;
mr_A_arm2_full = lisa_arm2.mr_A_full_;
mr_Z_arm2_full = lisa_arm2.mr_Z_full_;
%%%%%%%%%%%%%%%%;
pca_proj_arm2_infix = sprintf('pca_proj_arm2_ni%d_tst%d',niteration,lisa_arm2.cl_num);
pca_fname_AnV_arm2_ = sprintf('%s/%s_k%d_B%d_AnV_.mda',lisa_arm1.dir_out_s0_pca_mda,pca_proj_arm2_infix,pca_rank,pca_b_mlt);
pca_fname_ZnV_arm2_ = sprintf('%s/%s_k%d_B%d_ZnV_.mda',lisa_arm1.dir_out_s0_pca_mda,pca_proj_arm2_infix,pca_rank,pca_b_mlt);
...
fname__in = sprintf('%s/%s_%s.in',lisa_arm1.dir_out_s0_pca_inp,lisa_arm1.string_name_s0,pca_proj_arm2_infix);
fp = fopen(fname__in,'w');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ;
fprintf(fp,'GLOBAL_verbose= %d;\n',flag_verbose);
fprintf(fp,'GLOBAL_thread_count= 15;\n');
...
if (flag_reverse==1); dexcluster_PGC_uADZSZDA_excerpt_0(fp,'GLOBAL_A_n_rind_= ',lisa_arm2.Icat,d_inpre_arm2,sprintf('_mr_Z_%s_',mr_string_arm2),'.b16'); end;
if (flag_reverse==0); dexcluster_PGC_uADZSZDA_excerpt_0(fp,'GLOBAL_A_n_rind_= ',lisa_arm2.Icat,d_inpre_arm2,sprintf('_mr_A_%s_',mr_string_arm2),'.b16'); end;
end;%if (strcmp(mr_string_arm2_,''));
...
if (flag_reverse==1); dexcluster_PGC_uADZSZDA_excerpt_0(fp,'GLOBAL_Z_n_rind_= ',lisa_arm2.Icat,d_inpre_arm2,sprintf('_mr_A_%s_',mr_string_arm2),'.b16'); end;
if (flag_reverse==0); dexcluster_PGC_uADZSZDA_excerpt_0(fp,'GLOBAL_Z_n_rind_= ',lisa_arm2.Icat,d_inpre_arm2,sprintf('_mr_Z_%s_',mr_string_arm2),'.b16'); end;
end;%if (strcmp(mr_string_arm2,''));
fprintf(fp,'GLOBAL_Y_n_cols= %d;\n',Y_n_cols);
fprintf(fp,'GLOBAL_DIR_NAME= %s;\n',lisa_arm1.dir_out_s0_pca_mda);
fprintf(fp,'END= 0;\n');
fprintf(fp,'%% generated by lisa_struct_pca_generate_ver2 on %s;\n',date);
