function lisa_prs_collect_ver11(prs_prefix,cl_num_arm1,cl_num_arm2,flag_reverse_use,flag_rerun,flag_replot);
% try: ;
%{
  ...
  lisa_prs_collect_ver11(prs_prefix_{nd},cl_num_arm1,cl_num_arm2,flag_reverse_use,flag_rerun,flag_replot);
  end;end;end;end;%for nd=1:length(prs_prefix_); for cl_num_arm1=[4]; for cl_num_arm2=[1,2,3]; for flag_reverse_use=[0:1];
  
  lisa_prs_collect_ver11('icuk_on_icuk',1,4,0,0,1);
...
fname_mat = sprintf('%s/prs_collect_ver11_%s_trn%d_tst%d.mat',dir_out_s0000_pca_r0_arm1,prs_prefix,cl_num_arm1,cl_num_arm2);
...
for nir1_arm2_ = 1:length(ni_r1_arm2_);
ni_r1_arm2 = ni_r1_arm2_(nir1_arm2_);
fname_fig = sprintf('%s/prs_collect_ver11_%s_trn%d_tst%d_ni%.3d_ni%.3d.jpg',dir_out_s0000_pca_r0_arm1,prs_prefix,cl_num_arm1,cl_num_arm2,ni_r0_arm2,ni_r1_arm2);
