...
[tmp_age_sort_,tmp_index_age_] = sort(tmp_age_,'ascend'); tmp_index_age_ = tmp_index_age_-1;
n_age = numel(tmp_index_age_);
...
tmp_RHS = sum_DD_inv_j_dt__(1+nvar0,1+nvar1);
BB_inv__(1+nvar0,1+nvar1) = tmp_RHS/max(1e-12,sum_dtdt);
