...
n_rank = 6;
if flag_load==0;
ij_missing_ = find(E_val_<=0); ij_filled_ = setdiff(1:n_E_GENE,ij_missing_); 
E_limp_ = svd_impute(log(max(1e-12,E_val_)),ij_missing_,n_rank);
ij_missing_ = find(I_val_<=0); ij_filled_ = setdiff(1:n_I_GENE,ij_missing_); 
I_limp_ = svd_impute(log(max(1e-12,I_val_)),ij_missing_,n_rank);
save('/data/rangan/dir_bcc/dir_jamison/dir_mat/E_limp_.mat','E_limp_');
save('/data/rangan/dir_bcc/dir_jamison/dir_mat/I_limp_.mat','I_limp_');
end;%if flag_load==0;
if flag_load==1;
load('/data/rangan/dir_bcc/dir_jamison/dir_mat/E_limp_.mat','E_limp_');
load('/data/rangan/dir_bcc/dir_jamison/dir_mat/I_limp_.mat','I_limp_');
end;%if flag_load==1;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
[E_limp_c127_beta_un_,E_limp_c127_beta_vn_,n_E_limp_c127_beta,I_limp_c127_beta_un_,I_limp_c127_beta_vn_,n_I_limp_c127_beta,E_limp_c127_zeta_un_,E_limp_c127_zeta_vn_,n_E_limp_c127_zeta,I_limp_c127_zeta_un_,I_limp_c127_zeta_vn_,n_I_limp_c127_zeta] = test_loader_lm_RRR_0(C_rank_c127_,E_limp_,I_limp_,dir_trunk,'limp_c127');
[E_limp_c127_beta_,I_limp_c127_beta_,E_limp_c127_zeta_,I_limp_c127_zeta_] = test_loader_lm_LSQ_0(C_rank_c127_,E_limp_,I_limp_,dir_trunk,'limp_c127');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
% Fit linear model to log of imputed data after centered-log-ratio (licl) ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
[E_licl_c127_beta_un_,E_licl_c127_beta_vn_,n_E_licl_c127_beta,I_licl_c127_beta_un_,I_licl_c127_beta_vn_,n_I_licl_c127_beta,E_licl_c127_zeta_un_,E_licl_c127_zeta_vn_,n_E_licl_c127_zeta,I_licl_c127_zeta_un_,I_licl_c127_zeta_vn_,n_I_licl_c127_zeta] = test_loader_lm_RRR_0(C_rank_c127_,E_licl_,I_licl_,dir_trunk,'licl_c127');
[E_licl_c127_beta_,I_licl_c127_beta_,E_licl_c127_zeta_,I_licl_c127_zeta_] = test_loader_lm_LSQ_0(C_rank_c127_,E_licl_,I_licl_,dir_trunk,'licl_c127');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
% Fit linear model to log of imputed data after centered-log-ratio and rank normalization (licr) ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
[E_licr_c127_beta_un_,E_licr_c127_beta_vn_,n_E_licr_c127_beta,I_licr_c127_beta_un_,I_licr_c127_beta_vn_,n_I_licr_c127_beta,E_licr_c127_zeta_un_,E_licr_c127_zeta_vn_,n_E_licr_c127_zeta,I_licr_c127_zeta_un_,I_licr_c127_zeta_vn_,n_I_licr_c127_zeta] = test_loader_lm_RRR_0(C_rank_c127_,E_licr_,I_licr_,dir_trunk,'licr_c127');
[E_licr_c127_beta_,I_licr_c127_beta_,E_licr_c127_zeta_,I_licr_c127_zeta_] = test_loader_lm_LSQ_0(C_rank_c127_,E_licr_,I_licr_,dir_trunk,'licr_c127');
...
% Fit linear model to log of imputed data (limp) ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
[E_limp_c042_beta_un_,E_limp_c042_beta_vn_,n_E_limp_c042_beta,I_limp_c042_beta_un_,I_limp_c042_beta_vn_,n_I_limp_c042_beta,E_limp_c042_zeta_un_,E_limp_c042_zeta_vn_,n_E_limp_c042_zeta,I_limp_c042_zeta_un_,I_limp_c042_zeta_vn_,n_I_limp_c042_zeta] = test_loader_lm_RRR_0(C_rank_c042_,E_limp_,I_limp_,dir_trunk,'limp_c042');
[E_limp_c042_beta_,I_limp_c042_beta_,E_limp_c042_zeta_,I_limp_c042_zeta_] = test_loader_lm_LSQ_0(C_rank_c042_,E_limp_,I_limp_,dir_trunk,'limp_c042');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
% Fit linear model to log of imputed data after centered-log-ratio (licl) ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
[E_licl_c042_beta_un_,E_licl_c042_beta_vn_,n_E_licl_c042_beta,I_licl_c042_beta_un_,I_licl_c042_beta_vn_,n_I_licl_c042_beta,E_licl_c042_zeta_un_,E_licl_c042_zeta_vn_,n_E_licl_c042_zeta,I_licl_c042_zeta_un_,I_licl_c042_zeta_vn_,n_I_licl_c042_zeta] = test_loader_lm_RRR_0(C_rank_c042_,E_licl_,I_licl_,dir_trunk,'licl_c042');
[E_licl_c042_beta_,I_licl_c042_beta_,E_licl_c042_zeta_,I_licl_c042_zeta_] = test_loader_lm_LSQ_0(C_rank_c042_,E_licl_,I_licl_,dir_trunk,'licl_c042');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
% Fit linear model to log of imputed data after centered-log-ratio and rank normalization (licr) ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
[E_licr_c042_beta_un_,E_licr_c042_beta_vn_,n_E_licr_c042_beta,I_licr_c042_beta_un_,I_licr_c042_beta_vn_,n_I_licr_c042_beta,E_licr_c042_zeta_un_,E_licr_c042_zeta_vn_,n_E_licr_c042_zeta,I_licr_c042_zeta_un_,I_licr_c042_zeta_vn_,n_I_licr_c042_zeta] = test_loader_lm_RRR_0(C_rank_c042_,E_licr_,I_licr_,dir_trunk,'licr_c042');
[E_licr_c042_beta_,I_licr_c042_beta_,E_licr_c042_zeta_,I_licr_c042_zeta_] = test_loader_lm_LSQ_0(C_rank_c042_,E_licr_,I_licr_,dir_trunk,'licr_c042');
...
% Fit linear model to log of imputed data (limp) ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
[E_limp_c012_beta_un_,E_limp_c012_beta_vn_,n_E_limp_c012_beta,I_limp_c012_beta_un_,I_limp_c012_beta_vn_,n_I_limp_c012_beta,E_limp_c012_zeta_un_,E_limp_c012_zeta_vn_,n_E_limp_c012_zeta,I_limp_c012_zeta_un_,I_limp_c012_zeta_vn_,n_I_limp_c012_zeta] = test_loader_lm_RRR_0(C_rank_c012_,E_limp_,I_limp_,dir_trunk,'limp_c012');
[E_limp_c012_beta_,I_limp_c012_beta_,E_limp_c012_zeta_,I_limp_c012_zeta_] = test_loader_lm_LSQ_0(C_rank_c012_,E_limp_,I_limp_,dir_trunk,'limp_c012');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
% Fit linear model to log of imputed data after centered-log-ratio (licl) ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
[E_licl_c012_beta_un_,E_licl_c012_beta_vn_,n_E_licl_c012_beta,I_licl_c012_beta_un_,I_licl_c012_beta_vn_,n_I_licl_c012_beta,E_licl_c012_zeta_un_,E_licl_c012_zeta_vn_,n_E_licl_c012_zeta,I_licl_c012_zeta_un_,I_licl_c012_zeta_vn_,n_I_licl_c012_zeta] = test_loader_lm_RRR_0(C_rank_c012_,E_licl_,I_licl_,dir_trunk,'licl_c012');
[E_licl_c012_beta_,I_licl_c012_beta_,E_licl_c012_zeta_,I_licl_c012_zeta_] = test_loader_lm_LSQ_0(C_rank_c012_,E_licl_,I_licl_,dir_trunk,'licl_c012');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
% Fit linear model to log of imputed data after centered-log-ratio and rank normalization (licr) ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
[E_licr_c012_beta_un_,E_licr_c012_beta_vn_,n_E_licr_c012_beta,I_licr_c012_beta_un_,I_licr_c012_beta_vn_,n_I_licr_c012_beta,E_licr_c012_zeta_un_,E_licr_c012_zeta_vn_,n_E_licr_c012_zeta,I_licr_c012_zeta_un_,I_licr_c012_zeta_vn_,n_I_licr_c012_zeta] = test_loader_lm_RRR_0(C_rank_c012_,E_licr_,I_licr_,dir_trunk,'licr_c012');
[E_licr_c012_beta_,I_licr_c012_beta_,E_licr_c012_zeta_,I_licr_c012_zeta_] = test_loader_lm_LSQ_0(C_rank_c012_,E_licr_,I_licr_,dir_trunk,'licr_c012');
...
test_loader_helper_CLabel_Distance_0(dir_trunk,E_limp_,'E_limp_',CLabel_sub_);
test_loader_helper_CLabel_Distance_0(dir_trunk,I_limp_,'I_limp_',CLabel_sub_);
%%%%%%%%;
[E_limp_c042_beta_un_,E_limp_c042_beta_vn_,n_E_limp_c042_beta,I_limp_c042_beta_un_,I_limp_c042_beta_vn_,n_I_limp_c042_beta,E_limp_c042_zeta_un_,E_limp_c042_zeta_vn_,n_E_limp_c042_zeta,I_limp_c042_zeta_un_,I_limp_c042_zeta_vn_,n_I_limp_c042_zeta] = test_loader_lm_RRR_0(C_rank_c042_,E_limp_,I_limp_,dir_trunk,'limp_c042');
for n_col=1:6;
...
test_loader_helper_CLabel_Distance_0(dir_trunk,E_limp_c042_,sprintf('E_limp_c042r%d_',n_col),CLabel_sub_);
test_loader_helper_CLabel_Distance_0(dir_trunk,I_limp_c042_,sprintf('I_limp_c042r%d_',n_col),CLabel_sub_);
...
test_loader_helper_CLabel_Distance_0(dir_trunk,E_limp_c012_,sprintf('E_limp_c012r%d_',n_col),CLabel_sub_);
test_loader_helper_CLabel_Distance_0(dir_trunk,I_limp_c012_,sprintf('I_limp_c012r%d_',n_col),CLabel_sub_);
...
test_loader_helper_CLabel_Distance_0(dir_trunk,E_limp_c127_,sprintf('E_limp_c127r%d_',n_col),CLabel_sub_);
test_loader_helper_CLabel_Distance_0(dir_trunk,I_limp_c127_,sprintf('I_limp_c127r%d_',n_col),CLabel_sub_);
clear E_limp_c127_ ; clear I_limp_c127_ ;
end;%for n_col=1:6;
%%%%%%%%;
clear E_limp_ ; clear I_limp_ ; 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
% Fit linear model to log of imputed data (licl) ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
...
test_loader_helper_CLabel_Distance_0(dir_trunk,E_licl_,'E_licl_',CLabel_sub_);
test_loader_helper_CLabel_Distance_0(dir_trunk,I_licl_,'I_licl_',CLabel_sub_);
%%%%%%%%;
[E_licl_c042_beta_un_,E_licl_c042_beta_vn_,n_E_licl_c042_beta,I_licl_c042_beta_un_,I_licl_c042_beta_vn_,n_I_licl_c042_beta,E_licl_c042_zeta_un_,E_licl_c042_zeta_vn_,n_E_licl_c042_zeta,I_licl_c042_zeta_un_,I_licl_c042_zeta_vn_,n_I_licl_c042_zeta] = test_loader_lm_RRR_0(C_rank_c042_,E_licl_,I_licl_,dir_trunk,'licl_c042');
for n_col=1:6;
...
test_loader_helper_CLabel_Distance_0(dir_trunk,E_licl_c042_,sprintf('E_licl_c042r%d_',n_col),CLabel_sub_);
test_loader_helper_CLabel_Distance_0(dir_trunk,I_licl_c042_,sprintf('I_licl_c042r%d_',n_col),CLabel_sub_);
...
test_loader_helper_CLabel_Distance_0(dir_trunk,E_licl_c012_,sprintf('E_licl_c012r%d_',n_col),CLabel_sub_);
test_loader_helper_CLabel_Distance_0(dir_trunk,I_licl_c012_,sprintf('I_licl_c012r%d_',n_col),CLabel_sub_);
...
test_loader_helper_CLabel_Distance_0(dir_trunk,E_licl_c127_,sprintf('E_licl_c127r%d_',n_col),CLabel_sub_);
test_loader_helper_CLabel_Distance_0(dir_trunk,I_licl_c127_,sprintf('I_licl_c127r%d_',n_col),CLabel_sub_);
clear E_licl_c127_ ; clear I_licl_c127_ ;
end;%for n_col=1:6;
%%%%%%%%;
clear E_licl_ ; clear I_licl_ ; 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
% Fit linear model to log of imputed data (licr) ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
...
test_loader_helper_CLabel_Distance_0(dir_trunk,E_licr_,'E_licr_',CLabel_sub_);
test_loader_helper_CLabel_Distance_0(dir_trunk,I_licr_,'I_licr_',CLabel_sub_);
%%%%%%%%;
[E_licr_c042_beta_un_,E_licr_c042_beta_vn_,n_E_licr_c042_beta,I_licr_c042_beta_un_,I_licr_c042_beta_vn_,n_I_licr_c042_beta,E_licr_c042_zeta_un_,E_licr_c042_zeta_vn_,n_E_licr_c042_zeta,I_licr_c042_zeta_un_,I_licr_c042_zeta_vn_,n_I_licr_c042_zeta] = test_loader_lm_RRR_0(C_rank_c042_,E_licr_,I_licr_,dir_trunk,'licr_c042');
for n_col=1:6;
E_licr_c042_ = E_licr_ - [ (ones(n_u,1)*E_licr_c042_zeta_un_(1,1:n_col) + C_rank_c042_*E_licr_c042_zeta_un_(2:end,1:n_col))*transpose(E_licr_c042_zeta_vn_(:,1:n_col)) ]; %<-- correct for linear effect of covariates. ;
I_licr_c042_ = I_licr_ - [ (ones(n_u,1)*I_licr_c042_zeta_un_(1,1:n_col) + C_rank_c042_*I_licr_c042_zeta_un_(2:end,1:n_col))*transpose(I_licr_c042_zeta_vn_(:,1:n_col)) ]; %<-- correct for linear effect of covariates. ;
test_loader_helper_CLabel_Distance_0(dir_trunk,E_licr_c042_,sprintf('E_licr_c042r%d_',n_col),CLabel_sub_);
test_loader_helper_CLabel_Distance_0(dir_trunk,I_licr_c042_,sprintf('I_licr_c042r%d_',n_col),CLabel_sub_);
clear E_licr_c042_ ; clear I_licr_c042_ ;
end;%for n_col=1:6;
%%%%%%%%;
[E_licr_c012_beta_un_,E_licr_c012_beta_vn_,n_E_licr_c012_beta,I_licr_c012_beta_un_,I_licr_c012_beta_vn_,n_I_licr_c012_beta,E_licr_c012_zeta_un_,E_licr_c012_zeta_vn_,n_E_licr_c012_zeta,I_licr_c012_zeta_un_,I_licr_c012_zeta_vn_,n_I_licr_c012_zeta] = test_loader_lm_RRR_0(C_rank_c012_,E_licr_,I_licr_,dir_trunk,'licr_c012');
for n_col=1:6;
E_licr_c012_ = E_licr_ - [ (ones(n_u,1)*E_licr_c012_zeta_un_(1,1:n_col) + C_rank_c012_*E_licr_c012_zeta_un_(2:end,1:n_col))*transpose(E_licr_c012_zeta_vn_(:,1:n_col)) ]; %<-- correct for linear effect of covariates. ;
I_licr_c012_ = I_licr_ - [ (ones(n_u,1)*I_licr_c012_zeta_un_(1,1:n_col) + C_rank_c012_*I_licr_c012_zeta_un_(2:end,1:n_col))*transpose(I_licr_c012_zeta_vn_(:,1:n_col)) ]; %<-- correct for linear effect of covariates. ;
test_loader_helper_CLabel_Distance_0(dir_trunk,E_licr_c012_,sprintf('E_licr_c012r%d_',n_col),CLabel_sub_);
test_loader_helper_CLabel_Distance_0(dir_trunk,I_licr_c012_,sprintf('I_licr_c012r%d_',n_col),CLabel_sub_);
clear E_licr_c012_ ; clear I_licr_c012_ ;
end;%for n_col=1:6;
%%%%%%%%;
[E_licr_c127_beta_un_,E_licr_c127_beta_vn_,n_E_licr_c127_beta,I_licr_c127_beta_un_,I_licr_c127_beta_vn_,n_I_licr_c127_beta,E_licr_c127_zeta_un_,E_licr_c127_zeta_vn_,n_E_licr_c127_zeta,I_licr_c127_zeta_un_,I_licr_c127_zeta_vn_,n_I_licr_c127_zeta] = test_loader_lm_RRR_0(C_rank_c127_,E_licr_,I_licr_,dir_trunk,'licr_c127');
for n_col=1:6;
E_licr_c127_ = E_licr_ - [ (ones(n_u,1)*E_licr_c127_zeta_un_(1,1:n_col) + C_rank_c127_*E_licr_c127_zeta_un_(2:end,1:n_col))*transpose(E_licr_c127_zeta_vn_(:,1:n_col)) ]; %<-- correct for linear effect of covariates. ;
I_licr_c127_ = I_licr_ - [ (ones(n_u,1)*I_licr_c127_zeta_un_(1,1:n_col) + C_rank_c127_*I_licr_c127_zeta_un_(2:end,1:n_col))*transpose(I_licr_c127_zeta_vn_(:,1:n_col)) ]; %<-- correct for linear effect of covariates. ;
test_loader_helper_CLabel_Distance_0(dir_trunk,E_licr_c127_,sprintf('E_licr_c127r%d_',n_col),CLabel_sub_);
test_loader_helper_CLabel_Distance_0(dir_trunk,I_licr_c127_,sprintf('I_licr_c127r%d_',n_col),CLabel_sub_);
...
test_loader_helper_tsne_50(dir_trunk,E_limp_,'E_limp_',CLabel_sub_);
test_loader_helper_tsne_50(dir_trunk,I_limp_,'I_limp_',CLabel_sub_);
test_loader_helper_tsne_50(dir_trunk,E_limp_,'E_limp_',CLabel_sub_,100);
test_loader_helper_tsne_50(dir_trunk,I_limp_,'I_limp_',CLabel_sub_,100);
%%%%%%%%;
[E_limp_c042_beta_un_,E_limp_c042_beta_vn_,n_E_limp_c042_beta,I_limp_c042_beta_un_,I_limp_c042_beta_vn_,n_I_limp_c042_beta,E_limp_c042_zeta_un_,E_limp_c042_zeta_vn_,n_E_limp_c042_zeta,I_limp_c042_zeta_un_,I_limp_c042_zeta_vn_,n_I_limp_c042_zeta] = test_loader_lm_RRR_0(C_rank_c042_,E_limp_,I_limp_,dir_trunk,'limp_c042');
for n_col=1:6;
E_limp_c042_ = E_limp_ - [ (ones(n_u,1)*E_limp_c042_zeta_un_(1,1:n_col) + C_rank_c042_*E_limp_c042_zeta_un_(2:end,1:n_col))*transpose(E_limp_c042_zeta_vn_(:,1:n_col)) ]; %<-- correct for linear effect of covariates. ;
I_limp_c042_ = I_limp_ - [ (ones(n_u,1)*I_limp_c042_zeta_un_(1,1:n_col) + C_rank_c042_*I_limp_c042_zeta_un_(2:end,1:n_col))*transpose(I_limp_c042_zeta_vn_(:,1:n_col)) ]; %<-- correct for linear effect of covariates. ;
test_loader_helper_tsne_50(dir_trunk,E_limp_c042_,sprintf('E_limp_c042r%d_',n_col),CLabel_sub_);
test_loader_helper_tsne_50(dir_trunk,I_limp_c042_,sprintf('I_limp_c042r%d_',n_col),CLabel_sub_);
test_loader_helper_tsne_50(dir_trunk,E_limp_c042_,sprintf('E_limp_c042r%d_',n_col),CLabel_sub_,100);
test_loader_helper_tsne_50(dir_trunk,I_limp_c042_,sprintf('I_limp_c042r%d_',n_col),CLabel_sub_,100);
clear E_limp_c042_ ; clear I_limp_c042_ ;
end;%for n_col=1:6;
%%%%%%%%
[E_limp_c012_beta_un_,E_limp_c012_beta_vn_,n_E_limp_c012_beta,I_limp_c012_beta_un_,I_limp_c012_beta_vn_,n_I_limp_c012_beta,E_limp_c012_zeta_un_,E_limp_c012_zeta_vn_,n_E_limp_c012_zeta,I_limp_c012_zeta_un_,I_limp_c012_zeta_vn_,n_I_limp_c012_zeta] = test_loader_lm_RRR_0(C_rank_c012_,E_limp_,I_limp_,dir_trunk,'limp_c012');
...
E_limp_c012_ = E_limp_ - [ (ones(n_u,1)*E_limp_c012_zeta_un_(1,1:n_col) + C_rank_c012_*E_limp_c012_zeta_un_(2:end,1:n_col))*transpose(E_limp_c012_zeta_vn_(:,1:n_col)) ]; %<-- correct for linear effect of covariates. ;
I_limp_c012_ = I_limp_ - [ (ones(n_u,1)*I_limp_c012_zeta_un_(1,1:n_col) + C_rank_c012_*I_limp_c012_zeta_un_(2:end,1:n_col))*transpose(I_limp_c012_zeta_vn_(:,1:n_col)) ]; %<-- correct for linear effect of covariates. ;
test_loader_helper_tsne_50(dir_trunk,E_limp_c012_,sprintf('E_limp_c012r%d_',n_col),CLabel_sub_);
test_loader_helper_tsne_50(dir_trunk,I_limp_c012_,sprintf('I_limp_c012r%d_',n_col),CLabel_sub_);
test_loader_helper_tsne_50(dir_trunk,E_limp_c012_,sprintf('E_limp_c012r%d_',n_col),CLabel_sub_,100);
test_loader_helper_tsne_50(dir_trunk,I_limp_c012_,sprintf('I_limp_c012r%d_',n_col),CLabel_sub_,100);
clear E_limp_c012_ ; clear I_limp_c012_ ;
end;%for n_col=1:6;
%%%%%%%%
[E_limp_c127_beta_un_,E_limp_c127_beta_vn_,n_E_limp_c127_beta,I_limp_c127_beta_un_,I_limp_c127_beta_vn_,n_I_limp_c127_beta,E_limp_c127_zeta_un_,E_limp_c127_zeta_vn_,n_E_limp_c127_zeta,I_limp_c127_zeta_un_,I_limp_c127_zeta_vn_,n_I_limp_c127_zeta] = test_loader_lm_RRR_0(C_rank_c127_,E_limp_,I_limp_,dir_trunk,'limp_c127');
...
E_limp_c127_ = E_limp_ - [ (ones(n_u,1)*E_limp_c127_zeta_un_(1,1:n_col) + C_rank_c127_*E_limp_c127_zeta_un_(2:end,1:n_col))*transpose(E_limp_c127_zeta_vn_(:,1:n_col)) ]; %<-- correct for linear effect of covariates. ;
I_limp_c127_ = I_limp_ - [ (ones(n_u,1)*I_limp_c127_zeta_un_(1,1:n_col) + C_rank_c127_*I_limp_c127_zeta_un_(2:end,1:n_col))*transpose(I_limp_c127_zeta_vn_(:,1:n_col)) ]; %<-- correct for linear effect of covariates. ;
test_loader_helper_tsne_50(dir_trunk,E_limp_c127_,sprintf('E_limp_c127r%d_',n_col),CLabel_sub_);
test_loader_helper_tsne_50(dir_trunk,I_limp_c127_,sprintf('I_limp_c127r%d_',n_col),CLabel_sub_);
test_loader_helper_tsne_50(dir_trunk,E_limp_c127_,sprintf('E_limp_c127r%d_',n_col),CLabel_sub_,100);
test_loader_helper_tsne_50(dir_trunk,I_limp_c127_,sprintf('I_limp_c127r%d_',n_col),CLabel_sub_,100);
clear E_limp_c127_ ; clear I_limp_c127_ ;
end;%for n_col=1:6;
%%%%%%%%
clear E_limp_ ; clear I_limp_ ; 
...
test_loader_helper_tsne_50(dir_trunk,E_licl_,'E_licl_',CLabel_sub_);
test_loader_helper_tsne_50(dir_trunk,I_licl_,'I_licl_',CLabel_sub_);
test_loader_helper_tsne_50(dir_trunk,E_licl_,'E_licl_',CLabel_sub_,100);
test_loader_helper_tsne_50(dir_trunk,I_licl_,'I_licl_',CLabel_sub_,100);
%%%%%%%%;
[E_licl_c042_beta_un_,E_licl_c042_beta_vn_,n_E_licl_c042_beta,I_licl_c042_beta_un_,I_licl_c042_beta_vn_,n_I_licl_c042_beta,E_licl_c042_zeta_un_,E_licl_c042_zeta_vn_,n_E_licl_c042_zeta,I_licl_c042_zeta_un_,I_licl_c042_zeta_vn_,n_I_licl_c042_zeta] = test_loader_lm_RRR_0(C_rank_c042_,E_licl_,I_licl_,dir_trunk,'licl_c042');
for n_col=1:6;
E_licl_c042_ = E_licl_ - [ (ones(n_u,1)*E_licl_c042_zeta_un_(1,1:n_col) + C_rank_c042_*E_licl_c042_zeta_un_(2:end,1:n_col))*transpose(E_licl_c042_zeta_vn_(:,1:n_col)) ]; %<-- correct for linear effect of covariates. ;
I_licl_c042_ = I_licl_ - [ (ones(n_u,1)*I_licl_c042_zeta_un_(1,1:n_col) + C_rank_c042_*I_licl_c042_zeta_un_(2:end,1:n_col))*transpose(I_licl_c042_zeta_vn_(:,1:n_col)) ]; %<-- correct for linear effect of covariates. ;
test_loader_helper_tsne_50(dir_trunk,E_licl_c042_,sprintf('E_licl_c042r%d_',n_col),CLabel_sub_);
test_loader_helper_tsne_50(dir_trunk,I_licl_c042_,sprintf('I_licl_c042r%d_',n_col),CLabel_sub_);
test_loader_helper_tsne_50(dir_trunk,E_licl_c042_,sprintf('E_licl_c042r%d_',n_col),CLabel_sub_,100);
test_loader_helper_tsne_50(dir_trunk,I_licl_c042_,sprintf('I_licl_c042r%d_',n_col),CLabel_sub_,100);
clear E_licl_c042_ ; clear I_licl_c042_ ;
end;%for n_col=1:6;
%%%%%%%%
[E_licl_c012_beta_un_,E_licl_c012_beta_vn_,n_E_licl_c012_beta,I_licl_c012_beta_un_,I_licl_c012_beta_vn_,n_I_licl_c012_beta,E_licl_c012_zeta_un_,E_licl_c012_zeta_vn_,n_E_licl_c012_zeta,I_licl_c012_zeta_un_,I_licl_c012_zeta_vn_,n_I_licl_c012_zeta] = test_loader_lm_RRR_0(C_rank_c012_,E_licl_,I_licl_,dir_trunk,'licl_c012');
...
E_licl_c012_ = E_licl_ - [ (ones(n_u,1)*E_licl_c012_zeta_un_(1,1:n_col) + C_rank_c012_*E_licl_c012_zeta_un_(2:end,1:n_col))*transpose(E_licl_c012_zeta_vn_(:,1:n_col)) ]; %<-- correct for linear effect of covariates. ;
I_licl_c012_ = I_licl_ - [ (ones(n_u,1)*I_licl_c012_zeta_un_(1,1:n_col) + C_rank_c012_*I_licl_c012_zeta_un_(2:end,1:n_col))*transpose(I_licl_c012_zeta_vn_(:,1:n_col)) ]; %<-- correct for linear effect of covariates. ;
test_loader_helper_tsne_50(dir_trunk,E_licl_c012_,sprintf('E_licl_c012r%d_',n_col),CLabel_sub_);
test_loader_helper_tsne_50(dir_trunk,I_licl_c012_,sprintf('I_licl_c012r%d_',n_col),CLabel_sub_);
test_loader_helper_tsne_50(dir_trunk,E_licl_c012_,sprintf('E_licl_c012r%d_',n_col),CLabel_sub_,100);
test_loader_helper_tsne_50(dir_trunk,I_licl_c012_,sprintf('I_licl_c012r%d_',n_col),CLabel_sub_,100);
clear E_licl_c012_ ; clear I_licl_c012_ ;
end;%for n_col=1:6;
%%%%%%%%
[E_licl_c127_beta_un_,E_licl_c127_beta_vn_,n_E_licl_c127_beta,I_licl_c127_beta_un_,I_licl_c127_beta_vn_,n_I_licl_c127_beta,E_licl_c127_zeta_un_,E_licl_c127_zeta_vn_,n_E_licl_c127_zeta,I_licl_c127_zeta_un_,I_licl_c127_zeta_vn_,n_I_licl_c127_zeta] = test_loader_lm_RRR_0(C_rank_c127_,E_licl_,I_licl_,dir_trunk,'licl_c127');
...
E_licl_c127_ = E_licl_ - [ (ones(n_u,1)*E_licl_c127_zeta_un_(1,1:n_col) + C_rank_c127_*E_licl_c127_zeta_un_(2:end,1:n_col))*transpose(E_licl_c127_zeta_vn_(:,1:n_col)) ]; %<-- correct for linear effect of covariates. ;
I_licl_c127_ = I_licl_ - [ (ones(n_u,1)*I_licl_c127_zeta_un_(1,1:n_col) + C_rank_c127_*I_licl_c127_zeta_un_(2:end,1:n_col))*transpose(I_licl_c127_zeta_vn_(:,1:n_col)) ]; %<-- correct for linear effect of covariates. ;
test_loader_helper_tsne_50(dir_trunk,E_licl_c127_,sprintf('E_licl_c127r%d_',n_col),CLabel_sub_);
test_loader_helper_tsne_50(dir_trunk,I_licl_c127_,sprintf('I_licl_c127r%d_',n_col),CLabel_sub_);
test_loader_helper_tsne_50(dir_trunk,E_licl_c127_,sprintf('E_licl_c127r%d_',n_col),CLabel_sub_,100);
test_loader_helper_tsne_50(dir_trunk,I_licl_c127_,sprintf('I_licl_c127r%d_',n_col),CLabel_sub_,100);
clear E_licl_c127_ ; clear I_licl_c127_ ;
end;%for n_col=1:6;
%%%%%%%%
clear E_licl_ ; clear I_licl_ ; 
...
E_licr_ = textread(sprintf('%s/dir_mat/E_licr_.tsv',dir_trunk));E_licr_ = E_licr_(:,1:end-1);
I_licr_ = textread(sprintf('%s/dir_mat/I_licr_.tsv',dir_trunk));I_licr_ = I_licr_(:,1:end-1);
%test_loader_helper_tsne_50(dir_trunk,E_licr_,'E_licr_',CLabel_sub_);
%test_loader_helper_tsne_50(dir_trunk,I_licr_,'I_licr_',CLabel_sub_);
test_loader_helper_tsne_50(dir_trunk,E_licr_,'E_licr_',CLabel_sub_,100);
test_loader_helper_tsne_50(dir_trunk,I_licr_,'I_licr_',CLabel_sub_,100);
%%%%%%%%;
[E_licr_c042_beta_un_,E_licr_c042_beta_vn_,n_E_licr_c042_beta,I_licr_c042_beta_un_,I_licr_c042_beta_vn_,n_I_licr_c042_beta,E_licr_c042_zeta_un_,E_licr_c042_zeta_vn_,n_E_licr_c042_zeta,I_licr_c042_zeta_un_,I_licr_c042_zeta_vn_,n_I_licr_c042_zeta] = test_loader_lm_RRR_0(C_rank_c042_,E_licr_,I_licr_,dir_trunk,'licr_c042');
E_licr_c042_ = E_licr_ - [ (ones(n_u,1)*E_licr_c042_zeta_un_(1,:) + C_rank_c042_*E_licr_c042_zeta_un_(2:end,:))*transpose(E_licr_c042_zeta_vn_) ]; %<-- correct for linear effect of covariates. ;
I_licr_c042_ = I_licr_ - [ (ones(n_u,1)*I_licr_c042_zeta_un_(1,:) + C_rank_c042_*I_licr_c042_zeta_un_(2:end,:))*transpose(I_licr_c042_zeta_vn_) ]; %<-- correct for linear effect of covariates. ;
%test_loader_helper_tsne_50(dir_trunk,E_licr_c042_,'E_licr_c042_',CLabel_sub_);
%test_loader_helper_tsne_50(dir_trunk,I_licr_c042_,'I_licr_c042_',CLabel_sub_);
test_loader_helper_tsne_50(dir_trunk,E_licr_c042_,'E_licr_c042_',CLabel_sub_,100);
test_loader_helper_tsne_50(dir_trunk,I_licr_c042_,'I_licr_c042_',CLabel_sub_,100);
clear E_licr_c042_ ; clear I_licr_c042_ ;
%%%%%%%%
[E_licr_c012_beta_un_,E_licr_c012_beta_vn_,n_E_licr_c012_beta,I_licr_c012_beta_un_,I_licr_c012_beta_vn_,n_I_licr_c012_beta,E_licr_c012_zeta_un_,E_licr_c012_zeta_vn_,n_E_licr_c012_zeta,I_licr_c012_zeta_un_,I_licr_c012_zeta_vn_,n_I_licr_c012_zeta] = test_loader_lm_RRR_0(C_rank_c012_,E_licr_,I_licr_,dir_trunk,'licr_c012');
E_licr_c012_ = E_licr_ - [ (ones(n_u,1)*E_licr_c012_zeta_un_(1,:) + C_rank_c012_*E_licr_c012_zeta_un_(2:end,:))*transpose(E_licr_c012_zeta_vn_) ]; %<-- correct for linear effect of covariates. ;
I_licr_c012_ = I_licr_ - [ (ones(n_u,1)*I_licr_c012_zeta_un_(1,:) + C_rank_c012_*I_licr_c012_zeta_un_(2:end,:))*transpose(I_licr_c012_zeta_vn_) ]; %<-- correct for linear effect of covariates. ;
%test_loader_helper_tsne_50(dir_trunk,E_licr_c012_,'E_licr_c012_',CLabel_sub_);
%test_loader_helper_tsne_50(dir_trunk,I_licr_c012_,'I_licr_c012_',CLabel_sub_);
test_loader_helper_tsne_50(dir_trunk,E_licr_c012_,'E_licr_c012_',CLabel_sub_,100);
test_loader_helper_tsne_50(dir_trunk,I_licr_c012_,'I_licr_c012_',CLabel_sub_,100);
clear E_licr_c012_ ; clear I_licr_c012_ ;
%%%%%%%%
[E_licr_c127_beta_un_,E_licr_c127_beta_vn_,n_E_licr_c127_beta,I_licr_c127_beta_un_,I_licr_c127_beta_vn_,n_I_licr_c127_beta,E_licr_c127_zeta_un_,E_licr_c127_zeta_vn_,n_E_licr_c127_zeta,I_licr_c127_zeta_un_,I_licr_c127_zeta_vn_,n_I_licr_c127_zeta] = test_loader_lm_RRR_0(C_rank_c127_,E_licr_,I_licr_,dir_trunk,'licr_c127');
n_col = 3;
 E_licr_c127_ = E_licr_ - [ (ones(n_u,1)*E_licr_c127_zeta_un_(1,1:n_col) + C_rank_c127_*E_licr_c127_zeta_un_(2:end,1:n_col))*transpose(E_licr_c127_zeta_vn_(:,1:n_col)) ]; %<-- correct for linear effect of covariates. ;
 I_licr_c127_ = I_licr_ - [ (ones(n_u,1)*I_licr_c127_zeta_un_(1,1:n_col) + C_rank_c127_*I_licr_c127_zeta_un_(2:end,1:n_col))*transpose(I_licr_c127_zeta_vn_(:,1:n_col)) ]; %<-- correct for linear effect of covariates. ;
%test_loader_helper_tsne_50(dir_trunk,E_licr_c127_,'E_licr_c127_',CLabel_sub_);
%test_loader_helper_tsne_50(dir_trunk,I_licr_c127_,'I_licr_c127_',CLabel_sub_);
test_loader_helper_tsne_50(dir_trunk,E_licr_c127_,'E_licr_c127_',CLabel_sub_,100);
test_loader_helper_tsne_50(dir_trunk,I_licr_c127_,'I_licr_c127_',CLabel_sub_,100);
clear E_licr_c127_ ; clear I_licr_c127_ ;
%%%%%%%%
clear E_licr_ ; clear I_licr_ ; 
...
prefix = 'E_limp_c000'; test_loader_lakcluster_dr_0(E_limp_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(E_limp_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(E_limp_,gamma,n_shuffle,prefix);
prefix = 'I_limp_c000'; test_loader_lakcluster_dr_0(I_limp_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(I_limp_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(I_limp_,gamma,n_shuffle,prefix);
...
I_licl_ = textread(sprintf('%s/dir_mat/I_licl_.tsv',dir_trunk)); I_licl_ = I_licl_(:,1:end-1);
gamma = 0.01; n_shuffle = 64;
prefix = 'E_licl_c000'; test_loader_lakcluster_dr_0(E_licl_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(E_licl_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(E_licl_,gamma,n_shuffle,prefix);
prefix = 'I_licl_c000'; test_loader_lakcluster_dr_0(I_licl_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(I_licl_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(I_licl_,gamma,n_shuffle,prefix);
...
I_licr_ = textread(sprintf('%s/dir_mat/I_licr_.tsv',dir_trunk)); I_licr_ = I_licr_(:,1:end-1);
gamma = 0.01; n_shuffle = 64;
prefix = 'E_licr_c000'; test_loader_lakcluster_dr_0(E_licr_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(E_licr_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(E_licr_,gamma,n_shuffle,prefix);
prefix = 'I_licr_c000'; test_loader_lakcluster_dr_0(I_licr_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(I_licr_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(I_licr_,gamma,n_shuffle,prefix);
clear E_licr_ I_licr_ ;
%%%%%%%%;
gamma = 0.01; n_shuffle = 32;
%%%%%%%%;
prefix = 'E_limp_c012'; test_loader_lakcluster_dr_0(E_limp_c012_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(E_limp_c012_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(E_limp_c012_,gamma,n_shuffle,prefix);
prefix = 'I_limp_c012'; test_loader_lakcluster_dr_0(I_limp_c012_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(I_limp_c012_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(I_limp_c012_,gamma,n_shuffle,prefix);
prefix = 'E_licl_c012'; test_loader_lakcluster_dr_0(E_licl_c012_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(E_licl_c012_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(E_licl_c012_,gamma,n_shuffle,prefix);
prefix = 'I_licl_c012'; test_loader_lakcluster_dr_0(I_licl_c012_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(I_licl_c012_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(I_licl_c012_,gamma,n_shuffle,prefix);
prefix = 'E_licr_c012'; test_loader_lakcluster_dr_0(E_licr_c012_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(E_licr_c012_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(E_licr_c012_,gamma,n_shuffle,prefix);
prefix = 'I_licr_c012'; test_loader_lakcluster_dr_0(I_licr_c012_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(I_licr_c012_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(I_licr_c012_,gamma,n_shuffle,prefix);
%%%%%%%%;
prefix = 'E_limp_c042'; test_loader_lakcluster_dr_0(E_limp_c042_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(E_limp_c042_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(E_limp_c042_,gamma,n_shuffle,prefix);
prefix = 'I_limp_c042'; test_loader_lakcluster_dr_0(I_limp_c042_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(I_limp_c042_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(I_limp_c042_,gamma,n_shuffle,prefix);
prefix = 'E_licl_c042'; test_loader_lakcluster_dr_0(E_licl_c042_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(E_licl_c042_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(E_licl_c042_,gamma,n_shuffle,prefix);
prefix = 'I_licl_c042'; test_loader_lakcluster_dr_0(I_licl_c042_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(I_licl_c042_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(I_licl_c042_,gamma,n_shuffle,prefix);
prefix = 'E_licr_c042'; test_loader_lakcluster_dr_0(E_licr_c042_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(E_licr_c042_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(E_licr_c042_,gamma,n_shuffle,prefix);
prefix = 'I_licr_c042'; test_loader_lakcluster_dr_0(I_licr_c042_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(I_licr_c042_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(I_licr_c042_,gamma,n_shuffle,prefix);
%%%%%%%%;
prefix = 'E_limp_c127'; test_loader_lakcluster_dr_0(E_limp_c127_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(E_limp_c127_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(E_limp_c127_,gamma,n_shuffle,prefix);
prefix = 'I_limp_c127'; test_loader_lakcluster_dr_0(I_limp_c127_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(I_limp_c127_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(I_limp_c127_,gamma,n_shuffle,prefix);
prefix = 'E_licl_c127'; test_loader_lakcluster_dr_0(E_licl_c127_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(E_licl_c127_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(E_licl_c127_,gamma,n_shuffle,prefix);
prefix = 'I_licl_c127'; test_loader_lakcluster_dr_0(I_licl_c127_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(I_licl_c127_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(I_licl_c127_,gamma,n_shuffle,prefix);
prefix = 'E_licr_c127'; test_loader_lakcluster_dr_0(E_licr_c127_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(E_licr_c127_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(E_licr_c127_,gamma,n_shuffle,prefix);
prefix = 'I_licr_c127'; test_loader_lakcluster_dr_0(I_licr_c127_,gamma,n_shuffle,prefix); test_loader_dexcluster_nonbinary_dr_0(I_licr_c127_,gamma,n_shuffle,prefix); test_loader_lakcluster_nonbinary_dr_0(I_licr_c127_,gamma,n_shuffle,prefix);
%%%%%%%%;
 %}
