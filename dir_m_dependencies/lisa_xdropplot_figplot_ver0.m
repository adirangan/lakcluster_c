...
set(gcf,'Position',1+[0,0,1024,470]);
print('-djpeg',sprintf('%s/%s_mds_dist_A_ni%.3d.jpg',dir_out_s0000,string_name_s0000,tmp_iteration));
print('-depsc',sprintf('%s/%s_mds_dist_A_ni%.3d.eps',dir_out_s0000,string_name_s0000,tmp_iteration));
drawnow();pause(1);
figure;clf;
for np=1:2;
rcut = rcut_(np);
...
set(gcf,'Position',1+[0,0,1024,470]);
print('-djpeg',sprintf('%s/%s_mds_dist_B_ni%.3d.jpg',dir_out_s0000,string_name_s0000,tmp_iteration));
print('-depsc',sprintf('%s/%s_mds_dist_B_ni%.3d.eps',dir_out_s0000,string_name_s0000,tmp_iteration));
drawnow();pause(1);
