...
disp(sprintf(' %% zeta_E_: %d/%d = %0.2f out of bounds',tmp_n,numel(tmp_),tmp_n/numel(tmp_)))
end;%if flag_E;
if flag_I;
...
disp(sprintf(' %% zeta_I_: %d/%d = %0.2f out of bounds',tmp_n,numel(tmp_),tmp_n/numel(tmp_)))
end;%if flag_I;
clear tmp_ tmp_n;
end;%if flag_disp;
%%%%%%%%;
...
test_loader_lakcluster_dr_0(E_array_,gamma,n_shuffle,'E_limp_rank_sub');
%%%%%%%%;
...
test_loader_lakcluster_dr_0(I_array_,gamma,n_shuffle,'I_limp_rank_sub');
%%%%%%%%;
E_array_ = E_rank_; %<-- copy. ;
E_array_ = E_array_ - [ (ones(n_u,1)*zeta_E_un_(1,:) + C_rank_*zeta_E_un_(2:end,:))*transpose(zeta_E_vn_) ]; %<-- correct for linear effect of covariates. ;
E_array_ = E_array_ - median(E_array_,1); %<-- normalize for uniform sparsity = 0.5. ;
...
test_loader_lakcluster_dr_0(X_array_,gamma,n_shuffle,'X_limp_rank_sub');
%%%%%%%%;
