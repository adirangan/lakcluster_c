function [output_string,gamma_d] = xxxcluster_PGC_uADZSZDA_xfix_ver13(prefix,maf_lo_threshold,maf_hi_threshold,mc_string,rev_flag,n_mds,mds_used_,mds_repl,gamma,B_MLT,Ireq,n_scramble,nshuffle);
...
for n_scramble = [0,1];
for nshuffle = [0,8];
disp(xxxcluster_PGC_uADZSZDA_xfix_ver13('dex',maf_lo_threshold,maf_hi_threshold,mc_string_{1},rev_flag,n_mds,mds_used_,mds_repl,gamma,B_MLT,Ireq,n_scramble,nshuffle));
disp(xxxcluster_PGC_uADZSZDA_xfix_ver13('lak',maf_lo_threshold,maf_hi_threshold,mc_string_{1},rev_flag,n_mds,mds_used_,mds_repl,gamma,B_MLT,Ireq,n_scramble,nshuffle));
