function [cauc_avg_T,cauc_min_T,auc_T] = cauc_1(v_ctrl,v_case,y_ctrl,y_case,s_ctrl,s_case);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ;
% ;
% function [cauc_avg_T,cauc_min_T,auc_T] = cauc_1(v_ctrl,v_case,y_ctrl,y_case,s_ctrl,s_case);
% ;
...
[cauc_avg,cauc_min,auc] = cauc_1(v_ctrl,v_case,y_ctrl,y_case,s_ctrl,s_case);
