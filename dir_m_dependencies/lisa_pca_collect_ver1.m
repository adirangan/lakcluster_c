...
subplot(5,3,1*3 + cl_num_arm2 - (cl_num_arm2>=cl_num_arm1));hold on; plot(niteration_,min(30,-logp_auc_arm1_(:,cl_num_arm2)),'rx-'); hold off; ylim([0,30]);
...
hold on; plot(niteration_,min(30,-logp_beta0_arm1_(:,cl_num_arm2)),'rx-'); hold off; ylim([0,30]);
hold on; plot(niteration_,min(30,-logp_beta2_arm1_(:,cl_num_arm2)),'rs-'); hold off; ylim([0,30]);
...
plot(niteration_,min(30,-logp_auc_arm2_(:,cl_num_arm2)),'bo-',niteration_,0*niteration_ + -log(0.05),'k:'); 
...
title(sprintf('tst%d trn%d: beta',cl_num_arm1,cl_num_arm2));
subplot(5,3,3*3 + cl_num_arm2 - (cl_num_arm2>=cl_num_arm1));
hold on; 
plot(niteration_,min(30,-logp_beta0_arm2_(:,cl_num_arm2)),'bo-'); 
plot(niteration_,min(30,-logp_beta2_arm2_(:,cl_num_arm2)),'bs-'); 
plot(niteration_,0*niteration_ + -log(0.05),'k--');
plot(niteration_,0*niteration_ + -log(0.01),'k--');
hold off; ylim([0,30]);
xlabel('iteration'); ylabel('-logp beta arm2'); xlim([min(niteration_),max(niteration_)]);
title(sprintf('tst%d trn%d: -logp(beta)',cl_num_arm1,cl_num_arm2));
