function lisa_dosage_pca_ver7(n_scramble_use,flag_stage);
...
dosage_genotyped_DnV_arm2_ = zeros(n_patient_F_arm2,2);
dosage_genotyped_XnV_arm2_ = zeros(n_patient_F_arm2,2);
dosage_genotyped_DnV_arm2__ = cell(length(study_name_arm2_),1);
dosage_genotyped_XnV_arm2__ = cell(length(study_name_arm2_),1);
...
tmp_d1d_ = find(sum(d1d_by_eu1_xref_(:,neu1),2));
if (length(tmp_d1d_)>1); disp(sprintf(' %% Warning! tmp_d1d_ length %d in lisa_dosage_pca_ver7',length(tmp_d1d_))); end;
nd1d = tmp_d1d_(1);
tmp_bu1_ = find(sum(bu1_by_eu1_xref_(:,neu1),2));
if (length(tmp_bu1_)>1); disp(sprintf(' %% Warning! tmp_bu1_ length %d in lisa_dosage_pca_ver7',length(tmp_bu1_))); end;
nbu1 = tmp_bu1_(1);
...
nd1d = tmp_d1d_(1);
tmp_bu2_ = find(sum(bu2_by_eu2_xref_(:,neu2),2));
if (length(tmp_bu2_)>1); disp(sprintf(' %% Warning! tmp_bu2_ length %d in lisa_dosage_pca_ver7',length(tmp_bu2_))); end;
nbu2 = tmp_bu2_(1);
...
if (length(tmp_fu1_)>1); disp(sprintf(' %% Warning! tmp_fu1_ length %d in lisa_dosage_pca_ver7',length(tmp_fu1_))); end;
nfu1 = tmp_fu1_(1);
tmp_g1d_ = find(sum(g1d_by_hu1_xref_(:,nhu1),2));
if (length(tmp_g1d_)>1); disp(sprintf(' %% Warning! tmp_g1d_ length %d in lisa_dosage_pca_ver7',length(tmp_g1d_))); end;
ng1d = tmp_g1d_(1);
...
if (length(tmp_fu2_)>1); disp(sprintf(' %% Warning! tmp_fu2_ length %d in lisa_dosage_pca_ver7',length(tmp_fu2_))); end;
nfu2 = tmp_fu2_(1);
...
%%%%%%%%%%%%%%%%;
ent_cutoff = 0.03; 
flag_atfr_vs_A_p = 1; %<-- 1=atfr; 0=A_p;
flag_atfr_arm1 = 1; %<-- 1 means use arm1 frequency to normalize; 0 means use arm2. ;
...
tmp_dosage_genotyped_AnV_ = zeros(n_dosage_patient,2);
mismatch_d1_imputed__{nstudy_arm2} = 9*ones(n_dosage_snp,1);
mismatch_d1_genotyped__{nstudy_arm2} = 9*ones(n_dosage_snp,1);
mismatch_d2_imputed__{nstudy_arm2} = 9*ones(n_dosage_snp,1);
mismatch_d2_genotyped__{nstudy_arm2} = 9*ones(n_dosage_snp,1);
flag_bo1_all_sum = 0; flag_bo2_and_sum = 0; flag_bo2_xor_sum = 0; flag_bo2_nor_sum = 0;
%%%%%%%%;
fid = fopen(fname_dosage);
...
mismatch_d2_genotyped__{nstudy_arm2}(nd1d) = tmp_error_code_d2;
...
mismatch_d1_genotyped__{nstudy_arm2}(nd1d) = tmp_error_code_d1;
...
%%%%%%%%;
if flag_atfr_vs_A_p==1 & flag_atfr_arm1==1;
...
tmp_dosage_genotyped_val_and_normalized_ = flag_bo2_and*(2*tmp_dosage_imputed_val_and_ - 1 - atfr_arm1_perm_and_alpha_(nd1d)) / sqrt(atfr_arm1_perm_and_delta_(nd1d));
tmp_dosage_genotyped_val_xor_normalized_ = flag_bo2_xor*(2*tmp_dosage_imputed_val_xor_ - 1 - atfr_arm1_perm_xor_alpha_(nd1d)) / sqrt(atfr_arm1_perm_xor_delta_(nd1d));
tmp_dosage_genotyped_val_nor_normalized_ = flag_bo2_nor*(2*tmp_dosage_imputed_val_nor_ - 1 - atfr_arm1_perm_nor_alpha_(nd1d)) / sqrt(atfr_arm1_perm_nor_delta_(nd1d));
end;%if flag_atfr_vs_A_p==1 & flag_atfr_arm1==1;
if flag_atfr_vs_A_p==0 & flag_atfr_arm1==1;
...
tmp_dosage_genotyped_val_and_normalized_ = flag_bo2_and*(2*tmp_dosage_imputed_val_and_ - 1 - A_p_arm1_perm_and_alpha_(nd1d)) / sqrt(A_p_arm1_perm_and_delta_(nd1d));
tmp_dosage_genotyped_val_xor_normalized_ = flag_bo2_xor*(2*tmp_dosage_imputed_val_xor_ - 1 - A_p_arm1_perm_xor_alpha_(nd1d)) / sqrt(A_p_arm1_perm_xor_delta_(nd1d));
tmp_dosage_genotyped_val_nor_normalized_ = flag_bo2_nor*(2*tmp_dosage_imputed_val_nor_ - 1 - A_p_arm1_perm_nor_alpha_(nd1d)) / sqrt(A_p_arm1_perm_nor_delta_(nd1d));
end;%if flag_atfr_vs_A_p==0 & flag_atfr_arm1==1;
%%%%%%%%;
if flag_atfr_vs_A_p==1 & flag_atfr_arm1==0;
...
tmp_dosage_genotyped_val_and_normalized_ = flag_bo2_and*(2*tmp_dosage_imputed_val_and_ - 1 - atfr_arm2_perm_and_alpha_(nd1d)) / sqrt(atfr_arm2_perm_and_delta_(nd1d));
tmp_dosage_genotyped_val_xor_normalized_ = flag_bo2_xor*(2*tmp_dosage_imputed_val_xor_ - 1 - atfr_arm2_perm_xor_alpha_(nd1d)) / sqrt(atfr_arm2_perm_xor_delta_(nd1d));
tmp_dosage_genotyped_val_nor_normalized_ = flag_bo2_nor*(2*tmp_dosage_imputed_val_nor_ - 1 - atfr_arm2_perm_nor_alpha_(nd1d)) / sqrt(atfr_arm2_perm_nor_delta_(nd1d));
end;%if flag_atfr_vs_A_p==1 & flag_atfr_arm1==1;
if flag_atfr_vs_A_p==0 & flag_atfr_arm1==0;
...
tmp_dosage_genotyped_val_and_normalized_ = flag_bo2_and*(2*tmp_dosage_imputed_val_and_ - 1 - A_p_arm2_perm_and_alpha_(nd1d)) / sqrt(A_p_arm2_perm_and_delta_(nd1d));
tmp_dosage_genotyped_val_xor_normalized_ = flag_bo2_xor*(2*tmp_dosage_imputed_val_xor_ - 1 - A_p_arm2_perm_xor_alpha_(nd1d)) / sqrt(A_p_arm2_perm_xor_delta_(nd1d));
tmp_dosage_genotyped_val_nor_normalized_ = flag_bo2_nor*(2*tmp_dosage_imputed_val_nor_ - 1 - A_p_arm2_perm_nor_alpha_(nd1d)) / sqrt(A_p_arm2_perm_nor_delta_(nd1d));
end;%if flag_atfr_vs_A_p==0 & flag_atfr_arm1==1;
%%%%%%%%;
...
tmp_dosage_genotyped_val_and_normalized_ = 0*tmp_dosage_genotyped_val_and_normalized_;
tmp_dosage_genotyped_val_xor_normalized_ = 0*tmp_dosage_genotyped_val_xor_normalized_;
tmp_dosage_genotyped_val_nor_normalized_ = 0*tmp_dosage_genotyped_val_nor_normalized_;
end;%if set to zero. ;
%%%%%%%%%%%%%%%%;
...
%%%%%%%%;
tmp_bo2_and = find(strcmp(bo2_,d1d_{nd1d}) & strcmp(alleletype_arm2_,'and')); if (length(tmp_bo2_and)>1); disp(sprintf(' %% Warning! tmp_bo2_and length %d in lisa_dosage_pca_ver7.m',length(tmp_bo2_and))); end;
...
for nhu2=1:length(hu2_);
tmp_fu2_ = find(sum(fu2_by_hu2_xref_(:,nhu2),2)); if (length(tmp_fu2_)>1); disp(sprintf(' %% Warning! tmp_fu2_ length %d in lisa_dosage_pca_ver7',length(tmp_fu2_))); end; nfu2 = tmp_fu2_(1);
tmp_g1d_ = find(sum(g1d_by_hu2_xref_(:,nhu2),2)); if (length(tmp_g1d_)>1); disp(sprintf(' %% Warning! tmp_g1d_ length %d in lisa_dosage_pca_ver7',length(tmp_g1d_))); end; ng1d = tmp_g1d_(1);
assert(strcmp(fu2_{nfu2},g1d_{ng1d}));
...
%%%%%%%%;
tmp_bo2_xor = find(strcmp(bo2_,d1d_{nd1d}) & strcmp(alleletype_arm2_,'xor')); if (length(tmp_bo2_xor)>1); disp(sprintf(' %% Warning! tmp_bo2_xor length %d in lisa_dosage_pca_ver7.m',length(tmp_bo2_xor))); end;
...
%%%%%%%%;
tmp_bo2_nor = find(strcmp(bo2_,d1d_{nd1d}) & strcmp(alleletype_arm2_,'nor')); if (length(tmp_bo2_nor)>1); disp(sprintf(' %% Warning! tmp_bo2_nor length %d in lisa_dosage_pca_ver7.m',length(tmp_bo2_nor))); end;
...
tmp_dosage_imputed_AnV_ = tmp_dosage_imputed_AnV_ ...
   + tmp_dosage_imputed_val_and_normalized_*V_rx_perm_and_(nd1d,:) ...
   + tmp_dosage_imputed_val_xor_normalized_*V_rx_perm_xor_(nd1d,:) ...
   + tmp_dosage_imputed_val_nor_normalized_*V_rx_perm_nor_(nd1d,:) ...
  ;
tmp_dosage_genotyped_AnV_ = tmp_dosage_genotyped_AnV_ ...
   + tmp_dosage_genotyped_val_and_normalized_*V_rx_perm_and_(nd1d,:) ...
   + tmp_dosage_genotyped_val_xor_normalized_*V_rx_perm_xor_(nd1d,:) ...
   + tmp_dosage_genotyped_val_nor_normalized_*V_rx_perm_nor_(nd1d,:) ...
  ;
end;%if (length(neu1)==1);
end;%for ndosage_snp=1:n_dosage_snp;
fclose(fid);
...
tmp_h_mismatch_d1_genotyped_ = hist(mismatch_d1_genotyped__{nstudy_arm2},[0,1,2,3,8,9]);
disp(sprintf(' %% tmp_h_d1_mismatched_imputed_  : %0.10d %0.10d %0.10d %0.10d %0.10d %0.10d',tmp_h_mismatch_d1_imputed_));
disp(sprintf(' %% tmp_h_d1_mismatched_genotyped_: %0.10d %0.10d %0.10d %0.10d %0.10d %0.10d',tmp_h_mismatch_d1_genotyped_));
tmp_h_mismatch_d2_imputed_ = hist(mismatch_d2_imputed__{nstudy_arm2},[0,1,2,3,8,9]);
tmp_h_mismatch_d2_genotyped_ = hist(mismatch_d2_genotyped__{nstudy_arm2},[0,1,2,3,8,9]);
disp(sprintf(' %% tmp_h_d2_mismatched_imputed_  : %0.10d %0.10d %0.10d %0.10d %0.10d %0.10d',tmp_h_mismatch_d2_imputed_));
disp(sprintf(' %% tmp_h_d2_mismatched_genotyped_: %0.10d %0.10d %0.10d %0.10d %0.10d %0.10d',tmp_h_mismatch_d2_genotyped_));
...
tmp_mismatch_d1_genotyped_swap_ = ( (mismatch_d1_genotyped__{nstudy_arm2}==error_code_dominance) | (mismatch_d1_genotyped__{nstudy_arm2}==error_code_both) );
...
tmp_mismatch_d2_genotyped_swap_ = ( (mismatch_d2_genotyped__{nstudy_arm2}==error_code_dominance) | (mismatch_d2_genotyped__{nstudy_arm2}==error_code_both) );
...
tmp_mismatch_d1_genotyped_keep_ = ( (mismatch_d1_genotyped__{nstudy_arm2}==error_code_null) | (mismatch_d1_genotyped__{nstudy_arm2}==error_code_synonym) );
...
tmp_mismatch_d2_genotyped_keep_ = ( (mismatch_d2_genotyped__{nstudy_arm2}==error_code_null) | (mismatch_d2_genotyped__{nstudy_arm2}==error_code_synonym) );
tmp_mismatch_dx_imputed_keep_ = tmp_mismatch_d1_imputed_keep_ & tmp_mismatch_d2_imputed_keep_ ;
tmp_mismatch_dx_genotyped_keep_ = tmp_mismatch_d1_genotyped_keep_ & tmp_mismatch_d2_genotyped_keep_ ;
tmp_mismatch_dx_imputed_swap_ = tmp_mismatch_d1_imputed_swap_ & tmp_mismatch_d2_imputed_swap_ ;
tmp_mismatch_dx_genotyped_swap_ = tmp_mismatch_d1_genotyped_swap_ & tmp_mismatch_d2_genotyped_swap_ ;
tmp_mismatch_dx_imputed_miss_ = tmp_mismatch_d1_imputed_swap_ & tmp_mismatch_d2_imputed_keep_ ;
tmp_mismatch_dx_genotyped_miss_ = tmp_mismatch_d1_genotyped_swap_ & tmp_mismatch_d2_genotyped_keep_ ;
...
assert(sum( tmp_mismatch_dx_genotyped_keep_ & tmp_mismatch_dx_genotyped_swap_ )==0);
assert(sum( tmp_mismatch_dx_genotyped_keep_ & tmp_mismatch_dx_genotyped_miss_ )==0);
assert(sum( tmp_mismatch_dx_genotyped_swap_ & tmp_mismatch_dx_genotyped_miss_ )==0);
disp(sprintf(' %% imputed: keep %d swap %d miss %d; genotyped: keep %d swap %d miss %d'...
,sum(tmp_mismatch_dx_imputed_keep_),sum(tmp_mismatch_dx_imputed_swap_),sum(tmp_mismatch_dx_imputed_miss_)...
,sum(tmp_mismatch_dx_genotyped_keep_),sum(tmp_mismatch_dx_genotyped_swap_),sum(tmp_mismatch_dx_genotyped_miss_)...
	     ));
%%%%%%%%;

tmp_imputed_AnV_arm2_ = zeros(length(fu2_),2);
tmp_genotyped_AnV_arm2_ = zeros(length(fu2_),2);
for nhu2=1:length(hu2_);
tmp_fu2_ = find(sum(fu2_by_hu2_xref_(:,nhu2),2));
if (length(tmp_fu2_)>1); disp(sprintf(' %% Warning! tmp_fu2_ length %d in lisa_dosage_pca_ver7',length(tmp_fu2_))); end;
nfu2 = tmp_fu2_(1);
...
ng1d = tmp_g1d_(1);
assert(strcmp(fu2_{nfu2},g1d_{ng1d}));
tmp_imputed_AnV_arm2_(nfu2,:) = tmp_dosage_imputed_AnV_(ng1d,:);
tmp_genotyped_AnV_arm2_(nfu2,:) = tmp_dosage_genotyped_AnV_(ng1d,:);
end;%for nhu2=1:length(hu2_);
...
tmp_genotyped_DnV_arm2_ = zeros(length(fu2_),2); tmp_Dij_ = find(mr_D_arm2_); tmp_genotyped_DnV_arm2_(tmp_Dij_,:) = tmp_genotyped_AnV_arm2_(tmp_Dij_,:);
tmp_genotyped_XnV_arm2_ = zeros(length(fu2_),2); tmp_Xij_ = find(mr_X_arm2_); tmp_genotyped_XnV_arm2_(tmp_Xij_,:) = tmp_genotyped_AnV_arm2_(tmp_Xij_,:);
...
plot(DnV_rx_tstx_arm2_(tmp_Dij_,1),tmp_genotyped_DnV_arm2_(tmp_Dij_,1),'rx'); ylim([-5,5]);
title('D 1');
...
plot(XnV_rx_tstx_arm2_(tmp_Xij_,1),tmp_genotyped_XnV_arm2_(tmp_Xij_,1),'rx'); ylim([-5,5]);
title('X 1');
subplot(2,2,3); hold on;
tmp_Dij_ = intersect(g1d_to_fu2_,find(mr_D_arm2_));
plot(DnV_rx_tstx_arm2_(tmp_Dij_,2),tmp_imputed_DnV_arm2_(tmp_Dij_,2),'bo'); ylim([-5,5]);
plot(DnV_rx_tstx_arm2_(tmp_Dij_,2),tmp_genotyped_DnV_arm2_(tmp_Dij_,2),'rx'); ylim([-5,5]);
title('D 2');
subplot(2,2,4); hold on;
tmp_Xij_ = intersect(g1d_to_fu2_,find(mr_X_arm2_));
plot(XnV_rx_tstx_arm2_(tmp_Xij_,2),tmp_imputed_XnV_arm2_(tmp_Xij_,2),'bo'); ylim([-5,5]);
plot(XnV_rx_tstx_arm2_(tmp_Xij_,2),tmp_genotyped_XnV_arm2_(tmp_Xij_,2),'rx'); ylim([-5,5]);
title('X 2'); hold on;
end;%if flag_plot;
...
dosage_genotyped_DnV_arm2__{nstudy_arm2} = tmp_genotyped_DnV_arm2_ ;
dosage_genotyped_XnV_arm2__{nstudy_arm2} = tmp_genotyped_XnV_arm2_ ;
dosage_genotyped_DnV_arm2_ = dosage_genotyped_DnV_arm2_ + tmp_genotyped_DnV_arm2_ ;
dosage_genotyped_XnV_arm2_ = dosage_genotyped_XnV_arm2_ + tmp_genotyped_XnV_arm2_ ;
...
save(fname_stage_1,...
     ...
     ,'dosage_genotyped_DnV_arm2__','dosage_genotyped_XnV_arm2__','dosage_genotyped_DnV_arm2_','dosage_genotyped_XnV_arm2_'...
     ,'mismatch_d1_imputed__','mismatch_d1_genotyped__');
