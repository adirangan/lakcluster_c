function xxxcluster_PGC_uADZSZDA_ver13(dir_code,dir_trunk,string_prefix,maf_lo_threshold,maf_hi_threshold,mc_string,flag_dex_vs_lak,flag_reverse,Icat,n_mds,mds_used_,mds_repl,gamma,B_MLT,Ireq,n_scramble,scramble_out_xdrop_,scramble_rseed_,nshuffle,flag_rerun,pbs_walltime,slurm_walltime,slurm_nnodes,slurm_tpn,slurm_memdecl,row_factor,col_factor,flag_verbose)
% set up to allow pbs_walltime as input ; using lakcluster_ver18 ; no replication ; reverse-search ;
% run with: xxxcluster_PGC_uADZSZDA_ver13_dr.m;
...
if (nshuffle>0 & n_scramble>0); disp(sprintf(' %% Warning! n_scramble %d nshuffle %d in xxxcluster_PGC_uADZSZDA_ver13. Not yet implemented appropriately!',n_scramble,nshuffle)); end;
...
string_name_s0000 = sprintf('%s_%s',string_prefix,xxxcluster_PGC_uADZSZDA_xfix_ver13(flag_dex_vs_lak,maf_lo_threshold,maf_hi_threshold,mc_string,flag_reverse,n_mds,mds_used_,mds_repl,gamma,B_MLT,Ireq,n_scramble,0));
...
string_name = sprintf('%s_%s',string_prefix,xxxcluster_PGC_uADZSZDA_xfix_ver13(flag_dex_vs_lak,maf_lo_threshold,maf_hi_threshold,mc_string,flag_reverse,n_mds,mds_used_,mds_repl,gamma,B_MLT,Ireq,n_scramble,nshuffle));
name_suffix = sprintf('%s','analyze');
...
if (flag_error); disp(sprintf(' %% Warning! incorrect dimensions in xxxcluster_PGC_uADZSZDA_ver13')); return; end;
...
fprintf(fp,'END= 0;\n');
fprintf(fp,'%% generated by xxxcluster_PGC_uADZSZDA_ver13.m on %s;\n',date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ;
fclose(fp);
type(fname__in);
