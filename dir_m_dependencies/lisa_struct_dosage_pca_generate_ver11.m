function lisa_struct_dosage_pca_generate_ver11(specification) ;
...
%{
  ...
  lisa_struct_dosage_pca_generate_ver11(specification) ;
...
if (~exist(tmp_dir_pca,'dir')); disp(sprintf(' %% Warning! %s does not exist in lisa_struct_dosage_pca_generate_ver11.m ',tmp_dir_pca)); end;
...
if nstudy_arm2==2; fname_dosage = sprintf('%s/%s_test1.dosage','/data/rangan/dir_bcc/dir_PGC_20190328/dir_icuk_bicluster_test',study_name_arm2_prefix); end;
end;%if flag_lisa==0;
fcheck(fname_dosage);
