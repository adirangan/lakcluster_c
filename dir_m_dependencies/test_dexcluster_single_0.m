function test_dexcluster_single_0(M,N,gamma,X,mu,n_rank,n_iteration,n_shuffle,flag_rerun);
%{
  ...
  test_dexcluster_single_0(M,N,gamma,X,mu,n_rank,n_iteration,n_shuffle,flag_rerun);
