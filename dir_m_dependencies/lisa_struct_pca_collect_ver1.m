function [lisa_arm1,lisa_arm2] = lisa_struct_pca_collect_ver1(specification) ;
%{
 ...
 %try: ;
  ...
  for n_maf = 1; %for n_maf = [1,6,4,5];%for n_maf = [1,6,4,5]; %<-- minor-allele-frequency cutoff 25-50 ;
  ...
  lisa_struct_pca_collect_ver1(specification) ;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
fname_pca_mat = sprintf('%s/%s_pca_collect_ver1_trn%d%s_tst%d%s.mat',lisa_arm1.dir_out_s0_pca,lisa_arm1.string_name_s0,cl_num_arm1,cl_num_arm1_string,cl_num_arm2,cl_num_arm2_string); 
...
fname_pca_jpg = sprintf('%s/%s_pca_collect_ver1_trn%d%s_tst%d%s.jpg',lisa_arm1.dir_out_s0_pca_jpg,lisa_arm1.string_name_s0,cl_num_arm1,cl_num_arm1_string,cl_num_arm2,cl_num_arm2_string); 
if (~exist(fname_pca_jpg,'file')); disp(sprintf(' %% creating %s',fname_pca_jpg)); print('-djpeg',fname_pca_jpg); end;%if ~exist;
fname_pca_eps = sprintf('%s/%s_pca_collect_ver1_trn%d%s_tst%d%s.eps',lisa_arm1.dir_out_s0_pca_jpg,lisa_arm1.string_name_s0,cl_num_arm1,cl_num_arm1_string,cl_num_arm2,cl_num_arm2_string); 
...
title(sprintf('%s trn%d tst %d (%s)',lisa_arm1.string_name_s0,cl_num_arm1,cl_num_arm2,lisa_arm2.study_name_{nstudy}),'interpreter','none');
set(gcf,'Position',1+[0,0,512,512]);
fname_pca_jpg = sprintf('%s/%s_pca_collect_ver1_trn%d%s_tst%d%s_xs%d.jpg',lisa_arm1.dir_out_s0_pca_jpg,lisa_arm1.string_name_s0,cl_num_arm1,cl_num_arm1_string,cl_num_arm2,cl_num_arm2_string,nstudy); 
if (0 || ~exist(fname_pca_jpg,'file')); disp(sprintf(' %% creating %s',fname_pca_jpg)); print('-djpeg',fname_pca_jpg); end;%if ~exist;
fname_pca_eps = sprintf('%s/%s_pca_collect_ver1_trn%d%s_tst%d%s_xs%d.eps',lisa_arm1.dir_out_s0_pca_jpg,lisa_arm1.string_name_s0,cl_num_arm1,cl_num_arm1_string,cl_num_arm2,cl_num_arm2_string,nstudy); 
