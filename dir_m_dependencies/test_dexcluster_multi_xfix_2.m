function str_xfix = test_dexcluster_multi_xfix_2(prefix,M,N,snr,n_cluster,gamma,niteration);
...
str_xfix =  sprintf('%s%s%s%s%s%s%s',prefix,str_M,str_N,str_snr,str_n_cluster,str_g,str_ni);
