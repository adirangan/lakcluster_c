function lisa_xdropplot_initialize_ver3(str_input,mc_string,cl_num,cl_num_arm2,flag_dex_vs_lak,gamma,B_MLT,n_mds,flag_reverse,n_maf,n_cov,n_scramble,n_shuffle) ;
%{

  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ;
  % check for lak / dex ;
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ;
  str_input = 'checktrace'; B_MLT = 34; n_mds = 20; n_scramble = 0; n_shuffle = 128;
  for flag_dex_vs_lak = {'dex'}; %for flag_dex_vs_lak = {'dex','lak'};
  %if (strcmp(flag_dex_vs_lak{1},'dex')); gamma = 0.004; mc_string = ''; end; if (strcmp(flag_dex_vs_lak{1},'lak')); gamma = 0.001; mc_string = 'm20_p85'; end;
  if (strcmp(flag_dex_vs_lak{1},'dex')); gamma = 0.004; mc_string = ''; end; if (strcmp(flag_dex_vs_lak{1},'lak')); gamma = 0.001; mc_string = ''; end;
  for flag_reverse = [0:1]; %for flag_reverse = [0:1]; 
  for cl_num = 1:4; %for cl_num = 1:4; 
  cl_num_arm2 = []; 
  for n_maf = [5]; %for n_maf = 1:5; 
  for n_cov = 2; %for n_cov = 0:2; 
  lisa_xdropplot_initialize_ver3(str_input,mc_string,cl_num,cl_num_arm2,flag_dex_vs_lak{1},gamma,B_MLT,n_mds,flag_reverse,n_maf,n_cov,n_scramble,n_shuffle) ;
  end;%for n_cov = 0:5; 
  end;%for n_maf = 1:5; 
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ;
  str_input = 'figplot'; B_MLT = 34; n_mds = 20; n_scramble = 0; n_shuffle = 128;
  ...
  for n_maf = 5; %for n_maf = 1:5; 
  for n_cov = 2; 
  lisa_xdropplot_initialize_ver3(str_input,mc_string,cl_num,cl_num_arm2,flag_dex_vs_lak,gamma,B_MLT,n_mds,flag_reverse,n_maf,n_cov,n_scramble,n_shuffle) ;
  close all;
  end;%for n_cov = 0:2; 
  end;%for n_maf = 1:5; 
  end;%for cl_num = 1:4; 
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ;
  str_input = 'pcaplot'; B_MLT = 34; n_mds = 20; n_scramble = 0; n_shuffle = 1;
  flag_dex_vs_lak = 'dex'; 
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
  str_input = 'pcaplot'; B_MLT = 34; n_mds = 20; n_shuffle = 128;
  flag_dex_vs_lak = 'dex'; 
  if (strcmp(flag_dex_vs_lak,'dex')); gamma = 0.004; mc_string = ''; end; if (strcmp(flag_dex_vs_lak,'lak')); gamma = 0.001; mc_string = 'm20_p85'; end;
  ...
  str_input = 'figplot'; B_MLT = 34; n_mds = 20; n_scramble = 0; n_shuffle = 128;
  flag_dex_vs_lak = 'lak'; 
  if (strcmp(flag_dex_vs_lak,'dex')); gamma = 0.004; mc_string = ''; end; if (strcmp(flag_dex_vs_lak,'lak')); gamma = 0.001; mc_string = 'm20_p85'; mc_string = ''; end;
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
  str_input = 'pcaplot'; B_MLT = 34; n_mds = 20; n_scramble = 0; n_shuffle = 128;
  flag_dex_vs_lak = 'lak'; 
  if (strcmp(flag_dex_vs_lak,'dex')); gamma = 0.004; mc_string = ''; end; if (strcmp(flag_dex_vs_lak,'lak')); gamma = 0.001; mc_string = 'm20_p85'; end;
  for flag_reverse = 0:1;%for flag_reverse = 0:1;
  cl_num = 4; 
  ...
  % clean ;
  %%%%%%%%%%%%%%%%;
  str_input = 'clean'; gamma = 0.004; B_MLT = 34; n_mds = 20; n_scramble = 0; n_shuffle = 128;
  ...
  for n_maf = 1:5;
  for n_cov = 1:5; 
  lisa_xdropplot_initialize_ver3(str_input,mc_string,cl_num,[],flag_dex_vs_lak{1},gamma,B_MLT,n_mds,flag_reverse,n_maf,n_cov,n_scramble,n_shuffle) ;
  end;%for n_cov = 1:5; 
  end;%for n_maf = 1:5;
  end;%for cl_num = 1:4;
  end;%for flag_reverse = 0:1;
...
if (nargin<ni); n_shuffle = 128; end; ni=ni+1;
...
lisa_xdropplot_checktrace_ver3;
...
lisa_mxcheck_ver2 ;
lisa_studyindex_ver3 ;
lisa_traceextract_ver2 ;
lisa_BDextract_ver2 ;
lisa_xdropplot_figplot_ver1;
