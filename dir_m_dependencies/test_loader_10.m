...
n_iteration = 128;
%%%%%%%%;
if flag_I; [AB_I_] = test_loader_helper_0(n_iteration,n_CLabel,n_CCOV,n_I_GENE,C_Label_,C_rank_,I_rank_,zeta_I_un_,zeta_I_vn_,n_zeta_I,beta_I_un_,beta_I_vn_,n_beta_I); end;%if flag_I;
if flag_E; [AB_E_] = test_loader_helper_0(n_iteration,n_CLabel,n_CCOV,n_E_GENE,C_Label_,C_rank_,E_rank_,zeta_E_un_,zeta_E_vn_,n_zeta_E,beta_E_un_,beta_E_vn_,n_beta_E); end;%if flag_E;
if flag_I; [AB_I_] = test_loader_helper_sub_0(AB_I_,C_Label_); end;
if flag_E; [AB_E_] = test_loader_helper_sub_0(AB_E_,C_Label_); end;
%%%%%%%%;
