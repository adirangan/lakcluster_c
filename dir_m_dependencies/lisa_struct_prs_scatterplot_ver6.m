function lisa = lisa_struct_prs_scatterplot_ver6(specification);
...
%{
  ...
  for prs_suffix = [263];%for prs_suffix = [0,150,163,175,188,200,213,225,238,250,263,275,288,300,313,325];
  ...
  lisa_struct_prs_scatterplot_ver6(specification) ;
...
if (~exist(lisa_arm1_r0.dir_out_s0_pca,'dir')); disp(sprintf(' %% Warning! %s does not exist in lisa_struct_prs_scatterplot_ver6',lisa_arm1_r0.dir_out_s0_pca)); end;
...
if (~exist(lisa_arm1_r1.dir_out_s0_pca,'dir')); disp(sprintf(' %% Warning! %s does not exist in lisa_struct_prs_scatterplot_ver6',lisa_arm1_r1.dir_out_s0_pca)); end;
...
%%%%%%%%%%%%%%%%;
fname_mat = sprintf('%s/prs_scatterplot_ver6_%s_trn%d%s_tst%d%s_pval.mat',lisa_arm1_r0.dir_out_s0_prs_mat,prs_prefix,cl_num_arm1,cl_num_arm1_string,cl_num_arm2,cl_num_arm2_string);
...
%%%%%%%%;
fname_mat = sprintf('%s/prs_scatterplot_ver6_%s_trn%d%s_tst%d%s_ni%.3d_ni%.3d.mat',lisa_arm1_r0.dir_out_s0_prs_mat,prs_prefix,cl_num_arm1,cl_num_arm1_string,cl_num_arm2,cl_num_arm2_string,ni_r0_arm2,ni_r1_arm2);
if ( flag_rerun==0 &  exist(fname_mat,'file')); 
disp(sprintf(' %% found %s, loading',fname_mat));
load(fname_mat,...
     'auc19_prs_t_',...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
fname_fig = sprintf('%s/prs_scatterplot_ver6_%s_trn%d%s_tst%d%s_ni%.3d_ni%.3d.jpg',lisa_arm1_r0.dir_out_s0_prs_jpg,prs_prefix,cl_num_arm1,cl_num_arm1_string,cl_num_arm2,cl_num_arm2_string,ni_r0_arm2,ni_r1_arm2);
