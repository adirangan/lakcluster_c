...
E_array_ = E_array_ - median(E_array_,1); %<-- normalize
%E_array_ = E_array_ - mean(E_array_,1); tmp_ = sum(E_array_>0); [~,tmp_ij_] = sort(tmp_,'ascend'); E_array_ = E_array_(:,tmp_ij_);
...
%%%%%%%%;
gamma = 0.01;
[out_xdrop_E_0_,trace_E_0_] = dexcluster_nonbinary_AAAA_ver0(E_array_,gamma);
rdrop_E_0_ = 1+out_xdrop_E_0_(find(out_xdrop_E_0_(:,1)>-1),1); rkeep_E_0_ = rdrop_E_0_(end:-1:1);
cdrop_E_0_ = 1+out_xdrop_E_0_(find(out_xdrop_E_0_(:,2)>-1),2); ckeep_E_0_ = cdrop_E_0_(end:-1:1);
figure;clf;colormap(colormap_beach()); imagesc(E_array_(rkeep_E_0_,ckeep_E_0_)); colorbar; title('dexcluster');
%%%%%%%%;
[tmp_U_,tmp_S_,tmp_V_] = svds(E_array_,1); 
[~,tmp_U_ij_] = sort(abs(tmp_U_),'descend'); [~,tmp_V_ij_] = sort(abs(tmp_V_),'descend');
%[~,tmp_U_ij_] = sort((tmp_U_),'descend'); [~,tmp_V_ij_] = sort((tmp_V_),'descend');
figure;clf;colormap(colormap_beach()); imagesc(E_array_(tmp_U_ij_,tmp_V_ij_)); colorbar; title('spectral');
...
%%%%%%%%;
gamma = 0.01;
[out_xdrop_I_0_,trace_I_0_] = dexcluster_nonbinary_AAAA_ver0(I_array_,gamma);
rdrop_I_0_ = 1+out_xdrop_I_0_(find(out_xdrop_I_0_(:,1)>-1),1); rkeep_I_0_ = rdrop_I_0_(end:-1:1);
cdrop_I_0_ = 1+out_xdrop_I_0_(find(out_xdrop_I_0_(:,2)>-1),2); ckeep_I_0_ = cdrop_I_0_(end:-1:1);
figure;clf;colormap(colormap_beach()); imagesc(I_array_(rkeep_I_0_,ckeep_I_0_)); colorbar; title('dexcluster');
%%%%%%%%;
[tmp_U_,tmp_S_,tmp_V_] = svds(I_array_,1); 
[~,tmp_U_ij_] = sort(abs(tmp_U_),'descend'); [~,tmp_V_ij_] = sort(abs(tmp_V_),'descend');
%[~,tmp_U_ij_] = sort((tmp_U_),'descend'); [~,tmp_V_ij_] = sort((tmp_V_),'descend');
figure;clf;colormap(colormap_beach()); imagesc(I_array_(tmp_U_ij_,tmp_V_ij_)); colorbar; title('spectral');
...
%%%%%%%%;
gamma = 0.01;
[out_xdrop_X_0_,trace_X_0_] = dexcluster_nonbinary_AAAA_ver0(X_array_,gamma);
rdrop_X_0_ = 1+out_xdrop_X_0_(find(out_xdrop_X_0_(:,1)>-1),1); rkeep_X_0_ = rdrop_X_0_(end:-1:1);
cdrop_X_0_ = 1+out_xdrop_X_0_(find(out_xdrop_X_0_(:,2)>-1),2); ckeep_X_0_ = cdrop_X_0_(end:-1:1);
figure;clf;colormap(colormap_beach()); imagesc(X_array_(rkeep_X_0_,ckeep_X_0_)); colorbar; title('dexcluster');
%%%%%%%%;
[tmp_U_,tmp_S_,tmp_V_] = svds(X_array_,1); 
[~,tmp_U_ij_] = sort(abs(tmp_U_),'descend'); [~,tmp_V_ij_] = sort(abs(tmp_V_),'descend');
%[~,tmp_U_ij_] = sort((tmp_U_),'descend'); [~,tmp_V_ij_] = sort((tmp_V_),'descend');
figure;clf;colormap(colormap_beach()); imagesc(X_array_(tmp_U_ij_,tmp_V_ij_)); colorbar; title('spectral');
