function dolphin_d00_cmb_6_collect();
%{
...
fname_infix_0050 = sprintf('aid%.2d_age%.2d%.2d_d%dc%dC%d_cmb',dXX, 0,50,flag_drift0,flag_center,flag_constrain_CC);
fname_infix_5099 = sprintf('aid%.2d_age%.2d%.2d_d%dc%dC%d_cmb',dXX,50,99,flag_drift0,flag_center,flag_constrain_CC);
...
a_0050_o_ = tmp_.a_cmb_;
A_0050_o__ = tmp_.A_cmb__;
BB_0050_o__ = tmp_.BB_cmb__;
CC_0050_o__ = tmp_.CC_cmb__;
...
n_found_0050 = size(tmp_.L_cmb_prm_,1);
a_avg_0050_ = mean(tmp_.a_cmb_prm__(:,2:end),2); a_std_0050_ = std(tmp_.a_cmb_prm__(:,2:end),1,2);
A_avg_0050__ = mean(tmp_.A_cmb_prm___(:,:,2:end),3); A_std_0050__ = std(tmp_.A_cmb_prm___(:,:,2:end),1,3);
BB_avg_0050__ = mean(tmp_.BB_cmb_prm___(:,:,2:end),3); BB_std_0050__ = std(tmp_.BB_cmb_prm___(:,:,2:end),1,3);
CC_avg_0050__ = mean(tmp_.CC_cmb_prm___(:,:,2:end),3); CC_std_0050__ = std(tmp_.CC_cmb_prm___(:,:,2:end),1,3);
end;%if ( exist(fname_mat_0050_s,'file'));
...
a_5099_o_ = tmp_.a_cmb_;
A_5099_o__ = tmp_.A_cmb__;
BB_5099_o__ = tmp_.BB_cmb__;
CC_5099_o__ = tmp_.CC_cmb__;
...
n_found_5099 = size(tmp_.L_cmb_prm_,1);
a_avg_5099_ = mean(tmp_.a_cmb_prm__(:,2:end),2); a_std_5099_ = std(tmp_.a_cmb_prm__(:,2:end),1,2);
A_avg_5099__ = mean(tmp_.A_cmb_prm___(:,:,2:end),3); A_std_5099__ = std(tmp_.A_cmb_prm___(:,:,2:end),1,3);
BB_avg_5099__ = mean(tmp_.BB_cmb_prm___(:,:,2:end),3); BB_std_5099__ = std(tmp_.BB_cmb_prm___(:,:,2:end),1,3);
CC_avg_5099__ = mean(tmp_.CC_cmb_prm___(:,:,2:end),3); CC_std_5099__ = std(tmp_.CC_cmb_prm___(:,:,2:end),1,3);
end;%if ( exist(fname_mat_5099_s,'file'));
...
fname_infix_5099_vs_0050 = sprintf('aid%.2d_age_5099_vs_0050_d%dc%dC%d_cmb',dXX,flag_drift0,flag_center,flag_constrain_CC);
...
n_found_5099_vs_0050 = min(numel(tmp_5099_.L_cmb_prm_),numel(tmp_0050_.L_cmb_prm_)) - 1;
a_avg_5099_vs_0050_ = mean(tmp_5099_.a_cmb_prm__(:,2:end) - tmp_0050_.a_cmb_prm__(:,2:end),2);
a_std_5099_vs_0050_ = std(tmp_5099_.a_cmb_prm__(:,2:end) - tmp_0050_.a_cmb_prm__(:,2:end),1,2);
A_avg_5099_vs_0050__ = mean(tmp_5099_.A_cmb_prm___(:,:,2:end) - tmp_0050_.A_cmb_prm___(:,:,2:end),3);
A_std_5099_vs_0050__ = std(tmp_5099_.A_cmb_prm___(:,:,2:end) - tmp_0050_.A_cmb_prm___(:,:,2:end),1,3);
BB_avg_5099_vs_0050__ = mean(tmp_5099_.BB_cmb_prm___(:,:,2:end) - tmp_0050_.BB_cmb_prm___(:,:,2:end),3);
BB_std_5099_vs_0050__ = std(tmp_5099_.BB_cmb_prm___(:,:,2:end) - tmp_0050_.BB_cmb_prm___(:,:,2:end),1,3);
CC_avg_5099_vs_0050__ = mean(tmp_5099_.CC_cmb_prm___(:,:,2:end) - tmp_0050_.CC_cmb_prm___(:,:,2:end),3);
CC_std_5099_vs_0050__ = std(tmp_5099_.CC_cmb_prm___(:,:,2:end) - tmp_0050_.CC_cmb_prm___(:,:,2:end),1,3);
...
fname_fig = sprintf('%s/dolphin_%s_shuffle_AB2_FIGAB2',dir_jpg,fname_infix_5099_vs_0050);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig)); figure(1);
figure(1);clf;figbig;fontsize_use = 12;
c_beach__ = colormap_beach(); n_c_beach = size(c_beach__,1);
...
np = 1;
%%%%%%%%;
subplot_(1,1) = subplot(1,2,np);np=np+1; imagesc(A_sbnlp_5099_vs_0050__,c_nlpvt2_lim_); axis image;
set(gca,'YTick',1:n_var,'YTickLabel',string_dat_name_);
set(gca,'XTick',1:n_var,'XTickLabel',string_dat_name_); xtickangle(90);
...
colorbar();
%%%%%%%%;
subplot_(1,2) = subplot(1,2,np);np=np+1; imagesc(BB_sbnlp_5099_vs_0050__,c_nlpvt2_lim_); axis image;
set(gca,'YTick',1:n_var,'YTickLabel',string_dat_name_);
set(gca,'XTick',1:n_var,'XTickLabel',string_dat_name_); xtickangle(90);
...
fname_fig = sprintf('%s/dolphin_%s_shuffle_A_FIGA',dir_jpg,fname_infix_5099_vs_0050);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig)); figure(1);
figure(1);clf;figbig;set(gcf,'Position',1+[0,0,1024,1024]);fontsize_use = 12;
c_beach__ = colormap_beach(); n_c_beach = size(c_beach__,1);
...
np = 1;
%%%%%%%%;
subplot_(1,1) = subplot(1,1,np);np=np+1; imagesc(A_sbnlp_5099_vs_0050__,c_nlpvt2_lim_); axis image;
set(gca,'YTick',1:n_var,'YTickLabel',string_dat_name_);
set(gca,'XTick',1:n_var,'XTickLabel',string_dat_name_); xtickangle(90);
xlabel('source'); ylabel('target'); title('signed A_nlp_5099_vs_0050__ (bonferroni)','Interpreter','none');
set(gca,'TickLength',[0,0]); set(gca,'fontsize',fontsize_use);
...
fname_fig = sprintf('%s/dolphin_%s_shuffle_B_FIGB',dir_jpg,fname_infix_5099_vs_0050);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig)); figure(1);
figure(1);clf;figbig;set(gcf,'Position',1+[0,0,1024,1024]);fontsize_use = 12;
c_beach__ = colormap_beach(); n_c_beach = size(c_beach__,1);
...
np = 1;
%%%%%%%%;
subplot_(1,1) = subplot(1,1,np);np=np+1; imagesc(BB_sbnlp_5099_vs_0050__,c_nlpvt2_lim_); axis image;
set(gca,'YTick',1:n_var,'YTickLabel',string_dat_name_);
set(gca,'XTick',1:n_var,'XTickLabel',string_dat_name_); xtickangle(90);
xlabel('source'); ylabel('target'); title('signed BB_nlp_5099_vs_0050__ (bonferroni)','Interpreter','none');
set(gca,'TickLength',[0,0]); set(gca,'fontsize',fontsize_use);
