...
if (nargin<1);
%%%%%%%%;
disp(sprintf(' %% testing halfloop_nonbinary_recursive_gateway_c_1'));
...
if (verbose); disp(sprintf(' %% [entering halfloop_nonbinary_recursive_gateway_c_1]')); end;
...
fprintf(fp,'GLOBAL_flag_r0drop_vs_rcdrop= %d;\n',flag_r0drop_vs_rcdrop);
...
if (verbose); disp(sprintf(' %% [finished halfloop_nonbinary_recursive_gateway_c_1]')); end;
