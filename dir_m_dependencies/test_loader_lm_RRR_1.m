function [xeta_] = test_loader_lm_RRR_1(C_rank_,E_,I_,n_rank,dir_trunk,infix,flag_load);
%%%%%%%%;
...
if (nargin<7); if (exist(fname_beta,'file') & exist(fname_zeta,'file')); flag_load=1; else flag_load=0; end; end;
...
save(fname_beta,'beta_E_un_','beta_E_vn_','n_beta_E','beta_I_un_','beta_I_vn_','n_beta_I','beta_EI_un_','beta_EI_vn_','n_beta_EI');
save(fname_zeta,'zeta_E_un_','zeta_E_vn_','n_zeta_E','zeta_I_un_','zeta_I_vn_','n_zeta_I','zeta_EI_un_','zeta_EI_vn_','n_zeta_EI');
%%%%%%%%;
if flag_E;
