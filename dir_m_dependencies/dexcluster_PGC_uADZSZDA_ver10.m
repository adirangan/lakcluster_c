function dexcluster_PGC_uADZSZDA_ver10(dir_code,dir_trunk,string_prefix,maf_lo_threshold,maf_hi_threshold,flag_reverse,Icat,n_mds,mds_used_,mds_repl,gamma,B_MLT,Ireq,nshuffle,flag_rerun,pbs_walltime,slurm_walltime,slurm_nnodes,slurm_tpn,slurm_memdecl,row_factor,col_factor,flag_verbose)
% set up to allow pbs_walltime as input ; using lakcluster_ver18 ; no replication ; reverse-search ;
% try: ;
%{

  scp -rp rangan@access1.cims.nyu.edu:/data/rangan/dir_bcc/dir_lakcluster_c_dev/?* /scratch/avr209/dir_lakcluster_c_dev/ ;
  scp -p rangan@access1.cims.nyu.edu:/data/rangan/dir_bcc/dir_PGC_20180304/PGC_cl?_maf01_analyze_20180402.tar.gz /scratch/avr209/dir_PGC_20180304/ ;
  scp -p rangan@access1.cims.nyu.edu:/data/rangan/dir_bcc/dir_PGC_20180304/dir_m/?*.m /scratch/avr209/dir_PGC_20180304/dir_m/ ;
  scp -p rangan@access1.cims.nyu.edu:/data/rangan/dir_bcc/dir_PGC_20180304/dir_m/dexcluster_PGC_uADZSZDA_ver10.m /scratch/avr209/dir_PGC_20180304/dir_m/ ;

  !scp -rp rangan@access1.cims.nyu.edu:/data/rangan/dir_bcc/dir_lakcluster_c_dev/?* /home/arangan/dir_lakcluster_c_dev/ ;
  !scp -rp rangan@access1.cims.nyu.edu:/data/rangan/dir_bcc/dir_lakcluster_c_dev/Makefile_lisa /home/arangan/dir_lakcluster_c_dev/ ;

  !scp -p rangan@access1.cims.nyu.edu:/data/rangan/dir_bcc/dir_PGC_20180304/dir_m/?*.m /home/arangan/dir_PGC_20180304/dir_m/ ;
  !scp -p rangan@access1.cims.nyu.edu:/data/rangan/dir_bcc/dir_PGC_20180304/dir_m/dexcluster_PGC_uADZSZDA_ver10.m /home/arangan/dir_PGC_20180304/dir_m/ ;
  !scp -p rangan@access1.cims.nyu.edu:/data/rangan/dir_bcc/dir_PGC_20180304/dir_m/dexcluster_PGC_uADZSZDA_excerpt_0.m /home/arangan/dir_PGC_20180304/dir_m/ ;
  !scp -p rangan@access1.cims.nyu.edu:/data/rangan/dir_bcc/dir_PGC_20180304/dir_m/xxxcluster_PGC_uADZSZDA_xfix_ver10.m /home/arangan/dir_PGC_20180304/dir_m/ ;
  !scp -p rangan@access1.cims.nyu.edu:/data/rangan/dir_bcc/dir_PGC_20180304/dir_m/xxxcluster_PGC_getbim_ver3.m /home/arangan/dir_PGC_20180304/dir_m/ ;
  !scp -p rangan@access1.cims.nyu.edu:/data/rangan/dir_bcc/dir_PGC_20180304/dir_m/xxxcluster_uADZSZDA_check_ver1.m /home/arangan/dir_PGC_20180304/dir_m/ ;
  !scp -p rangan@access1.cims.nyu.edu:/data/rangan/dir_bcc/dir_PGC_20180304/dir_m/xxxcluster_uADZSZDA_shuffle_ver2.m /home/arangan/dir_PGC_20180304/dir_m/ ;
  ...
  % check log.txt in dir_trunk. make sure that previous runs are not included! ;
  % run log.txt with sh log.txt.
...
string_name_s0000 = sprintf('%s_%s',string_prefix,xxxcluster_PGC_uADZSZDA_xfix_ver10('dex',maf_lo_threshold,maf_hi_threshold,flag_reverse,n_mds,mds_used_,mds_repl,gamma,B_MLT,Ireq,0));
...
string_name = sprintf('%s_%s',string_prefix,xxxcluster_PGC_uADZSZDA_xfix_ver10('dex',maf_lo_threshold,maf_hi_threshold,flag_reverse,n_mds,mds_used_,mds_repl,gamma,B_MLT,Ireq,nshuffle));
name_suffix = sprintf('%s','analyze');
...
if (flag_error); disp(sprintf(' %% Warning! incorrect dimensions in dexcluster_PGC_uADZSZDA_ver10')); return; end;
...
fprintf(fp,'END= 0;\n');
fprintf(fp,'%% generated by dexcluster_PGC_uADZSZDA_ver10.m on %s;\n',date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ;
fclose(fp);
type(fname__in);
