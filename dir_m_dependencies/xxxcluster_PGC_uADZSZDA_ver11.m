function xxxcluster_PGC_uADZSZDA_ver11(dir_code,dir_trunk,string_prefix,maf_lo_threshold,maf_hi_threshold,flag_dex_vs_lak,flag_reverse,Icat,n_mds,mds_used_,mds_repl,gamma,B_MLT,Ireq,nshuffle,flag_rerun,pbs_walltime,slurm_walltime,slurm_nnodes,slurm_tpn,slurm_memdecl,row_factor,col_factor,flag_verbose)
% set up to allow pbs_walltime as input ; using lakcluster_ver18 ; no replication ; reverse-search ;
% run with: xxxcluster_PGC_uADZSZDA_ver11_dr.m;
...
string_name_s0000 = sprintf('%s_%s',string_prefix,xxxcluster_PGC_uADZSZDA_xfix_ver10(flag_dex_vs_lak,maf_lo_threshold,maf_hi_threshold,flag_reverse,n_mds,mds_used_,mds_repl,gamma,B_MLT,Ireq,0));
...
string_name = sprintf('%s_%s',string_prefix,xxxcluster_PGC_uADZSZDA_xfix_ver10(flag_dex_vs_lak,maf_lo_threshold,maf_hi_threshold,flag_reverse,n_mds,mds_used_,mds_repl,gamma,B_MLT,Ireq,nshuffle));
name_suffix = sprintf('%s','analyze');
...
if (flag_error); disp(sprintf(' %% Warning! incorrect dimensions in xxxcluster_PGC_uADZSZDA_ver11')); return; end;
...
fprintf(fp,'END= 0;\n');
fprintf(fp,'%% generated by xxxcluster_PGC_uADZSZDA_ver11.m on %s;\n',date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ;
fclose(fp);
type(fname__in);
