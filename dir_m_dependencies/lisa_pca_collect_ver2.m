...
fname_pre = sprintf('%s/trace_collect',dir_out_s0000_pca_arm1);
print('-djpeg',sprintf('%s.jpg',fname_pre));
print('-depsc',sprintf('%s.eps',fname_pre));
end;%if (n_finished>2);

fname_mat = sprintf('%s/pca_collect.mat',dir_out_s0000_pca_arm1);
...
if (strcmp(flag_dex_vs_lak,'lak')); AnV_arm1_ = abs(AnV_arm1_); ZnV_arm1_ = abs(ZnV_arm1_); end;%if (strcmp(flag_dex_vs_lak,'lak'));
get_auc_arm1_(ni,cl_num_arm2) = get_auc(ZnV_arm1_(find(mr_Z_arm1_full),1),AnV_arm1_(find(mr_A_arm1_full),1));
...
logp_auc_arm1_(ni,cl_num_arm2) = logp_auc_0(get_auc_arm1_(ni,cl_num_arm2),min(sum(mr_A_arm1_full),sum(mr_Z_arm1_full)));
[beta0_arm1,dev0_arm1,stats0_arm1] = mnrfit([AnV_arm1_(find(mr_A_arm1_full),1) ; ZnV_arm1_(find(mr_Z_arm1_full),1)],[ones(sum(mr_A_arm1_full),1) ; 1 + ones(sum(mr_Z_arm1_full),1)]);
...
[beta2_arm1,dev2_arm1,stats2_arm1] = mnrfit([AnV_arm1_(find(mr_A_arm1_full),1) , mds_arm1_(find(mr_A_arm1_full),1:2) ; ZnV_arm1_(find(mr_Z_arm1_full),1) , mds_arm1_(find(mr_Z_arm1_full),1:2)],[ones(sum(mr_A_arm1_full),1) ; 1 + ones(sum(mr_Z_arm1_full),1)]);
...
corr_arm1_(ni,cl_num_arm2) = corr( [ZnV_arm1_(find(mr_Z_arm1_full),1) ; AnV_arm1_(find(mr_A_arm1_full),1)] , [zeros(sum(mr_Z_arm1_full),1) ; ones(sum(mr_A_arm1_full),1)]);
...
if (strcmp(flag_dex_vs_lak,'lak')); AnV_arm2_ = abs(AnV_arm2_); ZnV_arm2_ = abs(ZnV_arm2_); end;%if (strcmp(flag_dex_vs_lak,'lak'));
get_auc_arm2_(ni,cl_num_arm2) = get_auc(ZnV_arm2_(find(mr_Z_arm2_full),1),AnV_arm2_(find(mr_A_arm2_full),1));
...
logp_auc_arm2_(ni,cl_num_arm2) = logp_auc_0(get_auc_arm2_(ni,cl_num_arm2),min(sum(mr_A_arm2_full),sum(mr_Z_arm2_full)));
[beta0_arm2,dev0_arm2,stats0_arm2] = mnrfit([AnV_arm2_(find(mr_A_arm2_full),1) ; ZnV_arm2_(find(mr_Z_arm2_full),1)],[ones(sum(mr_A_arm2_full),1) ; 1 + ones(sum(mr_Z_arm2_full),1)]);
...
[beta2_arm2,dev2_arm2,stats2_arm2] = mnrfit([AnV_arm2_(find(mr_A_arm2_full),1) , mds_arm2_(find(mr_A_arm2_full),1:2) ; ZnV_arm2_(find(mr_Z_arm2_full),1) , mds_arm2_(find(mr_Z_arm2_full),1:2)],[ones(sum(mr_A_arm2_full),1) ; 1 + ones(sum(mr_Z_arm2_full),1)]);
...
corr_arm2_(ni,cl_num_arm2) = corr( [ZnV_arm2_(find(mr_Z_arm2_full),1) ; AnV_arm2_(find(mr_A_arm2_full),1)] , [zeros(sum(mr_Z_arm2_full),1) ; ones(sum(mr_A_arm2_full),1)]);
...
%%%%%%%%%%%%%%%%;
save(fname_mat,'n_cl','get_auc_arm1_','logp_auc_arm1_','corr_arm1_','beta0_arm1_','logp_beta0_arm1_','beta2_arm1_','logp_beta2_arm1_','flag_flip_','get_auc_arm2_','logp_auc_arm2_','corr_arm2_','beta0_arm2_','logp_beta0_arm2_','beta2_arm2_','logp_beta2_arm2_');
%%%%%%%%%%%%%%%%;
...
%%%%%%%%%%%%%%%%;
subplot(5,3,0*3 + cl_num_arm2 - (cl_num_arm2>=cl_num_arm1));hold on; plot(niteration_,get_auc_arm1_(:,cl_num_arm2),'rx-'); hold off;
xlabel('iteration'); ylabel('auc arm1'); xlim([min(niteration_),max(niteration_)]);
subplot(5,3,1*3 + cl_num_arm2 - (cl_num_arm2>=cl_num_arm1));hold on; plot(niteration_,min(lmax,-logp_auc_arm1_(:,cl_num_arm2)),'rx-'); hold off; ylim([0,lmax]);
...
hold on; plot(niteration_,beta0_arm1_(:,cl_num_arm2),'rx-'); hold off;
hold on; plot(niteration_,beta2_arm1_(:,cl_num_arm2),'rs-'); hold off;
...
hold on; plot(niteration_,min(lmax,-logp_beta0_arm1_(:,cl_num_arm2)),'rx-'); hold off; ylim([0,lmax]);
hold on; plot(niteration_,min(lmax,-logp_beta2_arm1_(:,cl_num_arm2)),'rs-'); hold off; ylim([0,lmax]);
xlabel('iteration'); ylabel('-logp beta arm1'); xlim([min(niteration_),max(niteration_)]);
subplot(5,3,4*3 + cl_num_arm2 - (cl_num_arm2>=cl_num_arm1));hold on; plot(niteration_,corr_arm1_(:,cl_num_arm2),'rx-'); hold off;
xlabel('iteration'); ylabel('corr arm1'); xlim([min(niteration_),max(niteration_)]);
%%%%%%%%%%%%%%%%;
subplot(5,3,0*3 + cl_num_arm2 - (cl_num_arm2>=cl_num_arm1));hold on; plot(niteration_,get_auc_arm2_(:,cl_num_arm2),'bo-'); hold off;
...
plot(niteration_,min(lmax,-logp_auc_arm2_(:,cl_num_arm2)),'bo-',niteration_,0*niteration_ + -log(0.05),'k:'); 
...
subplot(5,3,2*3 + cl_num_arm2 - (cl_num_arm2>=cl_num_arm1));
hold on; plot(niteration_,beta0_arm2_(:,cl_num_arm2),'bo-'); hold off;
hold on; plot(niteration_,beta2_arm2_(:,cl_num_arm2),'bs-'); hold off;
...
subplot(5,3,3*3 + cl_num_arm2 - (cl_num_arm2>=cl_num_arm1));
hold on; 
plot(niteration_,min(lmax,-logp_beta0_arm2_(:,cl_num_arm2)),'bo-'); 
plot(niteration_,min(lmax,-logp_beta2_arm2_(:,cl_num_arm2)),'bs-'); 
plot(niteration_,0*niteration_ + -log(0.05),'k--');
plot(niteration_,0*niteration_ + -log(0.01),'k--');
hold off; ylim([0,lmax]);
...
subplot(5,3,4*3 + cl_num_arm2 - (cl_num_arm2>=cl_num_arm1));hold on; plot(niteration_,corr_arm2_(:,cl_num_arm2),'bo-'); hold off;
...
fname_pre = sprintf('%s/pca_collect_ver2',dir_out_s0000_pca_arm1);
print('-djpeg',sprintf('%s.jpg',fname_pre));
print('-depsc',sprintf('%s.eps',fname_pre));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
