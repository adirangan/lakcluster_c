...
%%%%%%%%;
subplot(1,2,1);
legend_str_ = {'loop','pca1->isosplit5','pca2->isosplit5','pca3->isosplit5','pca4->isosplit5','pca5->isosplit5','pca6->isosplit5'};
hold on;
...
%%%%%%%%;
subplot(1,2,2);
legend_str_ = {'loop','tsne00->isosplit5','tsne50->isosplit5','umap00->default','umap00->isosplit5','umap00->hdbscan'};
hold on;
plot(snr_,-lpv_dexcluster_nonbinary_trace_ZRmax_(1,:),'ms-','LineWidth',2,'MarkerSize',Msize);
%plot(snr_,-lpv_spectral_kmeansK_(1,:),'gs-','LineWidth',2,'MarkerSize',Msize);
%plot(snr_,-lpv_spectral_kmeansK_(6,:),'gh-','LineWidth',2,'MarkerSize',Msize);
...
%%%%%%%%;
figbig;
str_fig = sprintf('%s/dir_jpg/test_dexcluster_multi_2_collect_M%d_N%d_n%d',dir_base,M,N,n_cluster);
