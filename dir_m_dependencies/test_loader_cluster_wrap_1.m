function test_loader_cluster_wrap_1(dir_trunk,label_A_,E_rank_,I_rank_,prefix_normalization,xeta_,n_rank_xeta_sub_);
%{
  % try: ;
  ...
  test_loader_cluster_wrap_1(dir_trunk,label_A_,E_rank_,I_rank_,prefix_normalization,[],[]);
  ...
  test_loader_cluster_wrap_1(dir_trunk,label_A_,E_rank_,I_rank_,prefix_normalization_{1},xeta_,n_rank_xeta_sub_);
  %%%%%%%%;
