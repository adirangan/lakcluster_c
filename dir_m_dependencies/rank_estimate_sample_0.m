function [rank_estimate_sample,s_B_nlp_,svd_sample__,eig_tw__,eig_B_,kta_opt__,h_x__,h_eig__,h_opt__] = rank_estimate_sample_0(A__,p_val_0in,n_shuffle);
...
[rank_estimate_sample,s_B_nlp_,svd_sample__,eig_B_,eig_tw__,kta_opt__,h_x__,h_eig__,h_opt__] = rank_estimate_sample_0(A__);
...
rng(1024*nshuffle); C__ = B__; for ncol=0:n_col-1; C__(:,1+ncol) = B__(randperm(n_row),1+ncol); end;
...
kta_opt_ = fminsearch(tw_nll,kta_wis_,optimset('MaxIter',1e3));
