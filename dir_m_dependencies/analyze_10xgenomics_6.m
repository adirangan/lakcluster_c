function analyze_10xgenomics_6(dir_data_infix);
%%%%%%%%;
% 
%%%%%%%%;
...
%%%%%%%%;
% loading local hnbr0tZRgumb and hnbrtZRgumb and hnbtZRgumb results. ;
%%%%%%%%;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
for str_local_method_ = {'hnbr0tZRgumb','hnbrtZRgumb'};%for str_local_method_ = {'hnbr0tZRgumb','hnbrtZRgumb','hnbtZRgumb'};
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
...
tmp_infix_hnb_0 = sprintf('hnbr0tZRgumb_r%d_r1',local_rank_estimate_B_logn_sg); 
