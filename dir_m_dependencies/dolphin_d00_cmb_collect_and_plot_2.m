...
dolphin_d00_cmb_collect_and_plot_2( ...
 parameter ...
 ,n_var ...
 ,string_dat_name_ ...
 ,dir_mat ...
...
verbose=1;
if (verbose); disp(sprintf(' %% [entering dolphin_d00_cmb_collect_and_plot_2]')); end;
...
% try: ;
% dolphin_dXX_load_7;
% parameter = []; n_var = n_var_ori; string_dat_name_ = string_dat_ori_name_; dir_mat = '/data/rangan/dir_bcc/dir_dolphin/dir_mat_ind_7'; dir_shuffle_mat = '/data/rangan/dir_bcc/dir_dolphin/dir_shuffle256_mat_ind_7'; dir_jpg = '/data/rangan/dir_bcc/dir_dolphin/dir_jpg_ind_7'; fname_infix_zzzz = 'aid00_cmb';
...
BB_inv_zzzz_o__ = tmp_.BB_inv_cmb__;
CC_inv_zzzz_o__ = tmp_.CC_inv_cmb__;
...
BB_inv_avg_zzzz__ = mean(tmp_.BB_inv_cmb_prm___(:,:,2:end),3); BB_inv_std_zzzz__ = std(tmp_.BB_inv_cmb_prm___(:,:,2:end),1,3);
CC_inv_avg_zzzz__ = mean(tmp_.CC_inv_cmb_prm___(:,:,2:end),3); CC_inv_std_zzzz__ = std(tmp_.CC_inv_cmb_prm___(:,:,2:end),1,3);
end;%if ( exist(fname_mat_zzzz_s,'file'));
...
n_retain = numel(index_retain_);
tmp_BB_inv_prm__ = reshape(tmp_.BB_inv_cmb_prm___,[n_var^2,n_shuffle+1]);
BB_inv_zzzz_prm__ = tmp_BB_inv_prm__(1+index_retain_,:);
...
colorbar();
%%%%%%%%;
subplot_(1,2) = subplot(1,2,np);np=np+1; imagesc(BB_inv_sbnlp_zzzz__,c_nlpvt2_lim_); axis image;
set(gca,'YTick',1:n_var,'YTickLabel',string_dat_name_);
set(gca,'XTick',1:n_var,'XTickLabel',string_dat_name_); xtickangle(90);
xlabel('source'); ylabel('target'); title('signed BB_inv_nlp_zzzz__ (bonferroni)','Interpreter','none');
set(gca,'TickLength',[0,0]); set(gca,'fontsize',fontsize_use);
hold on;
l_x_ = +0.5 + (n_var)*[zeros(1,n_var);ones(1,n_var)];
l_y_ = +0.5 + repmat([0:n_var-1],[2,1]);
...
np = 1;
%%%%%%%%;
subplot_(1,1) = subplot(1,1,np);np=np+1; imagesc(BB_inv_sbnlp_zzzz__,c_nlpvt2_lim_); axis image;
set(gca,'YTick',1:n_var,'YTickLabel',string_dat_name_);
set(gca,'XTick',1:n_var,'XTickLabel',string_dat_name_); xtickangle(90);
xlabel('source'); ylabel('target'); title('signed BB_inv_nlp_zzzz__ (bonferroni)','Interpreter','none');
set(gca,'TickLength',[0,0]); set(gca,'fontsize',fontsize_use);
...
np = 1;
%%%%%%%%;
subplot_(1,1) = subplot(1,1,np);np=np+1; imagesc(CC_inv_sbnlp_zzzz__,c_nlpvt2_lim_); axis image;
set(gca,'YTick',1:n_var,'YTickLabel',string_dat_name_);
set(gca,'XTick',1:n_var,'XTickLabel',string_dat_name_); xtickangle(90);
xlabel('source'); ylabel('target'); title('signed CC_inv_nlp_zzzz__ (bonferroni)','Interpreter','none');
set(gca,'TickLength',[0,0]); set(gca,'fontsize',fontsize_use);
hold on;
l_x_ = +0.5 + (n_var)*[zeros(1,n_var);ones(1,n_var)];
l_y_ = +0.5 + repmat([0:n_var-1],[2,1]);
...
np = 1;
%%%%%%%%;
subplot_(1,1) = subplot(2,3,np);np=np+1; imagesc(BB_inv_avg_zzzz__,c_beach_lim_); axis image;
set(gca,'YTick',1:n_var,'YTickLabel',string_dat_name_);
set(gca,'XTick',1:n_var,'XTickLabel',string_dat_name_); xtickangle(90);
xlabel('source'); ylabel('target'); title('BB_inv_avg_zzzz__','Interpreter','none');
set(gca,'TickLength',[0,0]); set(gca,'fontsize',fontsize_use);
colorbar();
subplot_(1,2) = subplot(2,3,np);np=np+1; imagesc(BB_inv_std_zzzz__,c_beach_lim_); axis image;
set(gca,'YTick',1:n_var,'YTickLabel',string_dat_name_);
set(gca,'XTick',1:n_var,'XTickLabel',string_dat_name_); xtickangle(90);
xlabel('source'); ylabel('target'); title('BB_inv_std_zzzz__','Interpreter','none');
set(gca,'TickLength',[0,0]); set(gca,'fontsize',fontsize_use);
colorbar();
subplot_(1,3) = subplot(2,3,np);np=np+1; imagesc(BB_inv_snlp_zzzz__,c_nlpvt2_lim_); axis image;
set(gca,'YTick',1:n_var,'YTickLabel',string_dat_name_);
set(gca,'XTick',1:n_var,'XTickLabel',string_dat_name_); xtickangle(90);
xlabel('source'); ylabel('target'); title('signed BB_inv_nlp_zzzz__','Interpreter','none');
set(gca,'TickLength',[0,0]); set(gca,'fontsize',fontsize_use);
colorbar();
%%%%%%%%;
subplot_(2,1) = subplot(2,3,np);np=np+1; imagesc(CC_inv_avg_zzzz__,c_beach_lim_); axis image;
set(gca,'YTick',1:n_var,'YTickLabel',string_dat_name_);
set(gca,'XTick',1:n_var,'XTickLabel',string_dat_name_); xtickangle(90);
xlabel('source'); ylabel('target'); title('CC_inv_avg_zzzz__','Interpreter','none');
set(gca,'TickLength',[0,0]); set(gca,'fontsize',fontsize_use);
colorbar();
subplot_(2,2) = subplot(2,3,np);np=np+1; imagesc(CC_inv_std_zzzz__,c_beach_lim_); axis image;
set(gca,'YTick',1:n_var,'YTickLabel',string_dat_name_);
set(gca,'XTick',1:n_var,'XTickLabel',string_dat_name_); xtickangle(90);
xlabel('source'); ylabel('target'); title('CC_inv_std_zzzz__','Interpreter','none');
set(gca,'TickLength',[0,0]); set(gca,'fontsize',fontsize_use);
colorbar();
subplot_(2,3) = subplot(2,3,np);np=np+1; imagesc(CC_inv_snlp_zzzz__,c_nlpvt2_lim_); axis image;
set(gca,'YTick',1:n_var,'YTickLabel',string_dat_name_);
set(gca,'XTick',1:n_var,'XTickLabel',string_dat_name_); xtickangle(90);
xlabel('source'); ylabel('target'); title('signed CC_inv_nlp_zzzz__','Interpreter','none');
set(gca,'TickLength',[0,0]); set(gca,'fontsize',fontsize_use);
colorbar();
%%%%%%%%;
sgtitle(sprintf('%s',fname_infix_zzzz),'Interpreter','none');
...
colorbar();
%%%%%%%%;
subplot_(1,2) = subplot(2,2,np);np=np+1; imagesc(BB_inv_snlp_zzzz__,c_nlpvt2_lim_); axis image;
set(gca,'YTick',1:n_var,'YTickLabel',string_dat_name_);
set(gca,'XTick',1:n_var,'XTickLabel',string_dat_name_); xtickangle(90);
xlabel('source'); ylabel('target'); title('signed BB_inv_nlp_zzzz__','Interpreter','none');
set(gca,'TickLength',[0,0]); set(gca,'fontsize',fontsize_use);
...
colorbar();
%%%%%%%%;
subplot_(2,2) = subplot(2,2,np);np=np+1; imagesc(BB_inv_sbnlp_zzzz__,c_nlpvt2_lim_); axis image;
set(gca,'YTick',1:n_var,'YTickLabel',string_dat_name_);
set(gca,'XTick',1:n_var,'XTickLabel',string_dat_name_); xtickangle(90);
xlabel('source'); ylabel('target'); title('signed BB_inv_nlp_zzzz__ (bonferroni)','Interpreter','none');
set(gca,'TickLength',[0,0]); set(gca,'fontsize',fontsize_use);
...
BB_inv_zzzz__ = reshape(tmp_.BB_inv_cmb_prm___(:,:,2:end),[n_var^2,n_found_zzzz]);
CC_inv_zzzz__ = zeros(n_var,n_found_zzzz);
for nfound=0:n_found_zzzz-1;
CC_inv_zzzz__(:,1+nfound)= diag(tmp_.CC_inv_cmb_prm___(:,:,1+1+nfound));
...
subplot(2,2,3); hist(BB_inv_zzzz_nrm__(:),128); title('BB_inv_zzzz_nrm__(:)','Interpreter','none');
subplot(2,2,4); hist(CC_inv_zzzz_nrm__(:),128); title('CC_inv_zzzz_nrm__(:)','Interpreter','none');
%%%%%%%%;
disp(sprintf(' %% writing %s',fname_fig));
print('-depsc',sprintf('%s.eps',fname_fig));
print('-djpeg',sprintf('%s.jpg',fname_fig));
...
if (verbose); disp(sprintf(' %% [finished dolphin_d00_cmb_collect_and_plot_2]')); end;
