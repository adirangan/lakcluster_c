function lisa = lisa_struct_prs_collect_ver0(specification);
% try: ;
%{
...
specification.mc_string = mc_string;
  ...
  lisa_struct_prs_collect_ver0(specification) ;
...
if (~exist(lisa_arm1_r0.dir_out_s0_pca,'dir')); disp(sprintf(' %% Warning! %s does not exist in lisa_struct_prs_collect_ver0',lisa_arm1_r0.dir_out_s0_pca)); end;
...
if (~exist(lisa_arm1_r1.dir_out_s0_pca,'dir')); disp(sprintf(' %% Warning! %s does not exist in lisa_struct_prs_collect_ver0',lisa_arm1_r1.dir_out_s0_pca)); end;
...
fname_mat = sprintf('%s/prs_collect_ver12_%s_trn%d%s_tst%d%s.mat',dir_out_s0_pca_r0_arm1,prs_prefix,cl_num_arm1,cl_num_arm1_string,cl_num_arm2,cl_num_arm2_string);
...
[cauc02_avg_,cauc02_min_] = p_cauc_0(lisa_arm2.mds_sort_(find_x_,1: 2),lisa_arm2.mds_sort_(find_d_,1: 2),zeros(length(find_x_),1),zeros(length(find_d_),1),1024*8);
[cauc06_avg_,cauc06_min_] = p_cauc_0(lisa_arm2.mds_sort_(find_x_,1: 6),lisa_arm2.mds_sort_(find_d_,1: 6),zeros(length(find_x_),1),zeros(length(find_d_),1),1024*8);
[cauc19_avg_,cauc19_min_] = p_cauc_0(lisa_arm2.mds_sort_(find_x_,[1:6,19]),lisa_arm2.mds_sort_(find_d_,[1:6,19]),zeros(length(find_x_),1),zeros(length(find_d_),1),1024*8);
[cauc20_avg_,cauc20_min_] = p_cauc_0(lisa_arm2.mds_sort_(find_x_,1:20),lisa_arm2.mds_sort_(find_d_,1:20),zeros(length(find_x_),1),zeros(length(find_d_),1),1024*8);
%%%%%%%%%%%%%%%%;
...
auc02_prs_(nprs) = cauc_0(prs_sco_{nprs}(iprs_{nprs}(find_x_)),prs_sco_{nprs}(iprs_{nprs}(find_d_)),lisa_arm2.mds_sort_(find_x_,1: 2),lisa_arm2.mds_sort_(find_d_,1: 2));
logp_auc02_prs_(nprs) = log(max(1,length(find(cauc02_avg_>auc02_prs_(nprs)))/length(cauc02_avg_)));
auc06_prs_(nprs) = cauc_0(prs_sco_{nprs}(iprs_{nprs}(find_x_)),prs_sco_{nprs}(iprs_{nprs}(find_d_)),lisa_arm2.mds_sort_(find_x_,1: 6),lisa_arm2.mds_sort_(find_d_,1: 6));
logp_auc06_prs_(nprs) = log(max(1,length(find(cauc06_avg_>auc06_prs_(nprs)))/length(cauc06_avg_)));
auc19_prs_(nprs) = cauc_0(prs_sco_{nprs}(iprs_{nprs}(find_x_)),prs_sco_{nprs}(iprs_{nprs}(find_d_)),lisa_arm2.mds_sort_(find_x_,[1:6,19]),lisa_arm2.mds_sort_(find_d_,[1:6,19]));
logp_auc19_prs_(nprs) = log(max(1,length(find(cauc19_avg_>auc19_prs_(nprs)))/length(cauc19_avg_)));
auc20_prs_(nprs) = cauc_0(prs_sco_{nprs}(iprs_{nprs}(find_x_)),prs_sco_{nprs}(iprs_{nprs}(find_d_)),lisa_arm2.mds_sort_(find_x_,1:20),lisa_arm2.mds_sort_(find_d_,1:20));
...
%if (cl_num_arm1==4); ni_r0_arm2_ = [175,250,325]; ni_r1_arm2_ = [163]; end;
if (cl_num_arm1==4); ni_r0_arm2_ = [175:25:450]; ni_r1_arm2_ = [175:25:300]; end;
%if (cl_num_arm1==4); ni_r0_arm2_ = [400]; ni_r1_arm2_ = [300]; end;
...
tmp_mds_x_ = lisa_arm2.mds_sort_(find_x_(find_xt_),[1:6,19]); tmp_mds_d_ = lisa_arm2.mds_sort_(find_d_(find_dt_),[1:6,19]);
...
for nir1_arm2_ = 1:length(ni_r1_arm2_);
ni_r1_arm2 = ni_r1_arm2_(nir1_arm2_);
fname_fig = sprintf('%s/prs_collect_ver12_%s_trn%d%s_tst%d%s_ni%.3d_ni%.3d.jpg',dir_out_s0_pca_r0_arm1,prs_prefix,cl_num_arm1,cl_num_arm1_string,cl_num_arm2,cl_num_arm2_string,ni_r0_arm2,ni_r1_arm2);
