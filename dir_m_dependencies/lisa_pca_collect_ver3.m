function lisa_pca_collect_ver3(dir_code,dir_trunk,cl_num,flag_dex_vs_lak,gamma,B_MLT,n_mds,flag_reverse,n_maf,n_cov,n_shuffle) ;
%{
...
flag_dex_vs_lak = 'lak'; 
gamma=0.001;B_MLT=34;n_mds=20;
flag_reverse=1;
n_maf = 5;
n_cov = 2;
n_shuffle = 64;
lisa_pca_collect_ver3(dir_code,dir_trunk,cl_num,flag_dex_vs_lak,gamma,B_MLT,n_mds,flag_reverse,n_maf,n_cov,n_shuffle) ;
...
fname_mat = sprintf('%s/%s_pca_collect.mat',dir_out_s0000_pca_arm1,string_name_s0000);
...
%%%%%%%%%%%%%%%%
n_cl = 4;
get_auc_arm1_ = zeros(length(niteration_),n_cl) + 0.5;
logp_auc_arm1_ = zeros(length(niteration_),n_cl);
corr_arm1_ = zeros(length(niteration_),n_cl);
beta0_arm1_ = zeros(length(niteration_),n_cl);
logp_beta0_arm1_ = zeros(length(niteration_),n_cl);
beta2_arm1_ = zeros(length(niteration_),n_cl);
logp_beta2_arm1_ = zeros(length(niteration_),n_cl);
beta20_arm1_ = zeros(length(niteration_),n_cl);
logp_beta20_arm1_ = zeros(length(niteration_),n_cl);
flag_flip_ = zeros(length(niteration_),n_cl);
get_auc_arm2_ = zeros(length(niteration_),n_cl) + 0.5;
logp_auc_arm2_ = zeros(length(niteration_),n_cl);
corr_arm2_ = zeros(length(niteration_),n_cl);
beta0_arm2_ = zeros(length(niteration_),n_cl);
logp_beta0_arm2_ = zeros(length(niteration_),n_cl);
beta2_arm2_ = zeros(length(niteration_),n_cl);
logp_beta2_arm2_ = zeros(length(niteration_),n_cl);
...
get_auc_arm1_(ni,cl_num_arm2) = get_auc(XnV_arm1_(find(mr_X_arm1_full),1),DnV_arm1_(find(mr_D_arm1_full),1));
if (get_auc_arm1_(ni,cl_num_arm2)>=0.5); flag_flip_(ni,cl_num_arm2)=0; end;
if (get_auc_arm1_(ni,cl_num_arm2) <0.5); flag_flip_(ni,cl_num_arm2)=1; end;
if (flag_flip_(ni,cl_num_arm2)); get_auc_arm1_(ni,cl_num_arm2) = 1.0 - get_auc_arm1_(ni,cl_num_arm2); end;% if flag_flip_(ni,cl_num_arm2);
logp_auc_arm1_(ni,cl_num_arm2) = logp_auc_0(get_auc_arm1_(ni,cl_num_arm2),min(sum(mr_D_arm1_full),sum(mr_X_arm1_full)));
[beta0_arm1,dev0_arm1,stats0_arm1] = mnrfit([DnV_arm1_(find(mr_D_arm1_full),1) ; XnV_arm1_(find(mr_X_arm1_full),1)],[ones(sum(mr_D_arm1_full),1) ; 1 + ones(sum(mr_X_arm1_full),1)]);
beta0_arm1_(ni,cl_num_arm2) = beta0_arm1(2);
logp_beta0_arm1_(ni,cl_num_arm2) = log(max(1e-255,stats0_arm1.p(2)));
if (flag_flip_(ni,cl_num_arm2)); beta0_arm1_(ni,cl_num_arm2) = -beta0_arm1_(ni,cl_num_arm2); end;% if flag_flip_(ni,cl_num_arm2);
[beta2_arm1,dev2_arm1,stats2_arm1] = mnrfit([DnV_arm1_(find(mr_D_arm1_full),1) , mds_arm1_(find(mr_D_arm1_full),1:2) ; XnV_arm1_(find(mr_X_arm1_full),1) , mds_arm1_(find(mr_X_arm1_full),1:2)],[ones(sum(mr_D_arm1_full),1) ; 1 + ones(sum(mr_X_arm1_full),1)]);
beta2_arm1_(ni,cl_num_arm2) = beta2_arm1(2);
logp_beta2_arm1_(ni,cl_num_arm2) = log(max(1e-255,stats2_arm1.p(2)));
if (flag_flip_(ni,cl_num_arm2)); beta2_arm1_(ni,cl_num_arm2) = -beta2_arm1_(ni,cl_num_arm2); end;% if flag_flip_(ni,cl_num_arm2);
...
if (flag_flip_(ni,cl_num_arm2)); beta20_arm1_(ni,cl_num_arm2) = -beta20_arm1_(ni,cl_num_arm2); end;% if flag_flip_(ni,cl_num_arm2);
...
if (flag_flip_(ni,cl_num_arm2)); corr_arm1_(ni,cl_num_arm2) = -corr_arm1_(ni,cl_num_arm2); end;%if (flag_flip_(ni,cl_num_arm2));
catch; end;%try;
...
get_auc_arm2_(ni,cl_num_arm2) = get_auc(XnV_arm2_(find(mr_X_arm2_full),1),DnV_arm2_(find(mr_D_arm2_full),1));
if (flag_flip_(ni,cl_num_arm2)); get_auc_arm2_(ni,cl_num_arm2) = 1.0 - get_auc_arm2_(ni,cl_num_arm2); end;%if (flag_flip_(ni,cl_num_arm2)); 
logp_auc_arm2_(ni,cl_num_arm2) = logp_auc_0(get_auc_arm2_(ni,cl_num_arm2),min(sum(mr_D_arm2_full),sum(mr_X_arm2_full)));
[beta0_arm2,dev0_arm2,stats0_arm2] = mnrfit([DnV_arm2_(find(mr_D_arm2_full),1) ; XnV_arm2_(find(mr_X_arm2_full),1)],[ones(sum(mr_D_arm2_full),1) ; 1 + ones(sum(mr_X_arm2_full),1)]);
beta0_arm2_(ni,cl_num_arm2) = beta0_arm2(2);
logp_beta0_arm2_(ni,cl_num_arm2) = log(max(1e-255,stats0_arm2.p(2)));
if (flag_flip_(ni,cl_num_arm2)); beta0_arm2_(ni,cl_num_arm2) = -beta0_arm2_(ni,cl_num_arm2); end;% if flag_flip_(ni,cl_num_arm2);
[beta2_arm2,dev2_arm2,stats2_arm2] = mnrfit([DnV_arm2_(find(mr_D_arm2_full),1) , mds_arm2_(find(mr_D_arm2_full),1:2) ; XnV_arm2_(find(mr_X_arm2_full),1) , mds_arm2_(find(mr_X_arm2_full),1:2)],[ones(sum(mr_D_arm2_full),1) ; 1 + ones(sum(mr_X_arm2_full),1)]);
beta2_arm2_(ni,cl_num_arm2) = beta2_arm2(2);
logp_beta2_arm2_(ni,cl_num_arm2) = log(max(1e-255,stats2_arm2.p(2)));
if (flag_flip_(ni,cl_num_arm2)); beta2_arm2_(ni,cl_num_arm2) = -beta2_arm2_(ni,cl_num_arm2); end;% if flag_flip_(ni,cl_num_arm2);
...
if (flag_flip_(ni,cl_num_arm2)); beta20_arm2_(ni,cl_num_arm2) = -beta20_arm2_(ni,cl_num_arm2); end;% if flag_flip_(ni,cl_num_arm2);
...
if (flag_flip_(ni,cl_num_arm2)); corr_arm2_(ni,cl_num_arm2) = -corr_arm2_(ni,cl_num_arm2); end;%if (flag_flip_(ni,cl_num_arm2)); 
catch; end;%try;
end;%for ni=1:length(niteration_);
%%%%%%%%%%%%%%%%;
...
%%%%%%%%%%%%%%%%;
save(fname_mat,'n_cl','get_auc_arm1_','logp_auc_arm1_','corr_arm1_','beta0_arm1_','logp_beta0_arm1_','beta2_arm1_','logp_beta2_arm1_','beta20_arm1_','logp_beta20_arm1_','flag_flip_','get_auc_arm2_','logp_auc_arm2_','corr_arm2_','beta0_arm2_','logp_beta0_arm2_','beta2_arm2_','logp_beta2_arm2_','beta20_arm2_','logp_beta20_arm2_');
%%%%%%%%%%%%%%%%;
...
%%%%%%%%%%%%%%%%;
subplot(5,3,0*3 + cl_num_arm2 - (cl_num_arm2>=cl_num_arm1));hold on; plot(niteration_,get_auc_arm1_(:,cl_num_arm2),'rx-','MarkerSize',Msize); hold off;
xlabel('iteration'); ylabel('auc arm1'); xlim([min(niteration_),max(niteration_)]);
subplot(5,3,1*3 + cl_num_arm2 - (cl_num_arm2>=cl_num_arm1));hold on; plot(niteration_,min(lmax,-logp_auc_arm1_(:,cl_num_arm2)),'rx-','MarkerSize',Msize); hold off; ylim([0,lmax]);
xlabel('iteration'); ylabel('-logp arm1'); xlim([min(niteration_),max(niteration_)]);
subplot(5,3,2*3 + cl_num_arm2 - (cl_num_arm2>=cl_num_arm1));
hold on; plot(niteration_,beta0_arm1_(:,cl_num_arm2),'ro-','MarkerSize',Msize); hold off;
hold on; plot(niteration_,beta2_arm1_(:,cl_num_arm2),'rs-','MarkerSize',Msize); hold off;
hold on; plot(niteration_,beta20_arm1_(:,cl_num_arm2),'r*-','MarkerSize',Msize); hold off;
xlabel('iteration'); ylabel('beta arm1'); xlim([min(niteration_),max(niteration_)]);
subplot(5,3,3*3 + cl_num_arm2 - (cl_num_arm2>=cl_num_arm1));
hold on; plot(niteration_,min(lmax,-logp_beta0_arm1_(:,cl_num_arm2)),'ro-','MarkerSize',Msize); hold off; ylim([0,lmax]);
hold on; plot(niteration_,min(lmax,-logp_beta2_arm1_(:,cl_num_arm2)),'rs-','MarkerSize',Msize); hold off; ylim([0,lmax]);
hold on; plot(niteration_,min(lmax,-logp_beta20_arm1_(:,cl_num_arm2)),'r*-','MarkerSize',Msize); hold off; ylim([0,lmax]);
xlabel('iteration'); ylabel('-logp beta arm1'); xlim([min(niteration_),max(niteration_)]);
subplot(5,3,4*3 + cl_num_arm2 - (cl_num_arm2>=cl_num_arm1));hold on; plot(niteration_,corr_arm1_(:,cl_num_arm2),'rx-','MarkerSize',Msize); hold off;
xlabel('iteration'); ylabel('corr arm1'); xlim([min(niteration_),max(niteration_)]);
%%%%%%%%%%%%%%%%;
subplot(5,3,0*3 + cl_num_arm2 - (cl_num_arm2>=cl_num_arm1));hold on; plot(niteration_,get_auc_arm2_(:,cl_num_arm2),'bo-','MarkerSize',Msize); hold off;
...
subplot(5,3,1*3 + cl_num_arm2 - (cl_num_arm2>=cl_num_arm1));hold on; 
plot(niteration_,min(lmax,-logp_auc_arm2_(:,cl_num_arm2)),'bo-','MarkerSize',Msize);
...
subplot(5,3,2*3 + cl_num_arm2 - (cl_num_arm2>=cl_num_arm1));
hold on; plot(niteration_,beta0_arm2_(:,cl_num_arm2),'bo-','MarkerSize',Msize); hold off;
hold on; plot(niteration_,beta2_arm2_(:,cl_num_arm2),'bs-','MarkerSize',Msize); hold off;
hold on; plot(niteration_,beta20_arm2_(:,cl_num_arm2),'b*-','MarkerSize',Msize); hold off;
...
subplot(5,3,3*3 + cl_num_arm2 - (cl_num_arm2>=cl_num_arm1));
hold on; 
plot(niteration_,min(lmax,-logp_beta0_arm2_(:,cl_num_arm2)),'bo-','MarkerSize',Msize); 
plot(niteration_,min(lmax,-logp_beta2_arm2_(:,cl_num_arm2)),'bs-','MarkerSize',Msize); 
...
subplot(5,3,4*3 + cl_num_arm2 - (cl_num_arm2>=cl_num_arm1));hold on; plot(niteration_,corr_arm2_(:,cl_num_arm2),'bo-','MarkerSize',Msize); hold off;
...
fname_pre = sprintf('%s/%s_pca_collect_ver3',dir_out_s0000_pca_arm1,string_name_s0000);
print('-djpeg',sprintf('%s.jpg',fname_pre));
print('-depsc',sprintf('%s.eps',fname_pre));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
