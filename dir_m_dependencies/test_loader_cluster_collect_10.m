%function test_loader_cluster_collect_10();
...
for nX=1:n_X;
str_X = str_X_{nX};
fname = sprintf('/data/rangan/dir_bcc/dir_jamison/dir_jpg/test_loader_cluster_collect_10_%s',str_X);
fp=fopen(sprintf('%s.txt',fname),'w');
for nZ=1:n_Z;
str_Z = str_Z_{nZ};
n_Z_index = n_Z_index_(nZ);
for nZ_index=1:n_Z_index;
tmp_str = sprintf(' %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%\n');
fprintf(fp,tmp_str); disp(tmp_str);
tmp_str = sprintf(' %% %s %s nZ_index %d\n',str_X,str_Z,nZ_index);
fprintf(fp,tmp_str); disp(tmp_str);
tmp_str = sprintf(' %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%\n');
fprintf(fp,tmp_str); disp(tmp_str);
for nY=1:n_Y;
