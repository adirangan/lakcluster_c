%function test_loader_cluster_collect_9();
...
for nX=1:n_X;
str_X = str_X_{nX};
fname = sprintf('/data/rangan/dir_bcc/dir_jamison/dir_jpg/test_loader_cluster_collect_9_%s',str_X);
fp=fopen(sprintf('%s.txt',fname));
for nZ=1:n_Z;
str_Z = str_Z_{nZ};
n_Z_index = n_Z_index_(nZ);
for nZ_index=1:n_Z_index;
