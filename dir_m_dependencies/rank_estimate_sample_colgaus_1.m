function [rank_estimate_sample,s_B_nlp_,svd_sample__,eig_tw__,eig_B_,kta_opt__,h_x__,h_eig__,h_opt__] = rank_estimate_sample_colgaus_1(A__,p_val_0in,n_shuffle);
...
rng(1024*nshuffle); C__ = randn(n_row,n_col)*sparse(1:n_col,1:n_col,B_std_,n_col,n_col) + repmat(B_avg_,[n_row,1]);
